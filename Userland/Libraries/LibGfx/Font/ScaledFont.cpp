...
float ScaledFont::width(StringView view) const { return measure_text_width(Utf8View(view), 0, *this); }
float ScaledFont::width(Utf8View const& view) const { return measure_text_width(view, 0, *this); }

float ScaledFont::glyph_width(u32 code_point) const
{
    auto string = String::from_code_point(code_point);
    return measure_text_width(Utf8View(string), 0, *this);
}
