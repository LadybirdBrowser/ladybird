...
public:
    explicit Heap(void* private_data, AK::Function<void(HashMap<Cell*, HeapRoot>&)> gather_roots);
    ~Heap();

    template<typename T, typename... Args>
    Ref<T> allocate_without_realm(Args&&... args)
    {
...
private:
    ...
    AK::Function<void(HashMap<Cell*, HeapRoot>&)> m_gather_roots;
};
