...
void BytecodeInterpreter::interpret(Configuration& configuration, InstructionPointer& ip, Instruction const& instruction)
{
    ...
    case Instructions::i8x16_add.value():
        return binary_numeric_operation<u128, u128, Operators::VectorIntegerBinaryOp<16, Operators::WrappingIntegerOp<Operators::Add>>>(configuration);
    case Instructions::i8x16_sub.value():
        return binary_numeric_operation<u128, u128, Operators::VectorIntegerBinaryOp<16, Operators::WrappingIntegerOp<Operators::Subtract>>>(configuration);
    ...
    case Instructions::i16x8_add.value():
        return binary_numeric_operation<u128, u128, Operators::VectorIntegerBinaryOp<8, Operators::WrappingIntegerOp<Operators::Add>>>(configuration);
    case Instructions::i16x8_sub.value():
        return binary_numeric_operation<u128, u128, Operators::VectorIntegerBinaryOp<8, Operators::WrappingIntegerOp<Operators::Subtract>>>(configuration);
    case Instructions::i16x8_mul.value():
        return binary_numeric_operation<u128, u128, Operators::VectorIntegerBinaryOp<8, Operators::WrappingIntegerOp<Operators::Multiply>>>(configuration);
    ...
    case Instructions::i32x4_neg.value():
        return unary_operation<u128, u128, Operators::VectorIntegerUnaryOp<4, Operators::Negate>>(configuration);
    ...
    case Instructions::i32x4_add.value():
        return binary_numeric_operation<u128, u128, Operators::VectorIntegerBinaryOp<4, Operators::WrappingIntegerOp<Operators::Add>>>(configuration);
    case Instructions::i32x4_sub.value():
        return binary_numeric_operation<u128, u128, Operators::VectorIntegerBinaryOp<4, Operators::WrappingIntegerOp<Operators::Subtract>>>(configuration);
    case Instructions::i32x4_mul.value():
        return binary_numeric_operation<u128, u128, Operators::VectorIntegerBinaryOp<4, Operators::WrappingIntegerOp<Operators::Multiply>>>(configuration);
    ...
    case Instructions::i64x2_neg.value():
        return unary_operation<u128, u128, Operators::VectorIntegerUnaryOp<2, Operators::Negate>>(configuration);
    ...
    case Instructions::i64x2_sub.value():
        return binary_numeric_operation<u128, u128, Operators::VectorIntegerBinaryOp<2, Operators::WrappingIntegerOp<Operators::Subtract>>>(configuration);
    case Instructions::i64x2_mul.value():
        return binary_numeric_operation<u128, u128, Operators::VectorIntegerBinaryOp<2, Operators::WrappingIntegerOp<Operators::Multiply>>>(configuration);
