...
GC::Ref<WebIDL::Promise> readable_stream_cancel(ReadableStream& stream, JS::Value reason)
{
    ...
    auto react_result = WebIDL::react_to_promise(*source_cancel_promise,
        GC::create_heap_function(stream.heap(), [](JS::Value) -> WebIDL::ExceptionOr<JS::Value> { return JS::js_undefined(); }),
        {});
...
GC::Ref<WebIDL::Promise> readable_stream_pipe_to(ReadableStream& source, WritableStream& dest, bool, bool, bool, Optional<JS::Value> signal)
{
    ...
    auto chunk_steps = GC::create_heap_function(realm.heap(), [&realm, writer](ByteBuffer buffer) {
    ...
    auto success_steps = GC::create_heap_function(realm.heap(), [promise, &realm, writer](ByteBuffer) {
    ...
    auto failure_steps = GC::create_heap_function(realm.heap(), [promise, &realm, writer](JS::Value error) {
        // Make sure we close the acquired writer.
        WebIDL::resolve_promise(realm, writable_stream_default_writer_close(*writer), JS::js_undefined());
...
public:
    ...
    virtual void on_chunk(JS::Value chunk) override
    {
        ...
        HTML::queue_a_microtask(nullptr, GC::create_heap_function(m_realm->heap(), [this, chunk]() {
            ...
            if (!m_params->canceled2 && m_clone_for_branch2) {
                ...
                if (clone_result.is_exception()) {
                    ...
                    GC::Ref cancel_value = verify_cast<JS::Promise>(*cancel_result->promise().ptr());
...
WebIDL::ExceptionOr<ReadableStreamPair> readable_stream_default_tee(JS::Realm& realm, ReadableStream& stream, bool clone_for_branch2)
{
    ...
    auto pull_algorithm = GC::create_heap_function(realm.heap(), [&realm, &stream, reader, params, cancel_promise, clone_for_branch2]() {
    ...
    auto cancel1_algorithm = GC::create_heap_function(realm.heap(), [&realm, &stream, params, cancel_promise](JS::Value reason) {
    ...
    auto cancel2_algorithm = GC::create_heap_function(realm.heap(), [&realm, &stream, params, cancel_promise](JS::Value reason) {
    ...
    auto start_algorithm = GC::create_heap_function(realm.heap(), []() -> WebIDL::ExceptionOr<JS::Value> {
    ...
    WebIDL::upon_rejection(*reader->closed_promise_capability(), GC::create_heap_function(realm.heap(), [&realm, params, cancel_promise](JS::Value reason) -> WebIDL::ExceptionOr<JS::Value> {
...
public:
    ...
    {
        // 1. Queue a microtask to perform the following steps:
        HTML::queue_a_microtask(nullptr, GC::create_heap_function(m_realm->heap(), [this, chunk]() mutable {
...
public:
    ...
    virtual void on_chunk(JS::Value chunk) override
    {
        ...
        // 1. Queue a microtask to perform the following steps:
        HTML::queue_a_microtask(nullptr, GC::create_heap_function(m_realm->heap(), [this, chunk = chunk_view]() {
            HTML::TemporaryExecutionContext execution_context { Bindings::host_defined_environment_settings_object(m_realm) };
...
WebIDL::ExceptionOr<ReadableStreamPair> readable_byte_stream_tee(JS::Realm& realm, ReadableStream& stream)
{
    ...
    auto forward_reader_error = GC::create_heap_function(realm.heap(), [&realm, params, cancel_promise](ReadableStreamReader const& this_reader) {
        ...
        WebIDL::upon_rejection(*closed_promise, GC::create_heap_function(realm.heap(), [&realm, this_reader, params, cancel_promise](JS::Value reason) -> WebIDL::ExceptionOr<JS::Value> {
    ...
    auto pull_with_default_reader = GC::create_heap_function(realm.heap(), [&realm, &stream, params, cancel_promise, forward_reader_error]() mutable {
    ...
    auto pull_with_byob_reader = GC::create_heap_function(realm.heap(), [&realm, &stream, params, cancel_promise, forward_reader_error](GC::Ref<WebIDL::ArrayBufferView> view, bool for_branch2) mutable {
    ...
    auto pull1_algorithm = GC::create_heap_function(realm.heap(), [&realm, params, pull_with_default_reader, pull_with_byob_reader]() {
        auto controller1 = params->branch1->controller()->get<GC::Ref<ReadableByteStreamController>>();
    ...
    auto pull2_algorithm = GC::create_heap_function(realm.heap(), [&realm, params, pull_with_default_reader, pull_with_byob_reader]() {
        auto controller2 = params->branch2->controller()->get<GC::Ref<ReadableByteStreamController>>();
...
GC::Ref<SizeAlgorithm> extract_size_algorithm(JS::VM& vm, QueuingStrategy const& strategy)
{
    ...
    if (!strategy.size)
        return GC::create_heap_function(vm.heap(), [](JS::Value) { return JS::normal_completion(JS::Value(1)); });

    // 2. Return an algorithm that performs the following steps, taking a chunk argument:
    return GC::create_heap_function(vm.heap(), [size = strategy.size](JS::Value chunk) {
...
WebIDL::ExceptionOr<GC::Ref<ReadableStream>> readable_stream_from_iterable(JS::VM& vm, JS::Value async_iterable)
{
    ...
    auto pull_algorithm = GC::create_heap_function(realm.heap(), [&vm, &realm, stream, iterator_record]() mutable {
        ...
        auto react_result = WebIDL::react_to_promise(*next_promise,
            GC::create_heap_function(realm.heap(), [&vm, stream](JS::Value iter_result) -> WebIDL::ExceptionOr<JS::Value> {
    ...
    auto cancel_algorithm = GC::create_heap_function(realm.heap(), [&vm, &realm, iterator_record](JS::Value reason) {
        ...
        auto react_result = WebIDL::react_to_promise(*return_promise,
            GC::create_heap_function(realm.heap(), [](JS::Value iter_result) -> WebIDL::ExceptionOr<JS::Value> {
                // 1. If Type(iterResult) is not Object, throw a TypeError.
                if (!iter_result.is_object())
                    return WebIDL::SimpleException { WebIDL::SimpleExceptionType::TypeError, "iterResult is not an Object"sv };
...
void readable_stream_default_controller_can_pull_if_needed(ReadableStreamDefaultController& controller)
{
    ...
    WebIDL::upon_fulfillment(*pull_promise, GC::create_heap_function(controller.heap(), [&controller](JS::Value) -> WebIDL::ExceptionOr<JS::Value> {
    ...
    WebIDL::upon_rejection(*pull_promise, GC::create_heap_function(controller.heap(), [&controller](JS::Value e) -> WebIDL::ExceptionOr<JS::Value> {
...
WebIDL::ExceptionOr<void> set_up_readable_stream_default_controller(ReadableStream& stream, ReadableStreamDefaultController& controller, GC::Ref<StartAlgorithm> start_algorithm, GC::Ref<PullAlgorithm> pull_algorithm, GC::Ref<CancelAlgorithm> cancel_algorithm, double high_water_mark, GC::Ref<SizeAlgorithm> size_algorithm)
{
    ...
    WebIDL::upon_fulfillment(start_promise, GC::create_heap_function(controller.heap(), [&controller](JS::Value) -> WebIDL::ExceptionOr<JS::Value> {
    ...
    WebIDL::upon_rejection(start_promise, GC::create_heap_function(controller.heap(), [&controller](JS::Value r) -> WebIDL::ExceptionOr<JS::Value> {
...
WebIDL::ExceptionOr<void> set_up_readable_stream_default_controller_from_underlying_source(ReadableStream& stream, JS::Value underlying_source_value, UnderlyingSource underlying_source, double high_water_mark, GC::Ref<SizeAlgorithm> size_algorithm)
{
    ...
    auto pull_algorithm = GC::create_heap_function(realm.heap(), [&realm]() {
        return WebIDL::create_resolved_promise(realm, JS::js_undefined());
    });

    // 4. Let cancelAlgorithm be an algorithm that returns a promise resolved with undefined.
    auto cancel_algorithm = GC::create_heap_function(realm.heap(), [&realm](JS::Value) {
        return WebIDL::create_resolved_promise(realm, JS::js_undefined());
    });
    ...
    if (underlying_source.start) {
        start_algorithm = GC::create_heap_function(realm.heap(), [controller, underlying_source_value, callback = underlying_source.start]() -> WebIDL::ExceptionOr<JS::Value> {
    ...
    if (underlying_source.pull) {
        pull_algorithm = GC::create_heap_function(realm.heap(), [&realm, controller, underlying_source_value, callback = underlying_source.pull]() {
    ...
    if (underlying_source.cancel) {
        cancel_algorithm = GC::create_heap_function(realm.heap(), [&realm, underlying_source_value, callback = underlying_source.cancel](JS::Value reason) {
            // Note: callback returns a promise, so invoke_callback will never return an abrupt completion
...
void readable_byte_stream_controller_call_pull_if_needed(ReadableByteStreamController& controller)
{
    ...
    // 8. Upon rejection of pullPromise with reason e,
    WebIDL::upon_rejection(*pull_promise, GC::create_heap_function(controller.heap(), [&controller](JS::Value error) -> WebIDL::ExceptionOr<JS::Value> {
...
WebIDL::ExceptionOr<void> set_up_readable_stream(JS::Realm& realm, ReadableStream& stream, GC::Ref<StartAlgorithm> start_algorithm, GC::Ref<PullAlgorithm> pull_algorithm, GC::Ref<CancelAlgorithm> cancel_algorithm, Optional<double> high_water_mark, GC::Ptr<SizeAlgorithm> size_algorithm)
{
    ...
    if (!size_algorithm)
        size_algorithm = GC::create_heap_function(realm.heap(), [](JS::Value) { return JS::normal_completion(JS::Value(1)); });
...
void set_up_readable_stream_controller_with_byte_reading_support(ReadableStream& stream, GC::Ptr<PullAlgorithm> pull_algorithm, GC::Ptr<CancelAlgorithm> cancel_algorithm, double high_water_mark)
{
    ...
    auto start_algorithm = GC::create_heap_function(realm.heap(), []() -> WebIDL::ExceptionOr<JS::Value> { return JS::js_undefined(); });

    // 2. Let pullAlgorithmWrapper be an algorithm that runs these steps:
    auto pull_algorithm_wrapper = GC::create_heap_function(realm.heap(), [&realm, pull_algorithm]() {
    ...
    auto cancel_algorithm_wrapper = GC::create_heap_function(realm.heap(), [&realm, cancel_algorithm](JS::Value c) {
...
void writable_stream_finish_erroring(WritableStream& stream)
{
    ...
    WebIDL::upon_fulfillment(*promise, GC::create_heap_function(realm.heap(), [&realm, &stream, abort_promise = abort_request.promise](JS::Value) -> WebIDL::ExceptionOr<JS::Value> {
    ...
    WebIDL::upon_rejection(*promise, GC::create_heap_function(realm.heap(), [&realm, &stream, abort_promise = abort_request.promise](JS::Value reason) -> WebIDL::ExceptionOr<JS::Value> {
...
WebIDL::ExceptionOr<void> set_up_writable_stream_default_controller(WritableStream& stream, WritableStreamDefaultController& controller, GC::Ref<StartAlgorithm> start_algorithm, GC::Ref<WriteAlgorithm> write_algorithm, GC::Ref<CloseAlgorithm> close_algorithm, GC::Ref<AbortAlgorithm> abort_algorithm, double high_water_mark, GC::Ref<SizeAlgorithm> size_algorithm)
{
    ...
    WebIDL::upon_fulfillment(*start_promise, GC::create_heap_function(realm.heap(), [&controller, &stream](JS::Value) -> WebIDL::ExceptionOr<JS::Value> {
    ...
    WebIDL::upon_rejection(*start_promise, GC::create_heap_function(realm.heap(), [&stream, &controller](JS::Value reason) -> WebIDL::ExceptionOr<JS::Value> {
        // 1. Assert: stream.[[state]] is "writable" or "erroring".
        auto state = stream.state();
        VERIFY(state == WritableStream::State::Writable || state == WritableStream::State::Erroring);
...
WebIDL::ExceptionOr<void> set_up_writable_stream_default_controller_from_underlying_sink(WritableStream& stream, JS::Value underlying_sink_value, UnderlyingSink& underlying_sink, double high_water_mark, GC::Ref<SizeAlgorithm> size_algorithm)
{
    ...
    auto write_algorithm = GC::create_heap_function(realm.heap(), [&realm](JS::Value) {
        return WebIDL::create_resolved_promise(realm, JS::js_undefined());
    });

    // 4. Let closeAlgorithm be an algorithm that returns a promise resolved with undefined.
    auto close_algorithm = GC::create_heap_function(realm.heap(), [&realm]() {
        return WebIDL::create_resolved_promise(realm, JS::js_undefined());
    });

    // 5. Let abortAlgorithm be an algorithm that returns a promise resolved with undefined.
    auto abort_algorithm = GC::create_heap_function(realm.heap(), [&realm](JS::Value) {
        return WebIDL::create_resolved_promise(realm, JS::js_undefined());
    });
    ...
    if (underlying_sink.start) {
        start_algorithm = GC::create_heap_function(realm.heap(), [controller, underlying_sink_value, callback = underlying_sink.start]() -> WebIDL::ExceptionOr<JS::Value> {
            // Note: callback does not return a promise, so invoke_callback may return an abrupt completion
    ...
    if (underlying_sink.write) {
        write_algorithm = GC::create_heap_function(realm.heap(), [&realm, controller, underlying_sink_value, callback = underlying_sink.write](JS::Value chunk) {
            // Note: callback returns a promise, so invoke_callback will never return an abrupt completion
    ...
    if (underlying_sink.close) {
        close_algorithm = GC::create_heap_function(realm.heap(), [&realm, underlying_sink_value, callback = underlying_sink.close]() {
            // Note: callback returns a promise, so invoke_callback will never return an abrupt completion
    ...
    if (underlying_sink.abort) {
        abort_algorithm = GC::create_heap_function(realm.heap(), [&realm, underlying_sink_value, callback = underlying_sink.abort](JS::Value reason) {
            // Note: callback returns a promise, so invoke_callback will never return an abrupt completion
...
void writable_stream_default_controller_process_close(WritableStreamDefaultController& controller)
{
    ...
    WebIDL::upon_fulfillment(*sink_close_promise, GC::create_heap_function(controller.heap(), [stream](JS::Value) -> WebIDL::ExceptionOr<JS::Value> {
    ...
    WebIDL::upon_rejection(*sink_close_promise, GC::create_heap_function(controller.heap(), [stream = stream](JS::Value reason) -> WebIDL::ExceptionOr<JS::Value> {
...
void writable_stream_default_controller_process_write(WritableStreamDefaultController& controller, JS::Value chunk)
{
    ...
    WebIDL::upon_fulfillment(*sink_write_promise, GC::create_heap_function(controller.heap(), [&controller, stream](JS::Value) -> WebIDL::ExceptionOr<JS::Value> {
    ...
    WebIDL::upon_rejection(*sink_write_promise, GC::create_heap_function(controller.heap(), [&controller, stream](JS::Value reason) -> WebIDL::ExceptionOr<JS::Value> {
...
void initialize_transform_stream(TransformStream& stream, GC::Ref<JS::PromiseCapability> start_promise, double writable_high_water_mark, GC::Ref<SizeAlgorithm> writable_size_algorithm, double readable_high_water_mark, GC::Ref<SizeAlgorithm> readable_size_algorithm)
{
    auto& realm = stream.realm();

    // 1. Let startAlgorithm be an algorithm that returns startPromise.
    auto writable_start_algorithm = GC::create_heap_function(realm.heap(), [start_promise]() -> WebIDL::ExceptionOr<JS::Value> {
        return start_promise->promise();
    });

    auto readable_start_algorithm = GC::create_heap_function(realm.heap(), [start_promise]() -> WebIDL::ExceptionOr<JS::Value> {
        return start_promise->promise();
    });

    // 2. Let writeAlgorithm be the following steps, taking a chunk argument:
    auto write_algorithm = GC::create_heap_function(realm.heap(), [&stream](JS::Value chunk) {
    ...
    auto abort_algorithm = GC::create_heap_function(realm.heap(), [&stream](JS::Value reason) {
    ...
    auto close_algorithm = GC::create_heap_function(realm.heap(), [&stream]() {
    ...
    auto pull_algorithm = GC::create_heap_function(realm.heap(), [&stream]() {
    ...
    auto cancel_algorithm = GC::create_heap_function(realm.heap(), [&stream](JS::Value reason) {
...
void set_up_transform_stream_default_controller_from_transformer(TransformStream& stream, JS::Value transformer, Transformer& transformer_dict)
{
    ...
    auto transform_algorithm = GC::create_heap_function(realm.heap(), [controller, &realm, &vm](JS::Value chunk) {
    ...
    auto flush_algorithm = GC::create_heap_function(realm.heap(), [&realm]() {
        return WebIDL::create_resolved_promise(realm, JS::js_undefined());
    });
    ...
    if (transformer_dict.transform) {
        transform_algorithm = GC::create_heap_function(realm.heap(), [controller, &realm, transformer, callback = transformer_dict.transform](JS::Value chunk) {
            // Note: callback returns a promise, so invoke_callback will never return an abrupt completion
    ...
    if (transformer_dict.flush) {
        flush_algorithm = GC::create_heap_function(realm.heap(), [&realm, transformer, callback = transformer_dict.flush, controller]() {
            // Note: callback returns a promise, so invoke_callback will never return an abrupt completion
    ...
    if (transformer_dict.cancel) {
        cancel_algorithm = GC::create_heap_function(realm.heap(), [&realm, transformer, callback = transformer_dict.cancel](JS::Value reason) {
            // Note: callback returns a promise, so invoke_callback will never return an abrupt completion
...
GC::Ref<WebIDL::Promise> transform_stream_default_controller_perform_transform(TransformStreamDefaultController& controller, JS::Value chunk)
{
    ...
    auto react_result = WebIDL::react_to_promise(*transform_promise,
        {},
        GC::create_heap_function(realm.heap(), [&controller](JS::Value reason) -> WebIDL::ExceptionOr<JS::Value> {
...
GC::Ref<WebIDL::Promise> transform_stream_default_sink_abort_algorithm(TransformStream& stream, JS::Value reason)
{
    ...
    WebIDL::react_to_promise(
        *cancel_promise,
        ...
        GC::create_heap_function(realm.heap(), [&realm, readable, controller](JS::Value reason) -> WebIDL::ExceptionOr<JS::Value> {
...
GC::Ref<WebIDL::Promise> transform_stream_default_sink_close_algorithm(TransformStream& stream)
{
    ...
    auto react_result = WebIDL::react_to_promise(
        *flush_promise,
        ...
        GC::create_heap_function(realm.heap(), [readable](JS::Value) -> WebIDL::ExceptionOr<JS::Value> {
        ...
        GC::create_heap_function(realm.heap(), [&stream, readable](JS::Value reason) -> WebIDL::ExceptionOr<JS::Value> {
...
GC::Ref<WebIDL::Promise> transform_stream_default_sink_write_algorithm(TransformStream& stream, JS::Value chunk)
{
    ...
    if (stream.backpressure().has_value() && *stream.backpressure()) {
        ...
        auto react_result = WebIDL::react_to_promise(*backpressure_change_promise,
            GC::create_heap_function(realm.heap(), [&stream, controller, chunk](JS::Value) -> WebIDL::ExceptionOr<JS::Value> {
...
GC::Ref<WebIDL::Promise> transform_stream_default_source_cancel_algorithm(TransformStream& stream, JS::Value reason)
{
    ...
    WebIDL::react_to_promise(
        *cancel_promise,
        // 1. If cancelPromise was fulfilled, then:
        GC::create_heap_function(realm.heap(), [&realm, writable, controller, &stream](JS::Value reason) -> WebIDL::ExceptionOr<JS::Value> {
        ...
        // 2. If cancelPromise was rejected with reason r, then:
        GC::create_heap_function(realm.heap(), [&realm, writable, &stream, controller](JS::Value reason) -> WebIDL::ExceptionOr<JS::Value> {
...
void transform_stream_set_up(TransformStream& stream, GC::Ref<TransformAlgorithm> transform_algorithm, GC::Ptr<FlushAlgorithm> flush_algorithm, GC::Ptr<CancelAlgorithm> cancel_algorithm)
{
    ...
    auto writable_size_algorithm = GC::create_heap_function(realm.heap(), [](JS::Value) {
    ...
    auto readable_size_algorithm = GC::create_heap_function(realm.heap(), [](JS::Value) {
        return JS::normal_completion(JS::Value { 1 });
    });

    // 5. Let transformAlgorithmWrapper be an algorithm that runs these steps given a value chunk:
    auto transform_algorithm_wrapper = GC::create_heap_function(realm.heap(), [&realm, transform_algorithm](JS::Value chunk) -> GC::Ref<WebIDL::Promise> {
    ...
    auto flush_algorithm_wrapper = GC::create_heap_function(realm.heap(), [&realm, flush_algorithm]() -> GC::Ref<WebIDL::Promise> {
    ...
    auto cancel_algorithm_wrapper = GC::create_heap_function(realm.heap(), [&realm, cancel_algorithm](JS::Value reason) -> GC::Ref<WebIDL::Promise> {
...
JS::ThrowCompletionOr<GC::Handle<WebIDL::CallbackType>> property_to_callback(JS::VM& vm, JS::Value value, JS::PropertyKey const& property_key, WebIDL::OperationReturnsPromise operation_returns_promise)
{
    auto property = TRY(value.get(vm, property_key));

    if (property.is_undefined())
        return GC::Handle<WebIDL::CallbackType> {};
...
WebIDL::ExceptionOr<void> set_up_readable_byte_stream_controller_from_underlying_source(ReadableStream& stream, JS::Value underlying_source, UnderlyingSource const& underlying_source_dict, double high_water_mark)
{
    ...
    if (underlying_source_dict.start) {
        start_algorithm = GC::create_heap_function(realm.heap(), [controller, underlying_source, callback = underlying_source_dict.start]() -> WebIDL::ExceptionOr<JS::Value> {
            // Note: callback does not return a promise, so invoke_callback may return an abrupt completion
    ...
    if (underlying_source_dict.pull) {
        pull_algorithm = GC::create_heap_function(realm.heap(), [&realm, controller, underlying_source, callback = underlying_source_dict.pull]() {
            // Note: callback returns a promise, so invoke_callback will never return an abrupt completion
    ...
    if (underlying_source_dict.cancel) {
        cancel_algorithm = GC::create_heap_function(realm.heap(), [&realm, underlying_source, callback = underlying_source_dict.cancel](JS::Value reason) {
            // Note: callback returns a promise, so invoke_callback will never return an abrupt completion
