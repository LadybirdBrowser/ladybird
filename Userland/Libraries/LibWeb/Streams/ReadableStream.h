...
public:
    ...
    static WebIDL::ExceptionOr<GC::Ref<ReadableStream>> construct_impl(JS::Realm&, Optional<GC::Handle<JS::Object>> const& underlying_source, QueuingStrategy const& = {});
    ...
    bool locked() const;
    GC::Ref<JS::Object> cancel(JS::Value reason);
    ...
    GC::Ref<JS::Object> pipe_to(WritableStream& destination, StreamPipeOptions const& = {});
