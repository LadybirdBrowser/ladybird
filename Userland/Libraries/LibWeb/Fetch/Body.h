...
public:
    ...
    // JS API functions
    [[nodiscard]] WebIDL::ExceptionOr<GC::Ref<JS::Promise>> array_buffer() const;
    [[nodiscard]] WebIDL::ExceptionOr<GC::Ref<JS::Promise>> blob() const;
    [[nodiscard]] WebIDL::ExceptionOr<GC::Ref<JS::Promise>> bytes() const;
    [[nodiscard]] WebIDL::ExceptionOr<GC::Ref<JS::Promise>> form_data() const;
    [[nodiscard]] WebIDL::ExceptionOr<GC::Ref<JS::Promise>> json() const;
    [[nodiscard]] WebIDL::ExceptionOr<GC::Ref<JS::Promise>> text() const;
};

[[nodiscard]] WebIDL::ExceptionOr<JS::Value> package_data(JS::Realm&, ByteBuffer, PackageDataType, Optional<MimeSniff::MimeType> const&);
[[nodiscard]] WebIDL::ExceptionOr<GC::Ref<JS::Promise>> consume_body(JS::Realm&, BodyMixin const&, PackageDataType);
