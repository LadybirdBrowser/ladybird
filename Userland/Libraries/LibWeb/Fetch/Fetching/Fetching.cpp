...
WebIDL::ExceptionOr<GC::Ref<Infrastructure::FetchController>> fetch(JS::Realm& realm, Infrastructure::Request& request, Infrastructure::FetchAlgorithms const& algorithms, UseParallelQueue use_parallel_queue)
{
    ...
    if (
        ...
        auto on_preloaded_response_available = GC::create_heap_function(realm.heap(), [fetch_params](GC::Ref<Infrastructure::Response> response) {
...
WebIDL::ExceptionOr<GC::Ptr<PendingResponse>> main_fetch(JS::Realm& realm, Infrastructure::FetchParams const& fetch_params, Recursive recursive)
{
    ...
    GC::SafeFunction<WebIDL::ExceptionOr<GC::Ref<PendingResponse>>()> get_response = [&realm, &vm, &fetch_params, request]() -> WebIDL::ExceptionOr<GC::Ref<PendingResponse>> {
    ...
    Platform::EventLoopPlugin::the().deferred_invoke([&realm, &vm, &fetch_params, request, response, get_response = move(get_response)] {
        ...
        pending_response->when_loaded([&realm, &vm, &fetch_params, request, response, response_was_null = !response](GC::Ref<Infrastructure::Response> resolved_response) mutable {
            ...
            if (!request->integrity_metadata().is_empty()) {
                ...
                //    error.
                auto process_body_error = GC::create_heap_function(vm.heap(), [&realm, &vm, &fetch_params](JS::Value) {
                ...
                auto process_body = GC::create_heap_function(vm.heap(), [&realm, request, response, &fetch_params, process_body_error = move(process_body_error)](ByteBuffer bytes) {
...
void fetch_response_handover(JS::Realm& realm, Infrastructure::FetchParams const& fetch_params, Infrastructure::Response& response)
{
    ...
    auto process_response_end_of_body = [&vm, &response, &fetch_params, timing_info] {
        ...
        auto process_response_end_of_body_task = GC::create_heap_function(vm.heap(), [&fetch_params, &response] {
    ...
    if (fetch_params.algorithms()->process_response()) {
        Infrastructure::queue_fetch_task(fetch_params.controller(), task_destination, GC::create_heap_function(vm.heap(), [&fetch_params, &response]() {
    ...
    // 7. Otherwise:
        ...
        auto identity_transform_algorithm = GC::create_heap_function(realm.heap(), [&realm, transform_stream](JS::Value chunk) -> GC::Ref<WebIDL::Promise> {
        ...
        auto flush_algorithm = GC::create_heap_function(realm.heap(), [&realm, process_response_end_of_body]() -> GC::Ref<WebIDL::Promise> {
            process_response_end_of_body();
            return WebIDL::create_resolved_promise(realm, JS::js_undefined());
        });
    ...
    if (fetch_params.algorithms()->process_response_consume_body()) {
        ...
        auto process_body = GC::create_heap_function(vm.heap(), [&fetch_params, &response](ByteBuffer null_or_bytes) {
        ...
        //    failure.
        auto process_body_error = GC::create_heap_function(vm.heap(), [&fetch_params, &response](JS::Value) {
        ...
        if (!internal_response->body()) {
            Infrastructure::queue_fetch_task(fetch_params.controller(), task_destination, GC::create_heap_function(vm.heap(), [process_body = move(process_body)]() {
...
WebIDL::ExceptionOr<GC::Ptr<PendingResponse>> http_redirect_fetch(JS::Realm& realm, Infrastructure::FetchParams const& fetch_params, Infrastructure::Response& response)
{
    ...
    if (!request->body().has<Empty>()) {
        ...
        auto converted_source = source.has<ByteBuffer>()
            ...
            : BodyInitOrReadableBytes { source.get<GC::Handle<FileAPI::Blob>>() };
...
public:
    ...
    GC::Ptr<Infrastructure::Response> select_response(JS::Realm& realm, URL::URL const& url, ReadonlyBytes method, Vector<Infrastructure::Header> const& headers) const
    {
        ...
        if (http_request->cache_mode() != Infrastructure::Request::CacheMode::NoStore
            ...
            if (stored_response) {
                ...
                if (http_request->cache_mode() == Infrastructure::Request::CacheMode::Default
                    ...
                    Platform::EventLoopPlugin::the().deferred_invoke([&vm, &realm, revalidate_request, fetch_params = GC::Ref(fetch_params)] {
...
WebIDL::ExceptionOr<GC::Ref<PendingResponse>> nonstandard_resource_loader_file_or_http_network_fetch(JS::Realm& realm, Infrastructure::FetchParams const& fetch_params, IncludeCredentials include_credentials, IsNewConnectionFetch is_new_connection_fetch)
{
    ...
    if (auto const* body = request->body().get_pointer<GC::Ref<Infrastructure::Body>>()) {
        TRY((*body)->source().visit(
            ...
            [&](GC::Handle<FileAPI::Blob> const& blob_handle) -> WebIDL::ExceptionOr<void> {
    ...
    if (request->buffer_policy() == Infrastructure::Request::BufferPolicy::DoNotBufferResponse) {
        ...
        auto pull_algorithm = GC::create_heap_function(realm.heap(), [&realm, fetched_data_receiver]() {
        ...
        auto cancel_algorithm = GC::create_heap_function(realm.heap(), [&realm, &fetch_params](JS::Value reason) {
