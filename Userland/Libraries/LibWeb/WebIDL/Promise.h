...
GC::Ref<JS::Promise> react_to_promise(Promise const&, GC::Ptr<ReactionSteps> on_fulfilled_callback, GC::Ptr<ReactionSteps> on_rejected_callback);
GC::Ref<JS::Promise> upon_fulfillment(Promise const&, GC::Ref<ReactionSteps>);
GC::Ref<JS::Promise> upon_rejection(Promise const&, GC::Ref<ReactionSteps>);
...
GC::Ref<JS::Promise> create_rejected_promise_from_exception(JS::Realm&, Exception);
