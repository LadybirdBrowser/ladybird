...
public:
    static GC::Ref<DOMException> create(JS::Realm& realm, FlyString const& name, FlyString const& message);
    ...
    static GC::Ref<DOMException> construct_impl(JS::Realm& realm, FlyString const& message, FlyString const& name);
...
#define __ENUMERATE(ErrorName)                                                          \
    ...
    public:                                                                             \
        static GC::Ref<DOMException> create(JS::Realm& realm, FlyString const& message) \
        {                                                                               \
