...
public:
    ...
    static WebIDL::ExceptionOr<GC::Ref<DOMMatrix>> from_float32_array(JS::VM&, GC::Handle<WebIDL::BufferSource> const& array32);
    static WebIDL::ExceptionOr<GC::Ref<DOMMatrix>> from_float64_array(JS::VM&, GC::Handle<WebIDL::BufferSource> const& array64);
