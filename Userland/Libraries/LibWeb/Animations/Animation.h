...
public:
    ...
    GC::Ref<JS::Object> ready() const { return *current_ready_promise()->promise(); }

    // https://www.w3.org/TR/web-animations-1/#dom-animation-finished
    GC::Ref<JS::Object> finished() const { return *current_finished_promise()->promise(); }
    ...
    virtual GC::Ptr<DOM::Element> owning_element() const { return {}; }
