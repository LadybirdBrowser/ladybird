...
ErrorOr<Vector<GC::Handle<PerformanceTimeline::PerformanceEntry>>> filter_buffer_by_name_and_type(Vector<GC::Ref<PerformanceTimeline::PerformanceEntry>> const& buffer, Optional<String> name, Optional<String> type)
{
...
WebIDL::ExceptionOr<Vector<GC::Handle<PerformanceTimeline::PerformanceEntry>>> PerformanceObserverEntryList::get_entries() const
{
...
WebIDL::ExceptionOr<Vector<GC::Handle<PerformanceTimeline::PerformanceEntry>>> PerformanceObserverEntryList::get_entries_by_type(String const& type) const
{
    // Returns a PerformanceEntryList object returned by filter buffer by name and type algorithm with this's entry list,
...
WebIDL::ExceptionOr<Vector<GC::Handle<PerformanceTimeline::PerformanceEntry>>> PerformanceObserverEntryList::get_entries_by_name(String const& name, Optional<String> type) const
{
    // Returns a PerformanceEntryList object returned by filter buffer by name and type algorithm with this's entry list,
