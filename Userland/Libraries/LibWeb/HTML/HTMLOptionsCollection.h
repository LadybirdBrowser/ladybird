...
using HTMLOptionOrOptGroupElement = Variant<GC::Handle<HTMLOptionElement>, GC::Handle<HTMLOptGroupElement>>;
using HTMLElementOrElementIndex = Variant<GC::Handle<HTMLElement>, i32>;
