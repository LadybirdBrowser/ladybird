...
WebIDL::ExceptionOr<GC::Ptr<WindowProxy>> Window::open_impl(StringView url, StringView target, StringView features)
{
...
WebIDL::ExceptionOr<GC::Ref<Storage>> Window::local_storage()
{
    ...
    static HashMap<Origin, GC::Handle<Storage>> local_storage_per_origin;
...
{
    // FIXME: Implement according to spec.
    static HashMap<Origin, GC::Handle<Storage>> session_storage_per_origin;
...
void Window::start_an_idle_period()
{
    ...
    queue_global_task(Task::Source::IdleTask, *this, GC::create_heap_function(heap(), [this] {
...
WebIDL::ExceptionOr<void> Window::window_post_message_steps(JS::Value message, WindowPostMessageOptions const& options)
{
    ...
    queue_global_task(Task::Source::PostedMessage, *this, GC::create_heap_function(heap(), [this, serialize_with_transfer_result = move(serialize_with_transfer_result), target_origin = move(target_origin), &incumbent_settings, &target_realm]() mutable {
...
WebIDL::UnsignedLong Window::request_animation_frame(WebIDL::CallbackType& callback)
{
    ...
    return m_animation_frame_callback_driver.add([this, callback = GC::make_handle(callback)](double now) {
...
GC::Ref<Crypto::Crypto> Window::crypto()
{
    auto& realm = this->realm();
