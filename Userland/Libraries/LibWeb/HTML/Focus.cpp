...
static void run_focus_update_steps(Vector<GC::Handle<DOM::Node>> old_chain, Vector<GC::Handle<DOM::Node>> new_chain, DOM::Node* new_focus_target)
{
...
static Vector<GC::Handle<DOM::Node>> focus_chain(DOM::Node* subject)
{
    ...
    Vector<GC::Handle<DOM::Node>> output;
