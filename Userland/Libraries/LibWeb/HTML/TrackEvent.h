...
struct TrackEventInit : public DOM::EventInit {
    using TrackType = Optional<Variant<GC::Handle<VideoTrack>, GC::Handle<AudioTrack>, GC::Handle<TextTrack>>>;
    TrackType track;
};
...
public:
    ...
    Variant<Empty, GC::Handle<VideoTrack>, GC::Handle<AudioTrack>, GC::Handle<TextTrack>> track() const;
