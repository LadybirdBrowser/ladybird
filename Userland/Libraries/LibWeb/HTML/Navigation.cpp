...
WebIDL::ExceptionOr<NavigationResult> Navigation::perform_a_navigation_api_traversal(String key, NavigationOptions const& options)
{
    ...
    traversable->append_session_history_traversal_steps(GC::create_heap_function(heap(), [key, api_method_tracker, navigable, source_snapshot_params, traversable, this] {
        ...
        if (it == navigable_shes.end()) {
            ...
            queue_global_task(HTML::Task::Source::NavigationAndTraversal, relevant_global_object(*this), GC::create_heap_function(heap(), [this, api_method_tracker] {
        ...
        if (result == TraversableNavigable::HistoryStepResult::CanceledByBeforeUnload) {
            queue_global_task(Task::Source::NavigationAndTraversal, global, GC::create_heap_function(heap(), [this, api_method_tracker, &realm] {
                TemporaryExecutionContext execution_context { relevant_settings_object(*this) };
