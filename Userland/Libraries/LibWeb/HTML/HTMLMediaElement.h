...
public:
    ...
    // NOTE: The function is wrapped in a GC::Function immediately.
    ...
    WebIDL::ExceptionOr<GC::Ref<JS::Promise>> play();
...
private:
    ...
    void reject_pending_play_promises(ReadonlySpan<GC::Ref<WebIDL::Promise>> promises, FlyString const& message)
    {
