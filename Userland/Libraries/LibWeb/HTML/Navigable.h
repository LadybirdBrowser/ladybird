...
public:
    ...
    Vector<GC::Handle<Navigable>> child_navigables() const;
    ...
    WebIDL::ExceptionOr<GC::Ptr<DOM::Document>> evaluate_javascript_url(URL::URL const&, Origin const& new_document_origin, String navigation_id);
