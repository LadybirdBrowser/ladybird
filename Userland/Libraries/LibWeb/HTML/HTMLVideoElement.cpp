...
GC::Ptr<Layout::Node> HTMLVideoElement::create_layout_node(NonnullRefPtr<CSS::StyleProperties> style)
{
...
WebIDL::ExceptionOr<void> HTMLVideoElement::determine_element_poster_frame(Optional<String> const& poster)
{
    ...
    fetch_algorithms_input.process_response = [this](auto response) mutable {
        ...
        auto on_image_data_read = GC::create_heap_function(heap(), [this](ByteBuffer image_data) mutable {
            ...
            (void)Platform::ImageCodecPlugin::the().decode_image(
                image_data,
                [strong_this = GC::Handle(*this)](Web::Platform::DecodedImage& image) -> ErrorOr<void> {
        ...
        auto empty_algorithm = GC::create_heap_function(heap(), [](JS::Value) {});
