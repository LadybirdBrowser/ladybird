...
static NonnullRefPtr<Core::Promise<Web::Platform::DecodedImage>> decode_favicon(ReadonlyBytes favicon_data, URL::URL const& favicon_url, GC::Ptr<Navigable> navigable)
{
    ...
    auto on_successful_decode = [navigable = GC::Handle(*navigable)](Web::Platform::DecodedImage& decoded_image) -> ErrorOr<void> {
...
WebIDL::ExceptionOr<void> HTMLLinkElement::load_fallback_favicon_if_needed(GC::Ref<DOM::Document> document)
{
    ...
    fetch_algorithms_input.process_response = [document, request](GC::Ref<Fetch::Infrastructure::Response> response) {
        ...
        auto process_body = GC::create_heap_function(realm.heap(), [document, request](ByteBuffer body) {
