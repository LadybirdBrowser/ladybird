...
public:
    [[nodiscard]] static GC::Ref<NavigationTransition> create(JS::Realm&, Bindings::NavigationType, GC::Ref<NavigationHistoryEntry>, GC::Ptr<JS::Promise>);
    ...
    GC::Ptr<JS::Promise> finished() const { return m_finished_promise; }

    virtual ~NavigationTransition() override;

private:
    NavigationTransition(JS::Realm&, Bindings::NavigationType, GC::Ref<NavigationHistoryEntry>, GC::Ptr<JS::Promise>);
    ...
    GC::Ptr<JS::Promise> m_finished_promise;
};
