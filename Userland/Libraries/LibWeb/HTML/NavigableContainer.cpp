...
WebIDL::ExceptionOr<void> NavigableContainer::create_new_child_navigable(GC::Ptr<GC::Function<void()>> after_session_history_update)
{
    ...
    GC::Ref<DocumentState> document_state = *heap().allocate_without_realm<HTML::DocumentState>();
    ...
    GC::Ref<Navigable> navigable = *heap().allocate_without_realm<Navigable>(page);
    ...
    traversable->append_session_history_traversal_steps(GC::create_heap_function(heap(), [traversable, navigable, parent_navigable, history_entry, after_session_history_update] {
...
void NavigableContainer::destroy_the_child_navigable()
{
    ...
    navigable->active_document()->destroy_a_document_and_its_descendants(GC::create_heap_function(heap(), [this, navigable] {
