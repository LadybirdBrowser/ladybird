...
WebIDL::ExceptionOr<GC::Ref<Node>> Node::replace_child(GC::Ref<Node> node, GC::Ref<Node> child)
{
    ...
    Vector<GC::Handle<Node>> removed_nodes;
...
Vector<GC::Handle<Node>> Node::children_as_vector() const
{
    Vector<GC::Handle<Node>> nodes;
...
void Node::replace_all(GC::Ptr<Node> node)
{
    ...
    Vector<GC::Handle<Node>> added_nodes;
...
void Node::queue_mutation_record(FlyString const& type, Optional<FlyString> const& attribute_name, Optional<FlyString> const& attribute_namespace, Optional<String> const& old_value, Vector<GC::Handle<Node>> added_nodes, Vector<GC::Handle<Node>> removed_nodes, Node* previous_sibling, Node* next_sibling) const
{
...
void Node::queue_tree_mutation_record(Vector<GC::Handle<Node>> added_nodes, Vector<GC::Handle<Node>> removed_nodes, Node* previous_sibling, Node* next_sibling)
{
