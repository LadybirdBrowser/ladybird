...
public:
    ...
    WebIDL::ExceptionOr<void> prepend(Vector<Variant<GC::Handle<Node>, String>> const& nodes);
    WebIDL::ExceptionOr<void> append(Vector<Variant<GC::Handle<Node>, String>> const& nodes);
    WebIDL::ExceptionOr<void> replace_children(Vector<Variant<GC::Handle<Node>, String>> const& nodes);
