...
public:
    ...
    Vector<GC::Handle<Node>> children_as_vector() const;
    ...
    void queue_mutation_record(FlyString const& type, Optional<FlyString> const& attribute_name, Optional<FlyString> const& attribute_namespace, Optional<String> const& old_value, Vector<GC::Handle<Node>> added_nodes, Vector<GC::Handle<Node>> removed_nodes, Node* previous_sibling, Node* next_sibling) const;
...
private:
    void queue_tree_mutation_record(Vector<GC::Handle<Node>> added_nodes, Vector<GC::Handle<Node>> removed_nodes, Node* previous_sibling, Node* next_sibling);
