...
struct GetHTMLOptions {
    ...
    Vector<GC::Handle<ShadowRoot>> shadow_roots {};
};
...
struct CustomElementUpgradeReaction {
    GC::Handle<HTML::CustomElementDefinition> custom_element_definition;
};
...
struct CustomElementCallbackReaction {
    GC::Handle<WebIDL::CallbackType> callback;
...
public:
    ...
    virtual GC::Ptr<Layout::Node> create_layout_node(NonnullRefPtr<CSS::StyleProperties>);
    virtual void adjust_computed_style(CSS::StyleProperties&) { }

    virtual void did_receive_focus() { }
    virtual void did_lose_focus() { }

    static GC::Ptr<Layout::NodeWithStyle> create_layout_node_for_display_type(DOM::Document&, CSS::Display const&, NonnullRefPtr<CSS::StyleProperties>, Element*);
