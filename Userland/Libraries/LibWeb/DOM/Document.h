...
public:
    ...
    Vector<GC::Handle<HTML::HTMLScriptElement>> take_scripts_to_execute_when_parsing_has_finished(Badge<HTML::HTMLParser>);
    ...
    Vector<GC::Handle<HTML::HTMLScriptElement>> take_scripts_to_execute_as_soon_as_possible(Badge<HTML::HTMLParser>);
    ...
    Vector<GC::Handle<HTML::HTMLScriptElement>> take_scripts_to_execute_in_order_as_soon_as_possible(Badge<HTML::HTMLParser>);
    ...
    Vector<GC::Handle<HTML::Navigable>> const descendant_navigables() const;
    Vector<GC::Handle<HTML::Navigable>> inclusive_descendant_navigables();
    Vector<GC::Handle<HTML::Navigable>> ancestor_navigables();
    Vector<GC::Handle<HTML::Navigable>> const ancestor_navigables() const;
    Vector<GC::Handle<HTML::Navigable>> inclusive_ancestor_navigables();
    Vector<GC::Handle<HTML::Navigable>> document_tree_child_navigables();
    ...
    Vector<GC::Ref<Element>> elements_from_point(double x, double y);
    ...
    Vector<GC::Handle<DOM::Range>> find_matching_text(String const&, CaseSensitivity);
    ...
    GC::Ptr<DOM::Position> cursor_position() const { return m_cursor_position; }
    void set_cursor_position(GC::Ref<DOM::Position>);
...
private:
    ...
    OrderedHashTable<GC::Ref<IntersectionObserver::IntersectionObserver>> m_intersection_observers;
    ...
    GC::Ptr<DOM::Position> m_cursor_position;
