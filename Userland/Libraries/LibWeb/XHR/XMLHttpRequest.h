...
using DocumentOrXMLHttpRequestBodyInit = Variant<GC::Handle<Web::DOM::Document>, GC::Handle<Web::FileAPI::Blob>, GC::Handle<WebIDL::BufferSource>, GC::Handle<XHR::FormData>, GC::Handle<Web::DOMURL::URLSearchParams>, AK::String>;
