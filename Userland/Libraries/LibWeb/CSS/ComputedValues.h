...
public:
    ...
    Optional<CSS::LengthOrCalculated> word_spacing() const { return m_inherited.word_spacing; }
...
protected:
    struct {
        ...
        Optional<CSS::LengthOrCalculated> word_spacing { InitialValues::word_spacing() };
