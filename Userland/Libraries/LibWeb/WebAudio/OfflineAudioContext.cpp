...
WebIDL::ExceptionOr<GC::Ref<JS::Promise>> OfflineAudioContext::start_rendering()
{
    return WebIDL::NotSupportedError::create(realm(), "FIXME: Implement OfflineAudioContext::start_rendering"_fly_string);
}

WebIDL::ExceptionOr<GC::Ref<JS::Promise>> OfflineAudioContext::resume()
{
    return WebIDL::NotSupportedError::create(realm(), "FIXME: Implement OfflineAudioContext::resume"_fly_string);
}

WebIDL::ExceptionOr<GC::Ref<JS::Promise>> OfflineAudioContext::suspend(double suspend_time)
{
    (void)suspend_time;
