...
public:
    ...
    static GC::Ref<GainNode> create(JS::Realm&, GC::Ref<BaseAudioContext>, GainOptions const& = {});
    static GC::Ref<GainNode> construct_impl(JS::Realm&, GC::Ref<BaseAudioContext>, GainOptions const& = {});
