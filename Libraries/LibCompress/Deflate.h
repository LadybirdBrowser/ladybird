...
private:
    DeflateDecompressor(MaybeOwned<Stream> stream, z_stream* zstream)
        : GenericZlibDecompressor(move(stream), zstream)
    {
    }
};
...
private:
    DeflateCompressor(MaybeOwned<Stream> stream, z_stream* zstream)
        : GenericZlibCompressor(move(stream), zstream)
    {
    }
};
