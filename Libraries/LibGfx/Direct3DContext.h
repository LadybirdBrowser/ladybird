...
// NOTE: This D3D context is for both D11 and D12. We need D11 for creating a sharable texture for ANGLE/WebGL, but we need D12 for the Skia backend context.
// We can open the shared D11 texture as a D12 resource and use it for the D12 skia PaintingSurface
class Direct3DContext {
public:
    ~Direct3DContext();
