...
void PathImplSkia::text(Wtf8ByteView string, Font const& font)
{
...
NonnullOwnPtr<PathImpl> PathImplSkia::place_text_along(Wtf8ByteView text, Font const& font) const
{
