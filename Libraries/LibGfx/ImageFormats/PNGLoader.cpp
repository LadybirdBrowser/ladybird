    ...
    if (png_get_acTL(png_ptr, info_ptr, &frame_count, &loop_count)) {
        ...
        for (size_t frame_index = 0; frame_index < frame_count; ++frame_index) {
            ...
            case PNG_BLEND_OP_SOURCE:
                ...
                painter->draw_bitmap(frame_rect, Gfx::ImmutableBitmap::create(*decoded_frame_bitmap), decoded_frame_bitmap->rect(), Gfx::ScalingMode::NearestNeighbor, 1.0f, Gfx::BlendMode::Src);
                break;
            case PNG_BLEND_OP_OVER:
                ...
                painter->draw_bitmap(frame_rect, Gfx::ImmutableBitmap::create(*decoded_frame_bitmap), decoded_frame_bitmap->rect(), ScalingMode::NearestNeighbor, 1.0f, Gfx::BlendMode::SrcOver);
                break;
            default:
                VERIFY_NOT_REACHED();
            }
            ...
            case PNG_DISPOSE_OP_PREVIOUS:
                ...
                painter->clear_rect(frame_rect, Gfx::Color::Transparent);
                painter->draw_bitmap(frame_rect, Gfx::ImmutableBitmap::create(*prev_output_buffer), IntRect { x, y, width, height }, Gfx::ScalingMode::NearestNeighbor, 1.0f, Gfx::BlendMode::SrcOver);
                break;
            default:
                VERIFY_NOT_REACHED();
            }
