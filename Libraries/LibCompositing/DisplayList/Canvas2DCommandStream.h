...
struct COMPOSITING_API Canvas2DCommandStreamSegment {
    CanvasId canvas_id;
...
class COMPOSITING_API Canvas2DCommandStream : public RefCounted<Canvas2DCommandStream> {
public:
...
template<>
COMPOSITING_API ErrorOr<void> encode(Encoder&, Compositing::Canvas2DCommandStreamSegment const&);
template<>
COMPOSITING_API ErrorOr<Compositing::Canvas2DCommandStreamSegment> decode(Decoder&);
