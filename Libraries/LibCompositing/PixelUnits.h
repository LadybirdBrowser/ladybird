...
class COMPOSITING_API CSSPixels {
...
template<>
COMPOSITING_API ErrorOr<void> encode(Encoder& encoder, Compositing::CSSPixelPoint const& value);
template<>
COMPOSITING_API ErrorOr<Compositing::CSSPixelPoint> decode(Decoder& decoder);

template<>
COMPOSITING_API ErrorOr<void> encode(Encoder& encoder, Compositing::DevicePixelPoint const& value);
template<>
COMPOSITING_API ErrorOr<Compositing::DevicePixelPoint> decode(Decoder& decoder);

template<>
COMPOSITING_API ErrorOr<void> encode(Encoder& encoder, Compositing::DevicePixelSize const& value);
template<>
COMPOSITING_API ErrorOr<Compositing::DevicePixelSize> decode(Decoder& decoder);

template<>
COMPOSITING_API ErrorOr<void> encode(Encoder& encoder, Compositing::DevicePixelRect const& value);
template<>
COMPOSITING_API ErrorOr<Compositing::DevicePixelRect> decode(Decoder& decoder);
