...
template<>
COMPOSITING_API ErrorOr<void> encode(Encoder&, Compositing::ScrollStateSnapshot const&);
template<>
COMPOSITING_API ErrorOr<Compositing::ScrollStateSnapshot> decode(Decoder&);
