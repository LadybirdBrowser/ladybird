...
pub use crate::display_list::commands::{
...
pub struct NodeDependencyOrder {
    pub order: Vec<u32>,
...
impl VisualContextTree {
    ...
    pub fn debug_assert_slot_accounting(&self) {
        debug_assert_eq!(
    ...
    pub fn spatial_dependency_order_with_back_edges(&self) -> NodeDependencyOrder {
        dependency_order(
            self.spatial_nodes.len(),
            |index| self.spatial_nodes[index].data.is_live(),
            |index, references| {
    ...
    pub fn clip_dependency_order_with_back_edges(&self) -> NodeDependencyOrder {
        dependency_order(
            self.clip_nodes.len(),
            |index| self.clip_nodes[index].data.is_live(),
            |index, references| {
    ...
    pub fn effect_dependency_order_with_back_edges(&self) -> NodeDependencyOrder {
        dependency_order(
            self.effect_nodes.len(),
            |index| self.effect_nodes[index].data.is_live(),
            |index, references| {
