...
public:
    ...
    static NonnullRefPtr<DebuggerFrameActor> create(DevToolsServer&, String name, WeakPtr<ThreadActor>, WebView::DebuggerFrame, String source_actor);
    virtual ~DebuggerFrameActor() override;

    JsonObject serialize_frame() const;

private:
    DebuggerFrameActor(DevToolsServer&, String name, WeakPtr<ThreadActor>, WebView::DebuggerFrame, String source_actor);
