...
class Encoder {
public:
    virtual ErrorOr<void> process(Wtf8ByteView, Function<ErrorOr<void>(u8)> on_byte, Function<ErrorOr<void>(u32)> on_error) = 0;
...
public:
    virtual ErrorOr<void> process(Wtf8ByteView, Function<ErrorOr<void>(u8)> on_byte, Function<ErrorOr<void>(u32)> on_error) override;
};
