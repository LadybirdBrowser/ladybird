...
protected:
    bool interpret_instruction_chain(Configuration&, InstructionPointer& ip, InstructionPointer& last_ip, Span<Instruction const>, InstructionPointer max_ip, u64& executed_instructions);
