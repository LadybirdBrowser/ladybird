...
#define ENUMERATE_MULTI_BYTE_WASM_OPCODES(M)                        \
    ...
    M(memory_init, 0xfc00000000000008ull, -1, -1)                   \
    M(data_drop, 0xfc00000000000009ull, -1, -1)                     \
    M(memory_copy, 0xfc0000000000000aull, -1, -1)                   \
    M(memory_fill, 0xfc0000000000000bull, -1, -1)                   \
    M(table_init, 0xfc0000000000000cull, -1, -1)                    \
    M(elem_drop, 0xfc0000000000000dull, -1, -1)                     \
    M(table_copy, 0xfc0000000000000eull, -1, -1)                    \
    M(table_grow, 0xfc0000000000000full, -1, -1)                    \
    M(table_size, 0xfc00000000000010ull, -1, -1)                    \
    M(table_fill, 0xfc00000000000011ull, -1, -1)                    \
    ...
    M(v128_store, 0xfd0000000000000bull, -1, -1)                    \
    M(v128_const, 0xfd0000000000000cull, -1, -1)                    \
    M(i8x16_shuffle, 0xfd0000000000000dull, -1, -1)                 \
    M(i8x16_swizzle, 0xfd0000000000000eull, -1, -1)                 \
    ...
    M(i8x16_replace_lane, 0xfd00000000000017ull, -1, -1)            \
    M(i16x8_extract_lane_s, 0xfd00000000000018ull, -1, -1)          \
    M(i16x8_extract_lane_u, 0xfd00000000000019ull, -1, -1)          \
    M(i16x8_replace_lane, 0xfd0000000000001aull, -1, -1)            \
    M(i32x4_extract_lane, 0xfd0000000000001bull, -1, -1)            \
    M(i32x4_replace_lane, 0xfd0000000000001cull, -1, -1)            \
    M(i64x2_extract_lane, 0xfd0000000000001dull, -1, -1)            \
    M(i64x2_replace_lane, 0xfd0000000000001eull, -1, -1)            \
    M(f32x4_extract_lane, 0xfd0000000000001full, -1, -1)            \
    M(f32x4_replace_lane, 0xfd00000000000020ull, -1, -1)            \
    M(f64x2_extract_lane, 0xfd00000000000021ull, -1, -1)            \
    M(f64x2_replace_lane, 0xfd00000000000022ull, -1, -1)            \
    M(i8x16_eq, 0xfd00000000000023ull, -1, -1)                      \
    M(i8x16_ne, 0xfd00000000000024ull, -1, -1)                      \
    M(i8x16_lt_s, 0xfd00000000000025ull, -1, -1)                    \
    M(i8x16_lt_u, 0xfd00000000000026ull, -1, -1)                    \
    M(i8x16_gt_s, 0xfd00000000000027ull, -1, -1)                    \
    M(i8x16_gt_u, 0xfd00000000000028ull, -1, -1)                    \
    M(i8x16_le_s, 0xfd00000000000029ull, -1, -1)                    \
    M(i8x16_le_u, 0xfd0000000000002aull, -1, -1)                    \
    M(i8x16_ge_s, 0xfd0000000000002bull, -1, -1)                    \
    M(i8x16_ge_u, 0xfd0000000000002cull, -1, -1)                    \
    M(i16x8_eq, 0xfd0000000000002dull, -1, -1)                      \
    M(i16x8_ne, 0xfd0000000000002eull, -1, -1)                      \
    M(i16x8_lt_s, 0xfd0000000000002full, -1, -1)                    \
    M(i16x8_lt_u, 0xfd00000000000030ull, -1, -1)                    \
    M(i16x8_gt_s, 0xfd00000000000031ull, -1, -1)                    \
    M(i16x8_gt_u, 0xfd00000000000032ull, -1, -1)                    \
    M(i16x8_le_s, 0xfd00000000000033ull, -1, -1)                    \
    M(i16x8_le_u, 0xfd00000000000034ull, -1, -1)                    \
    M(i16x8_ge_s, 0xfd00000000000035ull, -1, -1)                    \
    M(i16x8_ge_u, 0xfd00000000000036ull, -1, -1)                    \
    M(i32x4_eq, 0xfd00000000000037ull, -1, -1)                      \
    M(i32x4_ne, 0xfd00000000000038ull, -1, -1)                      \
    M(i32x4_lt_s, 0xfd00000000000039ull, -1, -1)                    \
    M(i32x4_lt_u, 0xfd0000000000003aull, -1, -1)                    \
    M(i32x4_gt_s, 0xfd0000000000003bull, -1, -1)                    \
    M(i32x4_gt_u, 0xfd0000000000003cull, -1, -1)                    \
    M(i32x4_le_s, 0xfd0000000000003dull, -1, -1)                    \
    M(i32x4_le_u, 0xfd0000000000003eull, -1, -1)                    \
    M(i32x4_ge_s, 0xfd0000000000003full, -1, -1)                    \
    M(i32x4_ge_u, 0xfd00000000000040ull, -1, -1)                    \
    M(f32x4_eq, 0xfd00000000000041ull, -1, -1)                      \
    M(f32x4_ne, 0xfd00000000000042ull, -1, -1)                      \
    M(f32x4_lt, 0xfd00000000000043ull, -1, -1)                      \
    M(f32x4_gt, 0xfd00000000000044ull, -1, -1)                      \
    M(f32x4_le, 0xfd00000000000045ull, -1, -1)                      \
    M(f32x4_ge, 0xfd00000000000046ull, -1, -1)                      \
    M(f64x2_eq, 0xfd00000000000047ull, -1, -1)                      \
    M(f64x2_ne, 0xfd00000000000048ull, -1, -1)                      \
    M(f64x2_lt, 0xfd00000000000049ull, -1, -1)                      \
    M(f64x2_gt, 0xfd0000000000004aull, -1, -1)                      \
    M(f64x2_le, 0xfd0000000000004bull, -1, -1)                      \
    M(f64x2_ge, 0xfd0000000000004cull, -1, -1)                      \
    M(v128_not, 0xfd0000000000004dull, -1, -1)                      \
    M(v128_and, 0xfd0000000000004eull, -1, -1)                      \
    M(v128_andnot, 0xfd0000000000004full, -1, -1)                   \
    M(v128_or, 0xfd00000000000050ull, -1, -1)                       \
    M(v128_xor, 0xfd00000000000051ull, -1, -1)                      \
    M(v128_bitselect, 0xfd00000000000052ull, -1, -1)                \
    M(v128_any_true, 0xfd00000000000053ull, -1, -1)                 \
    M(v128_load8_lane, 0xfd00000000000054ull, -1, -1)               \
    M(v128_load16_lane, 0xfd00000000000055ull, -1, -1)              \
    M(v128_load32_lane, 0xfd00000000000056ull, -1, -1)              \
    M(v128_load64_lane, 0xfd00000000000057ull, -1, -1)              \
    M(v128_store8_lane, 0xfd00000000000058ull, -1, -1)              \
    M(v128_store16_lane, 0xfd00000000000059ull, -1, -1)             \
    M(v128_store32_lane, 0xfd0000000000005aull, -1, -1)             \
    M(v128_store64_lane, 0xfd0000000000005bull, -1, -1)             \
    ...
    M(i8x16_narrow_i16x8_s, 0xfd00000000000065ull, -1, -1)          \
    M(i8x16_narrow_i16x8_u, 0xfd00000000000066ull, -1, -1)          \
    ...
    M(i8x16_shl, 0xfd0000000000006bull, -1, -1)                     \
    M(i8x16_shr_s, 0xfd0000000000006cull, -1, -1)                   \
    M(i8x16_shr_u, 0xfd0000000000006dull, -1, -1)                   \
    M(i8x16_add, 0xfd0000000000006eull, -1, -1)                     \
    M(i8x16_add_sat_s, 0xfd0000000000006full, -1, -1)               \
    M(i8x16_add_sat_u, 0xfd00000000000070ull, -1, -1)               \
    M(i8x16_sub, 0xfd00000000000071ull, -1, -1)                     \
    M(i8x16_sub_sat_s, 0xfd00000000000072ull, -1, -1)               \
    M(i8x16_sub_sat_u, 0xfd00000000000073ull, -1, -1)               \
    M(f64x2_ceil, 0xfd00000000000074ull, -1, -1)                    \
    M(f64x2_floor, 0xfd00000000000075ull, -1, -1)                   \
    M(i8x16_min_s, 0xfd00000000000076ull, -1, -1)                   \
    M(i8x16_min_u, 0xfd00000000000077ull, -1, -1)                   \
    M(i8x16_max_s, 0xfd00000000000078ull, -1, -1)                   \
    M(i8x16_max_u, 0xfd00000000000079ull, -1, -1)                   \
    M(f64x2_trunc, 0xfd0000000000007aull, -1, -1)                   \
    M(i8x16_avgr_u, 0xfd0000000000007bull, -1, -1)                  \
    ...
    M(i16x8_q15mulr_sat_s, 0xfd00000000000082ull, -1, -1)           \
    M(i16x8_all_true, 0xfd00000000000083ull, -1, -1)                \
    M(i16x8_bitmask, 0xfd00000000000084ull, -1, -1)                 \
    M(i16x8_narrow_i32x4_s, 0xfd00000000000085ull, -1, -1)          \
    M(i16x8_narrow_i32x4_u, 0xfd00000000000086ull, -1, -1)          \
    ...
    M(i16x8_shl, 0xfd0000000000008bull, -1, -1)                     \
    M(i16x8_shr_s, 0xfd0000000000008cull, -1, -1)                   \
    M(i16x8_shr_u, 0xfd0000000000008dull, -1, -1)                   \
    M(i16x8_add, 0xfd0000000000008eull, -1, -1)                     \
    M(i16x8_add_sat_s, 0xfd0000000000008full, -1, -1)               \
    M(i16x8_add_sat_u, 0xfd00000000000090ull, -1, -1)               \
    M(i16x8_sub, 0xfd00000000000091ull, -1, -1)                     \
    M(i16x8_sub_sat_s, 0xfd00000000000092ull, -1, -1)               \
    M(i16x8_sub_sat_u, 0xfd00000000000093ull, -1, -1)               \
    M(f64x2_nearest, 0xfd00000000000094ull, -1, -1)                 \
    M(i16x8_mul, 0xfd00000000000095ull, -1, -1)                     \
    M(i16x8_min_s, 0xfd00000000000096ull, -1, -1)                   \
    M(i16x8_min_u, 0xfd00000000000097ull, -1, -1)                   \
    M(i16x8_max_s, 0xfd00000000000098ull, -1, -1)                   \
    M(i16x8_max_u, 0xfd00000000000099ull, -1, -1)                   \
    M(i16x8_avgr_u, 0xfd0000000000009bull, -1, -1)                  \
    M(i16x8_extmul_low_i8x16_s, 0xfd0000000000009cull, -1, -1)      \
    M(i16x8_extmul_high_i8x16_s, 0xfd0000000000009dull, -1, -1)     \
    M(i16x8_extmul_low_i8x16_u, 0xfd0000000000009eull, -1, -1)      \
    M(i16x8_extmul_high_i8x16_u, 0xfd0000000000009full, -1, -1)     \
    ...
    M(i32x4_shl, 0xfd000000000000abull, -1, -1)                     \
    M(i32x4_shr_s, 0xfd000000000000acull, -1, -1)                   \
    M(i32x4_shr_u, 0xfd000000000000adull, -1, -1)                   \
    M(i32x4_add, 0xfd000000000000aeull, -1, -1)                     \
    M(i32x4_sub, 0xfd000000000000b1ull, -1, -1)                     \
    M(i32x4_mul, 0xfd000000000000b5ull, -1, -1)                     \
    M(i32x4_min_s, 0xfd000000000000b6ull, -1, -1)                   \
    M(i32x4_min_u, 0xfd000000000000b7ull, -1, -1)                   \
    M(i32x4_max_s, 0xfd000000000000b8ull, -1, -1)                   \
    M(i32x4_max_u, 0xfd000000000000b9ull, -1, -1)                   \
    M(i32x4_dot_i16x8_s, 0xfd000000000000baull, -1, -1)             \
    M(i32x4_extmul_low_i16x8_s, 0xfd000000000000bcull, -1, -1)      \
    M(i32x4_extmul_high_i16x8_s, 0xfd000000000000bdull, -1, -1)     \
    M(i32x4_extmul_low_i16x8_u, 0xfd000000000000beull, -1, -1)      \
    M(i32x4_extmul_high_i16x8_u, 0xfd000000000000bfull, -1, -1)     \
    ...
    M(i64x2_shl, 0xfd000000000000cbull, -1, -1)                     \
    M(i64x2_shr_s, 0xfd000000000000ccull, -1, -1)                   \
    M(i64x2_shr_u, 0xfd000000000000cdull, -1, -1)                   \
    M(i64x2_add, 0xfd000000000000ceull, -1, -1)                     \
    M(i64x2_sub, 0xfd000000000000d1ull, -1, -1)                     \
    M(i64x2_mul, 0xfd000000000000d5ull, -1, -1)                     \
    M(i64x2_eq, 0xfd000000000000d6ull, -1, -1)                      \
    M(i64x2_ne, 0xfd000000000000d7ull, -1, -1)                      \
    M(i64x2_lt_s, 0xfd000000000000d8ull, -1, -1)                    \
    M(i64x2_gt_s, 0xfd000000000000d9ull, -1, -1)                    \
    M(i64x2_le_s, 0xfd000000000000daull, -1, -1)                    \
    M(i64x2_ge_s, 0xfd000000000000dbull, -1, -1)                    \
    M(i64x2_extmul_low_i32x4_s, 0xfd000000000000dcull, -1, -1)      \
    M(i64x2_extmul_high_i32x4_s, 0xfd000000000000ddull, -1, -1)     \
    M(i64x2_extmul_low_i32x4_u, 0xfd000000000000deull, -1, -1)      \
    M(i64x2_extmul_high_i32x4_u, 0xfd000000000000dfull, -1, -1)     \
    M(f32x4_abs, 0xfd000000000000e0ull, -1, -1)                     \
    M(f32x4_neg, 0xfd000000000000e1ull, -1, -1)                     \
    M(f32x4_sqrt, 0xfd000000000000e3ull, -1, -1)                    \
    M(f32x4_add, 0xfd000000000000e4ull, -1, -1)                     \
    M(f32x4_sub, 0xfd000000000000e5ull, -1, -1)                     \
    M(f32x4_mul, 0xfd000000000000e6ull, -1, -1)                     \
    M(f32x4_div, 0xfd000000000000e7ull, -1, -1)                     \
    M(f32x4_min, 0xfd000000000000e8ull, -1, -1)                     \
    M(f32x4_max, 0xfd000000000000e9ull, -1, -1)                     \
    M(f32x4_pmin, 0xfd000000000000eaull, -1, -1)                    \
    M(f32x4_pmax, 0xfd000000000000ebull, -1, -1)                    \
    M(f64x2_abs, 0xfd000000000000ecull, -1, -1)                     \
    M(f64x2_neg, 0xfd000000000000edull, -1, -1)                     \
    M(f64x2_sqrt, 0xfd000000000000efull, -1, -1)                    \
    M(f64x2_add, 0xfd000000000000f0ull, -1, -1)                     \
    M(f64x2_sub, 0xfd000000000000f1ull, -1, -1)                     \
    M(f64x2_mul, 0xfd000000000000f2ull, -1, -1)                     \
    M(f64x2_div, 0xfd000000000000f3ull, -1, -1)                     \
    M(f64x2_min, 0xfd000000000000f4ull, -1, -1)                     \
    M(f64x2_max, 0xfd000000000000f5ull, -1, -1)                     \
    M(f64x2_pmin, 0xfd000000000000f6ull, -1, -1)                    \
    M(f64x2_pmax, 0xfd000000000000f7ull, -1, -1)                    \
...
#define ENUMERATE_SYNTHETIC_INSTRUCTION_OPCODES(M)              \
    ...
    M(synthetic_i32_storelocal, 0xfe00000000000003ull, 0, 0)    \
    M(synthetic_i64_storelocal, 0xfe00000000000004ull, 0, 0)    \
