...
public:
    ...
    constexpr Bytes bytes() [[clang::lifetimebound]] { return Bytes { &m_value, sizeof(m_value) }; }
    constexpr ReadonlyBytes bytes() const [[clang::lifetimebound]] { return ReadonlyBytes { &m_value, sizeof(m_value) }; }
