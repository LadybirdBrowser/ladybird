...
int main()
{
    ...
    struct BitmapViewLayoutAccessor : AK::BitmapView {
        using AK::BitmapView::m_data;
    };
    ...
    EMIT_OFFSET(DECLARATIVE_ENVIRONMENT_INITIALIZED_BINDINGS, DeclarativeEnvironment, m_initialized_bindings);
    ...
    outln("const INITIALIZED_BINDINGS_DATA_PTR = {}", offsetof(DeclarativeEnvironment, m_initialized_bindings) + offsetof(BitmapViewLayoutAccessor, m_data));
