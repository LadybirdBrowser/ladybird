...
size_t handle(Interpreter& interpreter, u8 const* bytecode, size_t program_counter);
template<typename OP>
size_t handle_generic(Interpreter& interpreter, u8 const* bytecode, size_t program_counter);
template<typename OP>
size_t handle_jump(Interpreter& interpreter, u8 const* bytecode, size_t program_counter);
