...
test("timezone offset", () => {
    ...
    expect(Date.parse("07/18/2019 11:22GMT")).toBeNaN(); // Firefox and Chrome expect a space between time and GMT/UTC. So do we.
    expect(Date.parse("07/18/2019 11:22UTC")).toBeNaN();
...
test("garbage", () => {
    ...
    expect(Date.parse("+- 2204 Jan 29")).toBeNaN(); // '+' accepted by Chrome rejected by Firefox in some weird conditions. We reject it always. FIXME
