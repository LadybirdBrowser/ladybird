...
field OBJECT_FLAGS Object.flags u8 = Object.m_flags
...
hex PROPERTY_LOOKUP_CACHE_DATA_POINTER_MASK = ~PropertyLookupCache::polymorphic_data_tag
...
raw field ExecutionContext.slots Sequence<Value> SIZEOF_EXECUTION_CONTEXT embedded
...
raw field ExecutionContext.accumulator Value EXECUTION_CONTEXT_ACCUMULATOR nullable accumulator_and_exception
raw field ExecutionContext.exception Value EXECUTION_CONTEXT_EXCEPTION nullable accumulator_and_exception pinned values EXCEPTION_REG_OFFSET
raw field ExecutionContext.this_value_register Value EXECUTION_CONTEXT_THIS_VALUE_REGISTER nullable pinned values THIS_VALUE_REG_OFFSET
raw field ExecutionContext.return_value Value EXECUTION_CONTEXT_RETURN_VALUE nullable return_and_saved_environment
raw field ExecutionContext.saved_lexical_environment Value EXECUTION_CONTEXT_SAVED_LEXICAL_ENVIRONMENT nullable return_and_saved_environment
...
raw field VM.primitive_storage_cage_base u64 VM_PRIMITIVE_STORAGE_CAGE_BASE nonnull
...
raw field VM.running_execution_context ExecutionContext VM_RUNNING_EXECUTION_CONTEXT nullable
raw field VM.interpreter_stack_top u64 VM_INTERPRETER_STACK_TOP nonnull interpreter_stack_bounds
raw field VM.interpreter_stack_limit u64 VM_INTERPRETER_STACK_LIMIT nonnull interpreter_stack_bounds
raw field VM.stack_base u64 VM_STACK_INFO_BASE nullable
...
raw field IndexedElements.capacity u32 INDEXED_ELEMENTS_CAPACITY nullable
const EXECUTABLE_BYTECODE_DATA = offsetof(Executable, bytecode) + InstructionStream::data_member_offset()
raw field Executable.bytecode_data u64 EXECUTABLE_BYTECODE_DATA nonnull
...
raw field Executable.property_lookup_caches PropertyLookupCaches EXECUTABLE_PROPERTY_LOOKUP_CACHES_DATA nonnull
...
raw field Executable.global_variable_caches GlobalVariableCaches EXECUTABLE_GLOBAL_VARIABLE_CACHES_DATA nonnull
...
raw field Executable.environment_coordinate_caches Sequence<EnvironmentCoordinateEntry> EXECUTABLE_ENVIRONMENT_COORDINATE_CACHES_DATA nullable
...
raw field ObjectPropertyIteratorCacheData.property_values Sequence<Value> OBJECT_PROPERTY_ITERATOR_CACHE_DATA_PROPERTY_VALUES_DATA nullable
raw field ObjectPropertyIteratorCacheData.property_value_count u64 OBJECT_PROPERTY_ITERATOR_CACHE_DATA_PROPERTY_VALUES_SIZE nullable
...
raw field GlobalVariableCache.property_offset u32 GLOBAL_VARIABLE_CACHE_ENTRY_PROPERTY_OFFSET nullable global_cache_details stride GLOBAL_VARIABLE_CACHE_SIZE
raw field GlobalVariableCache.shape_dictionary_generation u32 GLOBAL_VARIABLE_CACHE_ENTRY_DICTIONARY_GENERATION nullable global_cache_details
raw field GlobalVariableCache.shape Shape GLOBAL_VARIABLE_CACHE_ENTRY_SHAPE nullable
raw field GlobalVariableCache.environment_serial_number u64 GLOBAL_VARIABLE_CACHE_ENVIRONMENT_SERIAL nullable
raw field GlobalVariableCache.environment_binding_index u32 GLOBAL_VARIABLE_CACHE_ENVIRONMENT_BINDING_INDEX nullable
raw field GlobalVariableCache.has_environment_binding_index u8 GLOBAL_VARIABLE_CACHE_HAS_ENVIRONMENT_BINDING nullable
raw field GlobalVariableCache.in_module_environment u8 GLOBAL_VARIABLE_CACHE_IN_MODULE_ENVIRONMENT nullable
...
raw field FunctionObject.builtin u8 FUNCTION_OBJECT_BUILTIN_VALUE nullable
raw field FunctionObject.has_builtin bool FUNCTION_OBJECT_BUILTIN_HAS_VALUE nullable
section RawNativeFunction layout
field RAW_NATIVE_FUNCTION_NATIVE_FUNCTION RawNativeFunction.native_function u64 = RawNativeFunction.m_native_function nonnull
...
raw field PrimitiveString.utf16_data Utf16StringData PRIMITIVE_STRING_UTF16_STRING nullable
...
raw field PrimitiveString.utf16_short_string_byte_count_and_flag u8 PRIMITIVE_STRING_UTF16_SHORT_STRING_BYTE_COUNT_AND_FLAG nullable
raw field PrimitiveString.utf16_short_string_storage Sequence<u8> PRIMITIVE_STRING_UTF16_SHORT_STRING_STORAGE embedded
section Utf16StringData layout
offset UTF16_STRING_DATA_LENGTH_IN_CODE_UNITS = Utf16StringData.m_length_in_code_units
const UTF16_STRING_DATA_STRING_STORAGE = AK::Detail::Utf16StringData::offset_of_string_storage()
raw field Utf16StringData.length_in_code_units u64 UTF16_STRING_DATA_LENGTH_IN_CODE_UNITS nullable
raw field Utf16StringData.string_storage Sequence<u8> UTF16_STRING_DATA_STRING_STORAGE embedded
...
raw field DeclarativeEnvironment.binding_values BindingValues BINDING_VALUES_DATA_PTR nonnull
...
raw field DeclarativeEnvironmentRareData.binding_flags BindingFlags BINDING_FLAGS_DATA_PTR nonnull
...
raw field EnvironmentShape.binding_flags_size u64 ENVIRONMENT_SHAPE_BINDING_FLAGS_SIZE nullable
raw field EnvironmentShape.binding_flags BindingFlags ENVIRONMENT_SHAPE_BINDING_FLAGS_DATA_PTR nonnull
...
raw field EnvironmentCoordinateEntry.hops u32 ENVIRONMENT_COORDINATE_HOPS nullable environment_coordinate stride {ENVIRONMENT_COORDINATE_SIZE}
raw field EnvironmentCoordinateEntry.binding_index u32 ENVIRONMENT_COORDINATE_INDEX nullable environment_coordinate
...
raw field Object.typed_array_array_length u32 TYPED_ARRAY_ARRAY_LENGTH_VALUE nullable
