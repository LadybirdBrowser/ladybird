...
int main()
{
    ...
    struct PrimitiveStringLayoutAccessor : PrimitiveString {
        ...
        using PrimitiveString::m_length_in_utf16_code_units;
    ...
    EMIT_FIELD(PRIMITIVE_STRING_LENGTH_IN_UTF16_CODE_UNITS, PrimitiveString, length_in_utf16_code_units, u32, PrimitiveStringLayoutAccessor, m_length_in_utf16_code_units, 4, nullable, scalar);
