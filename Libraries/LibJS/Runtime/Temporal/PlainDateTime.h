...
private:
    PlainDateTime(ISODateTime const&, Utf16String calendar, Object& prototype);
...
ThrowCompletionOr<ISODateTime> interpret_temporal_date_time_fields(VM&, Utf16View calendar, CalendarFields&, Overflow);
...
ThrowCompletionOr<GC::Ref<PlainDateTime>> create_temporal_date_time(VM&, ISODateTime const&, Utf16String calendar, GC::Ptr<FunctionObject> new_target = {});
Utf16String iso_date_time_to_string(ISODateTime const&, Utf16View calendar, SecondsStringPrecision::Precision, ShowCalendar);
...
InternalDuration difference_iso_date_time(VM&, ISODateTime const&, ISODateTime const&, Utf16View calendar, Unit largest_unit);
ThrowCompletionOr<InternalDuration> difference_plain_date_time_with_rounding(VM&, ISODateTime const&, ISODateTime const&, Utf16View calendar, Unit largest_unit, u64 rounding_increment, Unit smallest_unit, RoundingMode);
ThrowCompletionOr<Crypto::BigFraction> difference_plain_date_time_with_total(VM&, ISODateTime const&, ISODateTime const&, Utf16View calendar, Unit);
