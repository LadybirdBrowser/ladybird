...
public:
    ...
    StringView usage_string() const [[clang::lifetimebound]] { return Unicode::usage_to_string(m_usage); }
    ...
    StringView sensitivity_string() const [[clang::lifetimebound]] { return Unicode::sensitivity_to_string(m_sensitivity); }
    ...
    StringView case_first_string() const [[clang::lifetimebound]] { return Unicode::case_first_to_string(m_case_first); }
