...
ThrowCompletionOr<Utf16String> canonicalize_unicode_locale_id(VM&, Utf16View locale);
...
ThrowCompletionOr<Utf16String> insert_unicode_extension_and_canonicalize(VM&, Unicode::LocaleID locale_id, Vector<Utf16String> attributes, Vector<Unicode::Keyword> keywords);
ThrowCompletionOr<ResolvedLocale> resolve_locale(VM&, ReadonlySpan<Utf16String> requested_locales, LocaleOptions const& options, ReadonlySpan<Utf16View> relevant_extension_keys);
