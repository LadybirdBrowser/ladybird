...
asm(".global ABSTRACT_OPERATIONS\n"
    "ABSTRACT_OPERATIONS:\n"
    ".incbin \"LibJS/Runtime/JavaScriptImplementations/AbstractOperations.js\"\n"
    ".global ABSTRACT_OPERATIONS_END\n"
    "ABSTRACT_OPERATIONS_END:\n"
    ".byte 0\n");
extern unsigned char const ABSTRACT_OPERATIONS[];
#endif
...
#else
// FIXME: Remove this asm hack when we upgrade to GCC 15.
asm(".global ARRAY_CONSTRUCTOR\n"
    "ARRAY_CONSTRUCTOR:\n"
    ".incbin \"LibJS/Runtime/JavaScriptImplementations/ArrayConstructor.js\"\n"
    ".global ARRAY_CONSTRUCTOR_END\n"
    "ARRAY_CONSTRUCTOR_END:\n"
    ".byte 0\n");
extern unsigned char const ARRAY_CONSTRUCTOR[];
#endif
...
// FIXME: Don't reparse the JS every time.
#define __JS_ENUMERATE(snake_name, functionName, length)                                                                                                                                                                                      \
    ...
    {                                                                                                                                                                                                                                         \
        if (!m_##snake_name##_abstract_operation_function) {                                                                                                                                                                                  \
            auto abstract_operations_function_declarations = parse_builtin_file(ABSTRACT_OPERATIONS);                                                                                                                                         \
...
#define __JS_ENUMERATE(snake_name, functionName, length)                                                                                                                                                                                     \
    ...
    {                                                                                                                                                                                                                                        \
        if (!m_##snake_name##_array_constructor_function) {                                                                                                                                                                                  \
            auto intrinsics_function_declarations = parse_builtin_file(ARRAY_CONSTRUCTOR);                                                                                                                                                   \
