...
public:
    ...
    [[nodiscard]] GC::Ref<Shape> normal_function_without_prototype_shape() { return *m_normal_function_without_prototype_shape; }
...
#undef __JS_ENUMERATE
    ...
    GC::Ptr<Shape> m_normal_function_without_prototype_shape;
