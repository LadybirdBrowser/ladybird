...
#undef __JS_ENUMERATE
    ...
    Function<Vector<FlyString>()> host_get_supported_import_attributes;
...
#undef __JS_ENUMERATE
    ...
    StoredModule* get_stored_module(ImportedModuleReferrer const& script_or_module, ByteString const& filename, FlyString const& type);
