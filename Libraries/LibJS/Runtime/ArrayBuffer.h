...
ThrowCompletionOr<GC::Ref<ArrayBuffer>> allocate_array_buffer(VM&, FunctionObject& constructor, size_t byte_length, Optional<size_t> const& max_byte_length = {});
ThrowCompletionOr<GC::Ref<ArrayBuffer>> array_buffer_copy_and_detach(VM&, ArrayBuffer& array_buffer, Value new_length, PreserveResizability preserve_resizability);
...
JS_API ThrowCompletionOr<GC::Ref<ArrayBuffer>> clone_array_buffer(VM&, ArrayBuffer& source_buffer, size_t source_byte_offset, size_t source_length);
