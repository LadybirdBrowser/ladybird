...
MetalCommandQueueHandle::MetalCommandQueueHandle(id command_queue) : m_command_queue(command_queue) {
...
MetalCommandQueueHandle::MetalCommandQueueHandle(MetalCommandQueueHandle&& other) noexcept : m_command_queue(other.m_command_queue) {
...
MetalCommandBufferHandle::MetalCommandBufferHandle(id command_buffer) : m_command_buffer(command_buffer) {
...
MetalCommandBufferHandle::MetalCommandBufferHandle(MetalCommandBufferHandle&& other) noexcept : m_command_buffer(other.m_command_buffer) {
...
MetalTextureHandle::MetalTextureHandle(id texture) : m_texture(texture) {
    [m_texture retain];
}
...
MetalTextureHandle::MetalTextureHandle(MetalTextureHandle&& other) noexcept : m_texture(other.m_texture) {
...
MetalBufferHandle::MetalBufferHandle(id buffer) : m_buffer(buffer) {
    [m_buffer retain];
}
...
MetalBufferHandle::MetalBufferHandle(MetalBufferHandle&& other) noexcept : m_buffer(other.m_buffer) {
...
MetalRenderCommandEncoderHandle::MetalRenderCommandEncoderHandle(id render_command_encoder) : m_render_command_encoder(render_command_encoder) {
...
MetalRenderCommandEncoderHandle::MetalRenderCommandEncoderHandle(MetalRenderCommandEncoderHandle&& other) noexcept : m_render_command_encoder(other.m_render_command_encoder) {
