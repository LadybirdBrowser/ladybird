...
public:
    ...
    ALWAYS_INLINE RegexResult match(StringView const& str, regex::PosixFlags flags = regex::PosixFlags::Insensitive) const
    {
    ...
    Precedence const& precedence() const
    {
        return m_precedence;
    }
    ...
    // Useful for switch/case on the group name when the group name is a character..
    ...
    ALWAYS_INLINE static bool does_group_match_char(regex::Match const& group, char c)
    {
