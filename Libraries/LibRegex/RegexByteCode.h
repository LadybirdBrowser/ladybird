...
public:
    ...
    ALWAYS_INLINE size_t size() const override { return 2; }
    ALWAYS_INLINE size_t body_length() const { return argument(0); }
    ByteString arguments_string() const override { return ByteString::formatted("check saved back body_length={}", body_length()); }
};
