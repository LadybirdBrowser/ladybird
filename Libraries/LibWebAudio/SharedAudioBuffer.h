...
public:
    static NonnullRefPtr<SharedAudioBuffer> create(f32 sample_rate, size_t channel_count,
...
private:
    SharedAudioBuffer(f32 sample_rate, size_t channel_count, size_t length_in_sample_frames,
