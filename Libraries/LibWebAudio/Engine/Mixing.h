...
public:
    ...
    void zero() { m_samples.span().slice(0, m_channel_count * m_frame_count).fill(0.0f); }
    ...
    [[nodiscard]] AudioBus clone_resized(size_t new_channel_count, size_t new_frame_count,
        size_t new_channel_capacity) const
    {
