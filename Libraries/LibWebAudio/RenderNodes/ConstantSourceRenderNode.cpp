...
#include <LibWebAudio/RenderNodes/ConstantSourceRenderNode.h>
...
ConstantSourceRenderNode::ConstantSourceRenderNode(NodeID node_id, ConstantSourceGraphNode const& desc,
    size_t quantum_size)
    : RenderNode(node_id)
...
void ConstantSourceRenderNode::process(RenderContext& context, Vector<Vector<AudioBus const*>> const&,
