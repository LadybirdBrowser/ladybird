...
AudioListenerRenderNode::AudioListenerRenderNode(NodeID node_id, size_t quantum_size,
    AudioListenerGraphNode const& desc)
    : RenderNode(node_id)
...
void AudioListenerRenderNode::process(RenderContext&, Vector<Vector<AudioBus const*>> const&,
