...
public:
    ...
    void process(RenderContext&, Vector<Vector<AudioBus const*>> const& inputs,
...
private:
    ...
    // Render-thread snapshots (double-buffered). These are written on the render thread and read on the control
    // thread.
