...
#include <LibWebAudio/RenderNodes/ChannelMergerRenderNode.h>
...
ChannelMergerRenderNode::ChannelMergerRenderNode(NodeID node_id, ChannelMergerGraphNode const& desc,
    size_t quantum_size)
    : RenderNode(node_id)
...
void ChannelMergerRenderNode::process(RenderContext&, Vector<Vector<AudioBus const*>> const& inputs,
