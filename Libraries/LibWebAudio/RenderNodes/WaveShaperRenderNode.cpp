...
WaveShaperRenderNode::WaveShaperRenderNode(NodeID node_id, WaveShaperGraphNode const& desc,
    size_t quantum_size)
    : RenderNode(node_id)
...
void WaveShaperRenderNode::ensure_oversample_storage(size_t channel_count, size_t oversampled_frames,
    size_t factor)
{
...
void WaveShaperRenderNode::process(RenderContext&, Vector<Vector<AudioBus const*>> const& inputs,
