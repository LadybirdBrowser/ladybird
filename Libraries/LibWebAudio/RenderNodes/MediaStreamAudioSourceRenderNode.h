...
class MediaStreamAudioSourceRenderNode final : public RenderNode {
public:
	MediaStreamAudioSourceRenderNode(NodeID node_id, NonnullRefPtr<MediaElementAudioSourceProvider> provider,
		size_t quantum_size);
...
private:
	...
	u8 m_resample_ratio_hold_quanta { 0 };
