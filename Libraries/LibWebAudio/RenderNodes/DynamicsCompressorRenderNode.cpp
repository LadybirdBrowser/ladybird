...
DynamicsCompressorRenderNode::DynamicsCompressorRenderNode(NodeID node_id,
    DynamicsCompressorGraphNode const& desc,
    size_t quantum_size)
    : RenderNode(node_id)
...
f32 DynamicsCompressorRenderNode::apply_compression_curve(f32 linear_input, f32 threshold_db, f32 knee_db,
    f32 ratio)
{
...
void DynamicsCompressorRenderNode::process(RenderContext& context,
