...
void DelayRenderNode::process(RenderContext& context, Vector<Vector<AudioBus const*>> const& inputs,
    Vector<Vector<AudioBus const*>> const& param_inputs)
{
    ...
    // WEBAUDIO_LOG bit 16 enables these logs.
    ...
    if (should_log_this_quantum) {
        ...
        WA_NODE_DBGLN(
            "[WebAudio][DelayNode:{}] frames={} sr={} out_ch={} node_ch={} ring_size={} frames_written={} "
            "max_delay={} base_delay={} has_param_input={} connections={} mixed0_ch={}",
            node_id(), frames, context.sample_rate, m_output.channel_count(), m_channel_count, m_ring_size,
            m_frames_written, m_max_delay_time_seconds, m_delay_time_seconds, has_delay_time_param_input,
            connection_count, input_channels);
    }
    ...
    for (size_t i = 0; i < frames; ++i) {
        ...
        if (should_log_this_quantum && i < 4) {
            ...
            WA_NODE_DBGLN("[WebAudio][DelayNode:{}] i={} delay_s={} delay_frames={} write={} read_pos={} idx0={} "
                          "idx1={} frac={} in0={} out0={}",
                node_id(), i, delay_seconds, delay_frames_d, m_write_index, read_pos, idx0, idx1, frac,
                in0, out0);
        }
...
void DelayRenderNode::process_cycle_writer(RenderContext& context,
...
void DelayRenderNode::process_cycle_reader(RenderContext& context,
    Vector<Vector<AudioBus const*>> const& param_inputs,
