...
#include <LibWebAudio/RenderNodes/StereoPannerRenderNode.h>

namespace Web::WebAudio::Render {

StereoPannerRenderNode::StereoPannerRenderNode(NodeID node_id, StereoPannerGraphNode const& desc,
    size_t quantum_size)
    : RenderNode(node_id)
    , m_pan(desc.pan)
...
void StereoPannerRenderNode::process(RenderContext&, Vector<Vector<AudioBus const*>> const& inputs,
