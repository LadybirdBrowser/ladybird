...
- If the node depends on heavy data (for example AudioBuffer PCM), publish it via the graph resource bag and only reference it by handle from the node description.
