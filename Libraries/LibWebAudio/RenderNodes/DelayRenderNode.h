...
public:
    ...
    void process(RenderContext& context, Vector<Vector<AudioBus const*>> const& inputs,
    ...
    void process_cycle_reader(RenderContext& context, Vector<Vector<AudioBus const*>> const& param_inputs,
        bool clamp_to_quantum);
