...
struct PannerGraphNode {
    ...
    {
        set_state(PannerParamIndex::position_x, position_x, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
        set_state(PannerParamIndex::position_y, position_y, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
        set_state(PannerParamIndex::position_z, position_z, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
        set_state(PannerParamIndex::orientation_x, orientation_x, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
        set_state(PannerParamIndex::orientation_y, orientation_y, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
        set_state(PannerParamIndex::orientation_z, orientation_z, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
    }
