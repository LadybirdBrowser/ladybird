...
OwnPtr<RenderNode> DynamicsCompressorGraphNode::make_render_node(NodeID node_id, size_t quantum_size,
...
GraphUpdateKind
DynamicsCompressorGraphNode::classify_update(DynamicsCompressorGraphNode const& new_desc) const
{
    ASSERT_CONTROL_THREAD();
