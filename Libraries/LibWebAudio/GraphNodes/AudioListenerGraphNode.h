...
struct AudioListenerGraphNode {
    ...
    {
        set_state(AudioListenerParamIndex::position_x, position_x, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
        set_state(AudioListenerParamIndex::position_y, position_y, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
        set_state(AudioListenerParamIndex::position_z, position_z, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
        set_state(AudioListenerParamIndex::forward_x, forward_x, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
        set_state(AudioListenerParamIndex::forward_y, forward_y, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
        set_state(AudioListenerParamIndex::forward_z, forward_z, NumericLimits<f32>::lowest(),
            NumericLimits<f32>::max());
