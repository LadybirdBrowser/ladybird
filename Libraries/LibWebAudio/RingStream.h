...
ErrorOr<RingStreamView> validate_ring_stream_descriptor(RingStreamDescriptor&);

size_t ring_stream_pop_planar(RingStreamView, u64 read_frame, size_t frames_to_read,
...
public:
    ...
    RingStreamPopResult try_pop_planar_with_timing(Span<Span<f32>> out_channels, size_t requested_frames,
        u32 expected_channel_count) const;
    size_t try_pop_planar(Span<Span<f32>> out_channels, size_t requested_frames,
        u32 expected_channel_count) const;
...
public:
    ...
    RingHeader& header() const;
    void initialize_format(u32 sample_rate_hz, u32 channel_count, u32 channel_capacity,
