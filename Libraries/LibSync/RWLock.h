...
// NOTE: When RWLock is templated to support interprocess locks make this a private member
static consteval u64 get_rwlock_storage_size()
{
#ifdef AK_OS_WINDOWS
    return 8;
#else
...
private:
    alignas(void*) unsigned char m_storage[Detail::get_rwlock_storage_size()];
};
