...
public:
    ...
    virtual DecoderErrorOr<void> receive_coded_data(AK::Duration timestamp, AK::Duration decode_timestamp, AK::Duration duration, ReadonlyBytes coded_data) override;
