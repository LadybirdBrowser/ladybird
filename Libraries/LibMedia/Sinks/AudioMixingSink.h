...
public:
    ...
    AudioMixingSink(NonnullRefPtr<Audio::SingleSinkSessionClient>);
...
protected:
    ...
    struct TapState : public RefCounted<TapState> {
        TapState(TapCallback callback, Optional<Audio::SampleSpecification> override_sample_specification)
            : callback(move(callback))
            , override_sample_specification(override_sample_specification)
        {
        }

        TapCallback callback;
        Optional<Audio::SampleSpecification> override_sample_specification;
    };
