...
{
    auto name = Utf16String::from_utf8_without_validation(track_entry.name());
    auto language = [&] {
        ...
        if (track_entry.language_bcp_47().has_value())
            return Utf16String::from_utf8_without_validation(track_entry.language_bcp_47().value());
        return Utf16String::from_utf8_without_validation(track_entry.language());
    }();
