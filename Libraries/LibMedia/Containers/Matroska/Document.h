...
public:
    ...
    Utf8View muxing_app() const [[clang::lifetimebound]] { return Utf8View(m_muxing_app); }
    void set_muxing_app(ByteString muxing_app) { m_muxing_app = move(muxing_app); }
    Utf8View writing_app() const [[clang::lifetimebound]] { return Utf8View(m_writing_app); }
...
public:
    ...
    ReadonlyBytes codec_private_data() const [[clang::lifetimebound]] { return m_codec_private_data.span(); }
