...
struct DeviceInfo {
    ...
    {
        return type == other.type && device_handle == other.device_handle && label == other.label && dom_device_id == other.dom_device_id && group_id == other.group_id && sample_rate_hz == other.sample_rate_hz && channel_count == other.channel_count && channel_layout == other.channel_layout && is_default == other.is_default;
    }
};
