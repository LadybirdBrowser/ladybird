...
ErrorOr<void> SingleSinkSessionClient::request_output_sink(OutputSinkReadyHandler on_ready, OutputSinkFailedHandler on_failed, DeviceHandle device_handle, u32 target_latency_ms)
{
