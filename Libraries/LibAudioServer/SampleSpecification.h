...
public:
    ...
    bool is_valid() const { return m_sample_rate > 0 && m_channel_map.channel_count() > 0; }
...
struct Formatter<Audio::SampleSpecification> : StandardFormatter {
    ...
    {
        return builder.builder().try_appendff("{} Hz, {}", sample_specification.sample_rate(),
            sample_specification.channel_map());
    }
};
