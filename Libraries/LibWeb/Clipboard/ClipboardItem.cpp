...
WebIDL::ExceptionOr<GC::Ref<ClipboardItem>> ClipboardItem::construct_impl(JS::Realm& realm, GC::OrderedRootHashMap<Utf16String, GC::Ref<WebIDL::Promise>> const& items, Bindings::ClipboardItemOptions const& options)
{
...
WebIDL::ExceptionOr<GC::Ref<WebIDL::Promise>> ClipboardItem::get_type(Utf16String const& type)
{
    ...
    auto mime_type_serialized = Utf16String::from_utf8(mime_type->serialized());
...
bool ClipboardItem::supports(JS::VM&, Utf16View type)
{
