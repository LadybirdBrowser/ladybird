...
GC::Ref<ClipboardEvent> ClipboardEvent::construct_impl(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::ClipboardEventInit const& event_init)
{
    return realm.create<ClipboardEvent>(realm, event_name, event_init);
}

ClipboardEvent::ClipboardEvent(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::ClipboardEventInit const& event_init)
