...
struct NamedViewTransitionPseudoElement
...
struct ReplacedNamedViewTransitionPseudoElement
    ...
    ReplacedNamedViewTransitionPseudoElement(CSS::PseudoElement, FlyString);

    RefPtr<Gfx::Bitmap> m_content;
};
...
struct CapturedElement : public JS::Cell {
    ...
    Optional<Gfx::Filter> old_backdrop_filter = {};
