...
ReplacedNamedViewTransitionPseudoElement::ReplacedNamedViewTransitionPseudoElement(CSS::PseudoElement type, FlyString view_transition_name)
...
void ViewTransition::setup_transition_pseudo_elements()
{
    ...
    for (auto [transition_name, captured_element] : m_named_elements) {
        ...
        if (captured_element->old_image) {
            ...
            auto old = heap().allocate<ReplacedNamedViewTransitionPseudoElement>(CSS::PseudoElement::ViewTransitionOld, transition_name);
            old->m_content = captured_element->old_image;
