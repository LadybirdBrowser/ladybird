...
public:
    ...
    GC::Ref<SVGAnimatedString> href()
    {
        ...
        if (!m_href_animated_string) {
            ...
            m_href_animated_string = SVGAnimatedString::create(this_svg_element.realm(), this_svg_element, DOM::QualifiedName { AttributeNames::href, OptionalNone {}, OptionalNone {} }, supports_xlink_href == SupportsXLinkHref::Yes ? Optional<DOM::QualifiedName> { DOM::QualifiedName { AttributeNames::href, "xlink"_fly_string, Namespace::XLink } } : OptionalNone {});
        }
