...
public:
    ...
    REFLECT_ANIMATED_LENGTH_ATTRIBUTE(x, CSS::PercentageStyleValue::create(CSS::Percentage { 0 }));

    // https://drafts.csswg.org/filter-effects-1#dom-svgfilterprimitivestandardattributes-y
    REFLECT_ANIMATED_LENGTH_ATTRIBUTE(y, CSS::PercentageStyleValue::create(CSS::Percentage { 0 }));
...
private:
    ...
    GC::Ref<SVGAnimatedLength> svg_animated_length_for_attribute(Utf16FlyString const& attribute_name, NonnullRefPtr<CSS::StyleValue const>&& default_value)
    {
        return this_svg_element()->svg_animated_length_for_attribute(attribute_name, move(default_value));
    }
