...
ImageBox::ImageBox(DOM::Document& document, GC::Ptr<DOM::Element> element, CSS::LayoutStyle style, ImageProvider const& image_provider)
...
ImageBox::ImageBox(DOM::Document& document, GC::Ptr<DOM::Element> element, CSS::LayoutStyle style, NonnullOwnPtr<ImageProvider> image_provider)
    : ReplacedBox(document, element, style)
