...
class WritableStream final
    ...
    WEB_WRAPPABLE(WritableStream, Bindings::GCAllocatedWrappable);
...
public:
    ...
    static WebIDL::ExceptionOr<GC::Ref<WritableStream>> create_for_constructor(JS::Object&, GC::Ptr<JS::Object> underlying_sink_object, QueuingStrategy const& = {});
