...
WebIDL::ExceptionOr<void> set_up_writable_stream_default_controller_from_underlying_sink(JS::Realm&, WritableStream&, JS::Value underlying_sink_value, UnderlyingSink const&, double high_water_mark, GC::Ref<SizeAlgorithm> size_algorithm);
