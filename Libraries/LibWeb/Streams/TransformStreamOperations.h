...
void initialize_transform_stream(JS::Realm&, TransformStream&, GC::Ref<WebIDL::Promise> start_promise, double writable_high_water_mark, GC::Ref<SizeAlgorithm> writable_size_algorithm, double readable_high_water_mark, GC::Ref<SizeAlgorithm> readable_size_algorithm);
...
void transform_stream_set_backpressure(JS::Realm&, TransformStream&, bool backpressure);
...
void set_up_transform_stream_default_controller_from_transformer(TransformStream&, JS::Value transformer, Transformer const&);
void set_up_transform_stream_default_controller_from_transformer(JS::Realm&, TransformStream&, JS::Value transformer, Transformer const&);
...
WebIDL::ExceptionOr<void> transform_stream_default_controller_enqueue(JS::Realm&, TransformStreamDefaultController&, JS::Value chunk);
