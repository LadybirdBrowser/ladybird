...
WebIDL::ExceptionOr<GC::Ref<WritableStream>> WritableStream::create_for_constructor(JS::Object& relevant_global_object, GC::Ptr<JS::Object> underlying_sink_object, QueuingStrategy const& strategy)
{
