...
WebIDL::ExceptionOr<GC::Ref<ReadableStreamBYOBReader>> acquire_readable_stream_byob_reader(JS::Realm&, ReadableStream&);
WebIDL::ExceptionOr<GC::Ref<ReadableStreamDefaultReader>> acquire_readable_stream_default_reader(JS::Realm&, ReadableStream&);
...
WebIDL::ExceptionOr<GC::Ref<ReadableStream>> readable_stream_from_iterable(JS::Realm&, JS::Value async_iterable);
GC::Ref<WebIDL::Promise> readable_stream_pipe_to(JS::Realm&, ReadableStream& source, WritableStream& dest, bool prevent_close, bool prevent_abort, bool prevent_cancel, GC::Ptr<DOM::AbortSignal> signal = {});
...
GC::Ref<WebIDL::Promise> readable_stream_cancel(JS::Realm&, ReadableStream&, JS::Value reason);
...
void readable_stream_reader_generic_initialize(JS::Realm&, ReadableStreamReader const&, ReadableStream&);
...
WebIDL::ExceptionOr<void> set_up_readable_stream_byob_reader(JS::Realm&, ReadableStreamBYOBReader&, ReadableStream&);
WebIDL::ExceptionOr<void> set_up_readable_stream_default_reader(JS::Realm&, ReadableStreamDefaultReader&, ReadableStream&);
...
WebIDL::ExceptionOr<void> readable_stream_default_controller_enqueue(JS::Realm&, ReadableStreamDefaultController&, JS::Value chunk);
...
WebIDL::ExceptionOr<void> set_up_readable_stream_default_controller(JS::Realm&, ReadableStream&, ReadableStreamDefaultController&, GC::Ref<StartAlgorithm>, GC::Ref<PullAlgorithm>, GC::Ref<CancelAlgorithm>, double high_water_mark, GC::Ref<SizeAlgorithm>);
WebIDL::ExceptionOr<void> set_up_readable_stream_default_controller_from_underlying_source(JS::Realm&, ReadableStream&, JS::Value underlying_source_value, Bindings::UnderlyingSource, double high_water_mark, GC::Ref<SizeAlgorithm>);
...
WebIDL::ExceptionOr<void> readable_byte_stream_controller_close(JS::Realm&, ReadableByteStreamController&);
void readable_byte_stream_controller_commit_pull_into_descriptor(JS::Realm&, ReadableStream&, PullIntoDescriptor const&);
JS::Value readable_byte_stream_controller_convert_pull_into_descriptor(JS::Realm&, PullIntoDescriptor const&);
WebIDL::ExceptionOr<void> readable_byte_stream_controller_enqueue(JS::Realm&, ReadableByteStreamController& controller, JS::Value chunk);
WebIDL::ExceptionOr<void> readable_byte_stream_controller_enqueue_native_bytes(JS::Realm&, ReadableByteStreamController& controller, ByteBuffer bytes);
...
WebIDL::ExceptionOr<void> readable_byte_stream_controller_enqueue_cloned_chunk_to_queue(JS::Realm&, ReadableByteStreamController& controller, JS::ArrayBuffer& buffer, u64 byte_offset, u64 byte_length);
WebIDL::ExceptionOr<void> readable_byte_stream_controller_enqueue_detached_pull_into_to_queue(JS::Realm&, ReadableByteStreamController& controller, PullIntoDescriptor& pull_into_descriptor);
...
void readable_byte_stream_controller_fill_read_request_from_queue(JS::Realm&, ReadableByteStreamController&, ReadRequest&);
GC::Ptr<ReadableStreamBYOBRequest> readable_byte_stream_controller_get_byob_request(JS::Realm&, ReadableByteStreamController&);
...
void readable_byte_stream_controller_process_read_requests_using_queue(JS::Realm&, ReadableByteStreamController& controller);
void readable_byte_stream_controller_pull_into(JS::Realm&, ReadableByteStreamController&, WebIDL::ArrayBufferView&, u64 min, ReadIntoRequest&);
WebIDL::ExceptionOr<void> readable_byte_stream_controller_respond(JS::Realm&, ReadableByteStreamController&, u64 bytes_written);
void readable_byte_stream_controller_respond_in_closed_state(JS::Realm&, ReadableByteStreamController&, PullIntoDescriptor&);
WebIDL::ExceptionOr<void> readable_byte_stream_controller_respond_in_readable_state(JS::Realm&, ReadableByteStreamController&, u64 bytes_written, PullIntoDescriptor&);
WebIDL::ExceptionOr<void> readable_byte_stream_controller_respond_internal(JS::Realm&, ReadableByteStreamController&, u64 bytes_written);
...
WebIDL::ExceptionOr<void> set_up_readable_byte_stream_controller(JS::Realm&, ReadableStream&, ReadableByteStreamController&, GC::Ref<StartAlgorithm>, GC::Ref<PullAlgorithm>, GC::Ref<CancelAlgorithm>, double high_water_mark, JS::Value auto_allocate_chunk_size);
WebIDL::ExceptionOr<void> set_up_readable_byte_stream_controller_from_underlying_source(JS::Realm&, ReadableStream&, JS::Value underlying_source, Bindings::UnderlyingSource const& underlying_source_dict, double high_water_mark);
