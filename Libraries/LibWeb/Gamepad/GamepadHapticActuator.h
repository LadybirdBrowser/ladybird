...
class GamepadHapticActuator final : public Bindings::GCAllocatedWrappable {
    WEB_WRAPPABLE(GamepadHapticActuator, Bindings::GCAllocatedWrappable);
...
public:
    ...
    void play_effect(GamepadHapticEffectType, GamepadEffectParameters const&, GC::Ref<WebIDL::Promise>);
    void reset(GC::Ref<WebIDL::Promise>);
