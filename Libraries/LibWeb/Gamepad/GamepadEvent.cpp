...
GC::Ref<GamepadEvent> GamepadEvent::create(Utf16FlyString const& event_name, GamepadEventInit const& gamepad_event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
{
    return GC::Heap::the().allocate<GamepadEvent>(event_name, gamepad_event_init, time_stamp);
}

GamepadEvent::GamepadEvent(Utf16FlyString const& event_name, GamepadEventInit const& event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
