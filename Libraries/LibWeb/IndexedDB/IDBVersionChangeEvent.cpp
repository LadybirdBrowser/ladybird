...
GC::Ref<IDBVersionChangeEvent> IDBVersionChangeEvent::create(Utf16FlyString const& event_name, IDBVersionChangeEventInit const& event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
{
    return GC::Heap::the().allocate<IDBVersionChangeEvent>(event_name, event_init, time_stamp);
}

GC::Ref<IDBVersionChangeEvent> IDBVersionChangeEvent::create(Utf16FlyString const& event_name, Bindings::IDBVersionChangeEventInit const& event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
{
...
IDBVersionChangeEvent::IDBVersionChangeEvent(Utf16FlyString const& event_name, IDBVersionChangeEventInit const& event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
