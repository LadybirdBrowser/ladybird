...
GC::Ref<IDBVersionChangeEvent> IDBVersionChangeEvent::create(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::IDBVersionChangeEventInit const& event_init)
{
