...
WebIDL::ExceptionOr<GC::Ref<IDBObjectStore>> IDBDatabase::create_object_store(Utf16String const& name, ObjectStoreParameters const& options)
{
...
WebIDL::ExceptionOr<GC::Ref<IDBTransaction>> IDBDatabase::transaction(Variant<Utf16String, Vector<Utf16String>> store_names, TransactionMode mode, TransactionOptions options)
{
