...
public:
    [[nodiscard]] static GC::Ref<Index> create(GC::Ref<ObjectStore>, Utf16String const&, KeyPath const&, bool, bool);
    virtual ~Index();
    ...
    HTML::StorageSerializationRecord const& referenced_value(IndexRecord const& index_record) const;
