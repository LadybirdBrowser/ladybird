...
public:
    ...
    [[nodiscard]] static GC::Ref<Key> create_string(Utf16String const& value) { return create(String, value); }
    ...
    [[nodiscard]] static GC::Ref<Key> create_invalid(Utf16String const& value) { return create(Invalid, value); }
