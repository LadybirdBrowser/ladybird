...
GC::Ref<AudioWorkletEnvironmentSettingsObject> AudioWorkletEnvironmentSettingsObject::setup(GC::Ref<Page> page, NonnullOwnPtr<JS::ExecutionContext> execution_context, GC::Ref<AudioWorkletGlobalScope> global_scope, HTML::SerializedEnvironmentSettingsObject const& outside_settings, URL::URL const& global_scope_url)
{
