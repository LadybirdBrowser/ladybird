...
public:
    ...
    GC::Ref<WebIDL::Promise> decode_audio_data(BaseAudioContext&, GC::Root<JS::ArrayBuffer> const& audio_data, GC::Ptr<WebIDL::CallbackType> success_callback, GC::Ptr<WebIDL::CallbackType> error_callback);
