...
public:
    explicit RenderGraph(Render::GraphDescription const& description, f32 sample_rate, size_t quantum_size, Render::GraphResources const& resources);
    ~RenderGraph();
...
private:
    ...
    Render::GraphResources const& m_resources;
