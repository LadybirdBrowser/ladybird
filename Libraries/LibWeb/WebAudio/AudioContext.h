...
private:
    ...
    bool m_output_device_open_in_progress { false };

    struct PendingRenderThreadStateAck {
        Optional<GC::Ref<WebIDL::Promise>> promise;
        u64 generation { 0 };
        bool suspended { false };
    };

    u64 m_next_suspend_generation { 1 };
    ...
    void snapshot_render_graph_and_prepare_resources(Render::GraphResources& resources, Render::GraphDescription& out_graph_description);
