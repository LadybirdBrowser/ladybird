...
#include <AK/Vector.h>
#include <LibWeb/Bindings/IIRFilterNode.h>
...
public:
    ...
    WebIDL::ExceptionOr<void> get_frequency_response(GC::Root<JS::Float32Array> const& frequency_hz, GC::Root<JS::Float32Array> const& mag_response, GC::Root<JS::Float32Array> const& phase_response);
