...
GC::Ref<DOM::Event> BaseAudioContext::create_associated_event(FlyString const& event_name) const
{
...
{
    auto task = HTML::Task::create(m_media_element_event_task_source.source, HTML::current_settings_object().responsible_document(), steps);
