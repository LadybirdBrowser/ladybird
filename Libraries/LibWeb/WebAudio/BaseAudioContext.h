...
protected:
    ...
    Atomic<u8>& render_thread_suspended_atomic() { return m_render_thread_suspended; }
    Atomic<u64>& render_thread_suspend_generation_atomic() { return m_render_thread_suspend_generation; }
...
private:
    ...
    // Suspend state published by the rendering backend.
    Atomic<u8> m_render_thread_suspended { 1 };
    Atomic<u64> m_render_thread_suspend_generation { 0 };
