...
public:
    ...
    WebIDL::ExceptionOr<GC::Ref<ScriptProcessorNode>> create_script_processor(WebIDL::UnsignedLong buffer_size = 0, WebIDL::UnsignedLong number_of_input_channels = 2, WebIDL::UnsignedLong number_of_output_channels = 2);
