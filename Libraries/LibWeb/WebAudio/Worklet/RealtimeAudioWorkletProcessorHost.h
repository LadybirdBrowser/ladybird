...
public:
    ...
    void prepare_render_thread_state(u64 current_frame, float sample_rate, bool pump_event_loop);
    void service_worklet_event_loop(u64 current_frame, float sample_rate);
...
private:
    ...
    static void evaluate_modules(RenderThreadState&, Vector<WorkletModule> const&);
