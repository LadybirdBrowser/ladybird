...
template<>
ErrorOr<void> encode(Encoder&, Web::WebAudio::Render::WorkletParameterDataEntry const&);

template<>
ErrorOr<Web::WebAudio::Render::WorkletParameterDataEntry> decode(Decoder&);

template<>
ErrorOr<void> encode(Encoder&, Web::WebAudio::Render::WorkletNodeDefinition const&);

template<>
ErrorOr<Web::WebAudio::Render::WorkletNodeDefinition> decode(Decoder&);
