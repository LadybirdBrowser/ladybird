...
// - BufferSource node descriptions contain metadata and buffer_id but omit PCM channels.
// - MediaElementSource provider_id is kept; the actual provider must be supplied out-of-band.
