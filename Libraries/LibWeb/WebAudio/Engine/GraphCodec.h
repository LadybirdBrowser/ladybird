...
WEB_API ErrorOr<EncodedRenderGraph> encode_render_graph_for_media_server(GraphDescription const&, f32 context_sample_rate, GraphResourceResolver const&);
...
WEB_API ErrorOr<WireGraphBuildResult> decode_render_graph_wire_format(ReadonlyBytes bytes, Span<SharedAudioBufferBinding const> shared_audio_buffers = {});
