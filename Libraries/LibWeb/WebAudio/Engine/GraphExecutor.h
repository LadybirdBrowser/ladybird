...
public:
    explicit GraphExecutor(GraphDescription const& description, f32 sample_rate, GraphResourceResolver const* resources = nullptr);
    ~GraphExecutor();
...
private:
    ...
    struct Topology {
        ...
        // Nodes required for this graph's work (destination + analysers + dependencies).
        Vector<u8> is_needed;
