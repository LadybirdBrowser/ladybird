...
#define ENUMERATE_GRAPH_NODE_TYPES(X)           \
    ...
    X(BufferSource, "BufferSource")             \
    X(MediaElementSource, "MediaElementSource") \
...
#undef ENUMERATE_GRAPH_NODE_TYPES
...
struct RenderParamLayout {
    ...
    static constexpr size_t param_count(Render::GraphNodeType type)
    {
        ...
        case Render::GraphNodeType::BufferSource:
