...
public:
    ...
    OfflineAudioWorkletProcessorHost(GC::Ref<JS::Realm> worklet_realm,
        HashMap<NodeID, GC::Root<JS::Object>>& processor_instances);

    bool process_audio_worklet(NodeID node_id, RenderContext& process_context, String const&, size_t, size_t,
        Span<size_t const>, Vector<Vector<AudioBus const*>> const& inputs,
