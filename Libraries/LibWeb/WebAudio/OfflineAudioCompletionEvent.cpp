...
WebIDL::ExceptionOr<GC::Ref<OfflineAudioCompletionEvent>> OfflineAudioCompletionEvent::construct_impl(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::OfflineAudioCompletionEventInit const& event_init)
{
    return realm.create<OfflineAudioCompletionEvent>(realm, event_name, event_init);
}

OfflineAudioCompletionEvent::OfflineAudioCompletionEvent(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::OfflineAudioCompletionEventInit const& event_init)
