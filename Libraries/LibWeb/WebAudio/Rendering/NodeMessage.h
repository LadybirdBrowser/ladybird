...
using NodeMessage = Variant<StartSource, StopSource, StartBufferSource, SetBufferSourceParameters, SetOscillatorWaveform, SetBiquadFilterType, SetMediaElementSourceOutputSilenced, SetPannerParameters, SetMediaStreamSourceRing>;
