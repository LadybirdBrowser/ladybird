...
GC::Ref<WebIDL::Promise> ServiceWorkerContainer::get_registration(String const& client_url)
{
    ...
    Platform::EventLoopPlugin::the().deferred_invoke(GC::create_function(realm.heap(), [&realm, this, promise, storage_key, parsed_client_url]() mutable {
        ...
        auto registration_object = HTML::relevant_settings_object(*this).get_service_worker_registration_object(maybe_registration.value());
