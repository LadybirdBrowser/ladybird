...
Registration::Registration(RegistrationKey key, StorageAPI::StorageKey storage_key, URL::URL scope, Bindings::ServiceWorkerUpdateViaCache update_via_cache)
    : m_key(move(key))
...
Registration& Registration::set(StorageAPI::StorageKey const& storage_key, URL::URL const& scope, Bindings::ServiceWorkerUpdateViaCache update_via_cache)
{
    ...
    (void)s_registrations.set(key, Registration(key, storage_key, scope, update_via_cache));
