...
public:
    ...
    Optional<Utf16String> aria_active_descendant_or_default() const;
    bool aria_atomic_or_default(bool default_value = false) const;
    AriaAutocomplete aria_auto_complete_or_default() const;
    Utf16String aria_braille_label_or_default() const;
    Utf16String aria_braille_role_description_or_default() const;
    ...
    Utf16String aria_col_index_text_or_default() const;
    Optional<i32> aria_col_span_or_default() const;
    Vector<Utf16String> aria_controls_or_default() const;
    AriaCurrent aria_current_or_default() const;
    Vector<Utf16String> aria_described_by_or_default() const;
    Utf16String aria_description_or_default() const;
    Optional<Utf16String> aria_details_or_default() const;
    bool aria_disabled_or_default() const;
    Vector<AriaDropEffect> aria_drop_effect_or_default() const;
    Optional<Utf16String> aria_error_message_or_default() const;
    Optional<bool> aria_expanded_or_default() const;
    Vector<Utf16String> aria_flow_to_or_default() const;
    ...
    Utf16String aria_key_shortcuts_or_default() const;
    Utf16String aria_label_or_default() const;
    Vector<Utf16String> aria_labelled_by_or_default() const;
    ...
    Vector<Utf16String> aria_owns_or_default() const;
    Utf16String aria_placeholder_or_default() const;
    ...
    Utf16String aria_role_description_or_default() const;
    Optional<i32> aria_row_count_or_default() const;
    Optional<i32> aria_row_index_or_default() const;
    Utf16String aria_row_index_text_or_default() const;
...
private:
    ...
    static bool parse_true_false(Optional<Utf16String> const&);

    // https://www.w3.org/TR/wai-aria-1.2/#valuetype_tristate
    // The default value for this value type is undefined unless otherwise specified.
    static Tristate parse_tristate(Optional<Utf16String> const&);

    // https://www.w3.org/TR/wai-aria-1.2/#valuetype_true-false-undefined
    // The default value for this value type is undefined unless otherwise specified.
    static Optional<bool> parse_true_false_undefined(Optional<Utf16String> const&);

    // https://www.w3.org/TR/wai-aria-1.2/#valuetype_integer
    static Optional<i32> parse_integer(Optional<Utf16String> const&);

    // https://www.w3.org/TR/wai-aria-1.2/#valuetype_number
    static Optional<f64> parse_number(Optional<Utf16String> const&);

    static AriaAutocomplete parse_aria_autocomplete(Optional<Utf16String> const&);
    static AriaCurrent parse_aria_current(Optional<Utf16String> const&);
    ...
    static Optional<bool> parse_optional_true_false(Optional<Utf16String> const&);

    Optional<Utf16String> m_aria_active_descendant;
    Optional<bool> m_aria_atomic;
    AriaAutocomplete m_aria_auto_complete;
    Utf16String m_aria_braille_label;
    Utf16String m_aria_braille_role_description;
    bool m_aria_busy;
    Tristate m_aria_checked;
    Optional<i32> m_aria_col_count;
    Optional<i32> m_aria_col_index;
    Utf16String m_aria_col_index_text;
    Optional<i32> m_aria_col_span;
    Vector<Utf16String> m_aria_controls;
    AriaCurrent m_aria_current;
    Vector<Utf16String> m_aria_described_by;
    Utf16String m_aria_description;
    Optional<Utf16String> m_aria_details;
    bool m_aria_disabled;
    Vector<AriaDropEffect> m_aria_drop_effect;
    Optional<Utf16String> m_aria_error_message;
    Optional<bool> m_aria_expanded;
    Vector<Utf16String> m_aria_flow_to;
    Optional<bool> m_aria_grabbed;
    AriaHasPopup m_aria_has_popup;
    Optional<bool> m_aria_hidden;
    AriaInvalid m_aria_invalid;
    Utf16String m_aria_key_shortcuts;
    Utf16String m_aria_label;
    Vector<Utf16String> m_aria_labelled_by;
    ...
    Vector<Utf16String> m_aria_owns;
    Utf16String m_aria_placeholder;
    ...
    Utf16String m_aria_role_description;
    Optional<i32> m_aria_row_count;
    Optional<i32> m_aria_row_index;
    Utf16String m_aria_row_index_text;
