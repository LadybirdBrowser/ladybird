...
GC::Ref<CustomEvent> CustomEvent::create_for_constructor(Utf16String const& event_name, CustomEventInit const& event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
{
    return create(FlyString { event_name.to_utf8() }, event_init, time_stamp);
}
