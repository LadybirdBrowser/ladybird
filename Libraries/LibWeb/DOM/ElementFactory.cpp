...
{
    if (html_element_interface_name == "HTMLAnchorElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::a });
    if (html_element_interface_name == "HTMLAreaElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::area });
    if (html_element_interface_name == "HTMLAudioElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::audio });
    if (html_element_interface_name == "HTMLBaseElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::base });
    if (html_element_interface_name == "HTMLBodyElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::body });
    if (html_element_interface_name == "HTMLBRElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::br });
    if (html_element_interface_name == "HTMLButtonElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::button });
    if (html_element_interface_name == "HTMLCanvasElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::canvas });
    if (html_element_interface_name == "HTMLDataElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::data });
    if (html_element_interface_name == "HTMLDataListElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::datalist });
    if (html_element_interface_name == "HTMLDetailsElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::details });
    if (html_element_interface_name == "HTMLDialogElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::dialog });
    if (html_element_interface_name == "HTMLDirectoryElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::dir });
    if (html_element_interface_name == "HTMLDivElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::div });
    if (html_element_interface_name == "HTMLDListElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::dl });
    if (html_element_interface_name == "HTMLEmbedElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::embed });
    if (html_element_interface_name == "HTMLFieldSetElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::fieldset });
    if (html_element_interface_name == "HTMLFontElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::font });
    if (html_element_interface_name == "HTMLFormElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::form });
    if (html_element_interface_name == "HTMLFrameElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::frame });
    if (html_element_interface_name == "HTMLFrameSetElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::frameset });
    if (html_element_interface_name == "HTMLHeadElement"_sv)
        return FixedArray<FlyString>::create({ HTML::TagNames::head });
    if (html_element_interface_name == "HTMLHeadingElement"_sv)
