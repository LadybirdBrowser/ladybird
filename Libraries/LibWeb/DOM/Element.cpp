...
GC::Ref<WebIDL::Promise> Element::request_fullscreen()
{
    ...
    Platform::EventLoopPlugin::the().deferred_invoke(GC::create_function(heap(), [&realm, error, pending_doc, element = GC::Ref<Element> { *this }, promise]() mutable {
        ...
        if (error != RequestFullscreenError::False) {
            ...
            HTML::queue_global_task(HTML::Task::Source::UserInteraction, realm.global_object(), GC::create_function(realm.heap(), [&realm, error, promise]() {
