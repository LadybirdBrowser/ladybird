...
WebIDL::ExceptionOr<void> Attr::set_value(String value)
{
    ...
    // 2. Otherwise:
        ...
        if (owner_element() != original_element) {
            return {};
        }
