...
public:
    ...
    [[nodiscard]] static GC::Ref<HTMLCollection> create(ParentNode& root, Scope, ESCAPING Function<bool(Element const&)> filter, Function<bool(Element const&, Element const&)> sort = nullptr);
...
protected:
    HTMLCollection(ParentNode& root, Scope, ESCAPING Function<bool(Element const&)> filter, Function<bool(Element const&, Element const&)> sort = nullptr);
