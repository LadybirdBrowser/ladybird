...
public:
    ...
    Utf16FlyString const& slot_name() const { return m_name; } // Not called `name` to distinguish from `Element::name`.
    void set_slot_name(Utf16FlyString name) { m_name = move(name); }
