...
struct ScrollbarColorData {
    Gfx::Color thumb_color { Gfx::Color::Transparent };
    Gfx::Color track_color { Gfx::Color::Transparent };
};
...
public:
    ...
    static Gfx::Color caret_color() { return Gfx::Color::Black; }
    ...
    static Gfx::Color color() { return Gfx::Color::Black; }
    static Gfx::Color stop_color() { return Gfx::Color::Black; }
    static Filter backdrop_filter() { return Filter::make_none(); }
    static Filter filter() { return Filter::make_none(); }
    static Gfx::Color background_color() { return Gfx::Color::Transparent; }
    ...
    static Gfx::Color flood_color() { return Gfx::Color::Black; }
    ...
    static Gfx::Color outline_color() { return Gfx::Color::Black; }
    ...
    static ScrollbarColorData scrollbar_color()
    {
        return ScrollbarColorData {
            .thumb_color = Gfx::Color(Gfx::Color::NamedColor::DarkGray).with_alpha(192),
            .track_color = Gfx::Color(Gfx::Color::NamedColor::WarmGray).with_alpha(192),
        };
    }
...
public:
    ...
    Gfx::Color caret_color() const { return m_inherited.caret_color; }
    ...
    Gfx::Color text_decoration_color() const { return m_noninherited.text_decoration_color; }
    ...
    Optional<Gfx::Color> accent_color() const { return m_inherited.accent_color; }
    ...
    Gfx::Color color() const { return m_inherited.color; }
    Gfx::Color background_color() const { return m_noninherited.background_color; }
    ...
    Gfx::Color webkit_text_fill_color() const { return m_inherited.webkit_text_fill_color; }
    ...
    Gfx::Color stop_color() const { return m_noninherited.stop_color; }
    ...
    Gfx::Color flood_color() const { return m_noninherited.flood_color; }
    ...
    Gfx::Color outline_color() const { return m_noninherited.outline_color; }
...
protected:
    struct InheritedValues {
        Gfx::Color caret_color { InitialValues::caret_color() };
        ...
        Gfx::Color color { InitialValues::color() };
        ...
        Optional<Gfx::Color> accent_color {};
        Gfx::Color webkit_text_fill_color { InitialValues::color() };
    ...
    struct NonInheritedValues {
        ...
        Gfx::Color text_decoration_color { InitialValues::color() };
        ...
        Gfx::Color background_color { InitialValues::background_color() };
        ...
        Gfx::Color flood_color { InitialValues::flood_color() };
        ...
        Gfx::Color outline_color { InitialValues::outline_color() };
...
public:
    ...
    void set_caret_color(Gfx::Color caret_color) { m_inherited.caret_color = caret_color; }
    ...
    void set_color(Gfx::Color color) { m_inherited.color = color; }
    ...
    void set_background_color(Gfx::Color color) { m_noninherited.background_color = color; }
    ...
    void set_text_decoration_color(Gfx::Color value) { m_noninherited.text_decoration_color = value; }
    ...
    void set_webkit_text_fill_color(Gfx::Color value) { m_inherited.webkit_text_fill_color = value; }
    ...
    void set_accent_color(Gfx::Color value) { m_inherited.accent_color = value; }
    ...
    void set_stop_color(Gfx::Color value) { m_noninherited.stop_color = value; }
    ...
    void set_outline_color(Gfx::Color value) { m_noninherited.outline_color = value; }
    ...
    void set_flood_color(Gfx::Color value) { m_noninherited.flood_color = value; }
