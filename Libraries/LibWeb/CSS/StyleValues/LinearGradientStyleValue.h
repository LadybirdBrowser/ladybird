...
public:
    ...
    void paint(PaintContext& context, DevicePixelRect const& dest_rect, CSS::ImageRendering image_rendering, CSS::ImageOrientation image_orientation) const override;
