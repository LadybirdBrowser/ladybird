...
public:
    static NonnullRefPtr<NonMathFunctionCalculationNode const> create(Parser::Function, NumericType);
    ...
    Parser::Function function() const { return m_function; }

private:
    NonMathFunctionCalculationNode(Parser::Function, NumericType);
    Parser::Function m_function;
};
