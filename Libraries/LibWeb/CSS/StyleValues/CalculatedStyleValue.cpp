...
static GC::Ptr<CSSNumericArray> reify_children(JS::Realm& realm, ReadonlySpan<NonnullRefPtr<CalculationNode const>> children)
{
    ...
    for (auto const& child : children) {
        ...
        if (!reified_child)
            return nullptr;
        reified_children.append(reified_child.release_nonnull());
    }
...
GC::Ptr<CSSNumericValue> SumCalculationNode::reify(JS::Realm& realm) const
{
    ...
    if (!reified_children)
        return nullptr;
    return CSSMathSum::create(realm, numeric_type().value(), reified_children.release_nonnull());
}
...
GC::Ptr<CSSNumericValue> ProductCalculationNode::reify(JS::Realm& realm) const
{
    ...
    if (!reified_children)
        return nullptr;
    return CSSMathProduct::create(realm, numeric_type().value(), reified_children.release_nonnull());
}
...
GC::Ptr<CSSNumericValue> NegateCalculationNode::reify(JS::Realm& realm) const
{
    ...
    if (!reified_value)
        return nullptr;
    return CSSMathNegate::create(realm, numeric_type().value(), reified_value.release_nonnull());
}
...
GC::Ptr<CSSNumericValue> InvertCalculationNode::reify(JS::Realm& realm) const
{
    ...
    if (!reified_value)
        return nullptr;
    return CSSMathInvert::create(realm, numeric_type().value(), reified_value.release_nonnull());
}
...
GC::Ptr<CSSNumericValue> MinCalculationNode::reify(JS::Realm& realm) const
{
    ...
    if (!reified_children)
        return nullptr;
    return CSSMathMin::create(realm, numeric_type().value(), reified_children.release_nonnull());
}
...
GC::Ptr<CSSNumericValue> MaxCalculationNode::reify(JS::Realm& realm) const
{
    ...
    if (!reified_children)
        return nullptr;
    return CSSMathMax::create(realm, numeric_type().value(), reified_children.release_nonnull());
}
...
GC::Ptr<CSSNumericValue> ClampCalculationNode::reify(JS::Realm& realm) const
{
    ...
    return CSSMathClamp::create(realm, numeric_type().value(), lower.release_nonnull(), value.release_nonnull(), upper.release_nonnull());
}
