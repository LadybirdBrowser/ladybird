...
GC::Ref<CSSStyleSheet> StyleSheetList::create_a_css_style_sheet(Utf16View css_text, DOM::Element* owner_node, Utf16View media, Utf16String title, Alternate alternate, OriginClean origin_clean, Optional<::URL::URL> location, CSSStyleSheet* parent_style_sheet, CSSRule* owner_rule, StyleEngineUpdate style_engine_update)
{
    ...
    initialize_a_css_style_sheet(*sheet, owner_node, media, move(title), alternate, origin_clean, parent_style_sheet, owner_rule, style_engine_update);
    return sheet;
}

void StyleSheetList::initialize_a_css_style_sheet(CSSStyleSheet& sheet, DOM::Element* owner_node, Utf16View media, Utf16String title, Alternate alternate, OriginClean origin_clean, CSSStyleSheet* parent_style_sheet, CSSRule* owner_rule, StyleEngineUpdate style_engine_update)
{
