...
static RefPtr<CSSStyleValue const> style_value_for_shadow(Vector<ShadowData> const& shadow_data)
{
    ...
    auto make_shadow_style_value = [](ShadowData const& shadow) {
        return ShadowStyleValue::create(
            CSSColorValue::create_from_color(shadow.color, LegacySyntax::No),
...
RefPtr<CSSStyleValue const> ResolvedCSSStyleDeclaration::style_value_for_property(Layout::NodeWithStyle const& layout_node, PropertyID property_id) const
{
    ...
    case PropertyID::BackgroundColor:
        return CSSColorValue::create_from_color(layout_node.computed_values().background_color(), LegacySyntax::No);
    case PropertyID::BorderBottomColor:
        return CSSColorValue::create_from_color(layout_node.computed_values().border_bottom().color, LegacySyntax::No);
    case PropertyID::BorderLeftColor:
        return CSSColorValue::create_from_color(layout_node.computed_values().border_left().color, LegacySyntax::No);
    case PropertyID::BorderRightColor:
        return CSSColorValue::create_from_color(layout_node.computed_values().border_right().color, LegacySyntax::No);
    case PropertyID::BorderTopColor:
        return CSSColorValue::create_from_color(layout_node.computed_values().border_top().color, LegacySyntax::No);
    case PropertyID::BoxShadow:
        return style_value_for_shadow(layout_node.computed_values().box_shadow());
    case PropertyID::Color:
        return CSSColorValue::create_from_color(layout_node.computed_values().color(), LegacySyntax::No);
    case PropertyID::OutlineColor:
        return CSSColorValue::create_from_color(layout_node.computed_values().outline_color(), LegacySyntax::No);
    case PropertyID::TextDecorationColor:
        return CSSColorValue::create_from_color(layout_node.computed_values().text_decoration_color(), LegacySyntax::No);
    ...
    case PropertyID::WebkitTextFillColor:
        return CSSColorValue::create_from_color(layout_node.computed_values().webkit_text_fill_color(), LegacySyntax::No);
