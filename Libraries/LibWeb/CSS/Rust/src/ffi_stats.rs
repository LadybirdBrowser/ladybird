...
define_ffi_ops! {
    ...
    LonghandCascadedValueCallback => "longhandCascadedValueCallbacks",
    LonghandInheritedValueCallback => "longhandInheritedValueCallbacks",
    LonghandInitialValueCallback => "longhandInitialValueCallbacks",
