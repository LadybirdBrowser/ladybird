...
WEB_API StyleValueFFI::FfiNumericType invoke_rust_numeric_type_operate(StyleValueFFI::FfiNumericTypeOperation operation, StyleValueFFI::FfiNumericType const* first, StyleValueFFI::FfiNumericType const* second);
