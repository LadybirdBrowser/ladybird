...
public:
    ...
    GC::Ref<CSSStyleSheet> create_a_css_style_sheet(Utf16View css_text, String type, DOM::Element* owner_node, Utf16View media, Utf16String title, Alternate, OriginClean, Optional<::URL::URL> location, CSSStyleSheet* parent_style_sheet, CSSRule* owner_rule);
