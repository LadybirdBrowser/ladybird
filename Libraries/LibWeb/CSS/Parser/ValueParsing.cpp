...
NonnullRefPtr<CSSStyleValue const> Parser::resolve_unresolved_style_value(ParsingParams const& context, DOM::Element& element, Optional<PseudoElement> pseudo_element, PropertyIDOrCustomPropertyName property, UnresolvedStyleValue const& unresolved)
{
    ...
    return parser.resolve_unresolved_style_value(abstract_element, property, unresolved);
}
...
NonnullRefPtr<CSSStyleValue const> Parser::resolve_unresolved_style_value(DOM::AbstractElement& element, PropertyIDOrCustomPropertyName property, UnresolvedStyleValue const& unresolved)
{
