...
using JSONBaseValue = Variant<Empty, u16, u32, bool, AK::String>;
using JSONValue = Variant<JSONBaseValue, Vector<JSONBaseValue>>;
struct JSONObject {
    OrderedHashMap<AK::String, Variant<JSONValue, JSONObject>> value;
};
...
WebIDL::ExceptionOr<AK::String> serialize_javascript_value_to_json_string(JS::VM&, JS::Value);
WebIDL::ExceptionOr<ByteBuffer> serialize_javascript_value_to_json_bytes(JS::VM&, JS::Value);
AK::String serialize_an_infra_value_to_a_json_string(JS::Realm&, JSONTopLevel const&);
