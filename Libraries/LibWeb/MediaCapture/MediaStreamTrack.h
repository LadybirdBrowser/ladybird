...
public:
    static GC::Ref<MediaStreamTrack> create_audio_input_track(JS::Realm&, Media::Capture::AudioInputDeviceID device_id, u32 sample_rate_hz, u32 channel_count, Optional<String> label = {});
    ...
    Optional<Media::Capture::AudioInputDeviceID> audio_input_device_id() const { return m_audio_input_device_id; }
...
private:
    ...
    Optional<Media::Capture::AudioInputDeviceID> m_audio_input_device_id;
