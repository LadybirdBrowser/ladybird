...
GC::Ref<MediaStreamTrack> MediaStreamTrack::create_audio_input_track(JS::Realm& realm, AudioServer::AudioInputDeviceID device_id, u32 sample_rate_hz, u32 channel_count, Optional<String> label)
{
...
GC::Ref<MediaStreamTrack> MediaStreamTrack::clone() const
{
    ...
    // FIXME: ConstrainablePattern state is not modeled yet.
