...
Optional<TrustedTypeData const&> get_trusted_type_data_for_attribute(String const& element, String const& attribute, Optional<String> const& attribute_ns)
{
    // 1. Let data be null.
...
#define __ENUMERATE(attribute_name, event_name)                                                                \
    if (attribute == HTML::AttributeNames::attribute_name) {                                                   \
        ...
        return TrustedTypeData { "Element"_string, {}, attribute, "TrustedScript"_string, "Element "_string }; \
    }
