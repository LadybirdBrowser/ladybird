...
public:
    ...
    GC::Ref<TrustedHTML const> empty_html() const { return m_empty_html; }
    GC::Ref<TrustedScript const> empty_script() const { return m_empty_script; }
...
private:
    ...
    GC::Ref<TrustedHTML const> const m_empty_html;

    // https://www.w3.org/TR/trusted-types/#dom-trustedtypepolicyfactory-emptyscript
    GC::Ref<TrustedScript const> const m_empty_script;
};
