...
GC::Ref<ScrollTimeline> ScrollTimeline::create(JS::Realm& realm, DOM::Document& document, GC::Ptr<DOM::Element> source, Bindings::ScrollAxis axis)
{
...
GC::Ref<ScrollTimeline> ScrollTimeline::construct_impl(JS::Realm& realm, ScrollTimelineOptions options)
{
    ...
    auto source = [&]() -> GC::Ptr<DOM::Element> {
        ...
        if (document.scrolling_element())
            return const_cast<DOM::Element&>(*document.scrolling_element());
...
ScrollTimeline::ScrollTimeline(JS::Realm& realm, DOM::Document& document, GC::Ptr<DOM::Element> source, Bindings::ScrollAxis axis)
...
Variant<GC::Ptr<DOM::Element>, GC::Ptr<DOM::Document>> ScrollTimeline::get_propagated_source() const
{
