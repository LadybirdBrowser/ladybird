...
public:
    static GC::Ref<ScrollTimeline> create(JS::Realm&, DOM::Document&, GC::Ptr<DOM::Element> source, Bindings::ScrollAxis axis);
    ...
    GC::Ptr<DOM::Element> source() const { return m_source; }
...
private:
    ScrollTimeline(JS::Realm&, DOM::Document&, GC::Ptr<DOM::Element> source, Bindings::ScrollAxis axis);
    virtual ~ScrollTimeline() override = default;

    virtual void visit_edges(Cell::Visitor&) override;
    virtual void initialize(JS::Realm&) override;

    Variant<GC::Ptr<DOM::Element>, GC::Ptr<DOM::Document>> get_propagated_source() const;
