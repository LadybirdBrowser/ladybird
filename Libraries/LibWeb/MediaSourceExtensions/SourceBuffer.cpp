...
{
    auto& relevant_global_object = media_source.relevant_global_object();
    set_wrapper_realm_hint(relevant_global_object);
    m_audio_tracks->set_wrapper_realm_hint(relevant_global_object);
    m_video_tracks->set_wrapper_realm_hint(relevant_global_object);
    m_text_tracks->set_wrapper_realm_hint(relevant_global_object);
