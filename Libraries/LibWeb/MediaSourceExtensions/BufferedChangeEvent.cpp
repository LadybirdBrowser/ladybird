...
WebIDL::ExceptionOr<GC::Ref<BufferedChangeEvent>> BufferedChangeEvent::construct_impl(JS::Realm& realm, Utf16FlyString const& type, Bindings::BufferedChangeEventInit const& event_init)
{
    return realm.create<BufferedChangeEvent>(realm, type, event_init);
}

BufferedChangeEvent::BufferedChangeEvent(JS::Realm& realm, Utf16FlyString const& type, Bindings::BufferedChangeEventInit const& event_init)
