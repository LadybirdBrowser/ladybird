...
public:
    ...
    [[nodiscard]] static GC::Ref<BufferedChangeEvent> create(Utf16String const& type, BufferedChangeEventInit const&, HighResolutionTime::DOMHighResTimeStamp);

private:
    BufferedChangeEvent(FlyString const& type, BufferedChangeEventInit const&, HighResolutionTime::DOMHighResTimeStamp);
    BufferedChangeEvent(Utf16FlyString const& type, BufferedChangeEventInit const&, HighResolutionTime::DOMHighResTimeStamp);
