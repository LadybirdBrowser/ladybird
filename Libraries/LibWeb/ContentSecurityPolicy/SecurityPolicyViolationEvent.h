...
public:
    ...
    String document_uri() const { return m_document_uri; }
    String referrer() const { return m_referrer; }
    String blocked_uri() const { return m_blocked_uri; }
    String violated_directive() const { return m_violated_directive; }
    String effective_directive() const { return m_effective_directive; }
    String original_policy() const { return m_original_policy; }
    String source_file() const { return m_source_file; }
    String sample() const { return m_sample; }
