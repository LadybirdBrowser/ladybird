...
Directive::Result ScriptSourceAttributeDirective::inline_check(JS::Realm&, GC::Ptr<DOM::Element const> element, InlineType type, GC::Ref<Policy const> policy, String const& source) const
{
