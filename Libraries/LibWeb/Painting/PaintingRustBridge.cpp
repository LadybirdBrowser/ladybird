...
Layout::RustFFI::FfiPaintHostCallbacks paint_host_callbacks(PaintHostContext& context)
{
    return {
        ...
        .text_fragment_indication_facts = [](void*, void* layout_node_shell, size_t dom_start, size_t dom_end, void* range_sink) -> Layout::RustFFI::FfiTextFragmentIndicationFacts {
            ...
            facts.mark_color = CSS::SystemColor::mark(text_node->document().page().preferred_color_scheme()).value();
            facts.mark_text_color = CSS::SystemColor::mark_text(text_node->document().page().preferred_color_scheme()).value();
            return facts;
        },
