...
WEB_API Optional<BordersData> borders_data_for_outline(Layout::Node const&, CSS::Color outline_color, CSS::OutlineStyle outline_style, CSSPixels outline_width);
