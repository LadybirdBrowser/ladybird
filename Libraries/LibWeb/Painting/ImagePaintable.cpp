    ...
    if (phase == PaintPhase::Foreground) {
        ...
        if (m_renders_as_alt_text) {
            if (!m_alt_text.is_empty()) {
                ...
                context.display_list_recorder().draw_text(enclosing_rect, Utf16String::from_utf8(m_alt_text), *Platform::FontPlugin::the().default_font(12), Gfx::TextAlignment::Center, computed_values().color().resolved());
            }
