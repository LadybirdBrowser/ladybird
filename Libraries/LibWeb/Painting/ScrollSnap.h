...
WEB_API SnapAxes snap_axes_of_scroll_container(Paintable const& snap_container);

WEB_API bool is_scroll_snap_container(Paintable const&);
...
WEB_API SnapDestination adjust_scroll_destination_for_snapping(Paintable const& snap_container, CSSPixelPoint destination, SnapSelectionStrategy const& strategy = {});
...
WEB_API SnapDestination select_resnap_destination(Paintable const& snap_container, CSSPixelPoint current_offset, ResnapSelection const&);
