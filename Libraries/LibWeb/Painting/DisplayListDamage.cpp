    ...
    Gfx::IntRect viewport_rect)
{
    ...
    bool damage_is_bounded = Layout::RustFFI::display_list_compute_damage(
        old_display_list_commands.data(), old_display_list_commands.size(), old_visual_context_tree.rust_tree(), old_scroll_offsets.data(), old_scroll_offsets.size(),
        new_display_list_commands.data(), new_display_list_commands.size(), new_visual_context_tree.rust_tree(), new_scroll_offsets.data(), new_scroll_offsets.size(),
