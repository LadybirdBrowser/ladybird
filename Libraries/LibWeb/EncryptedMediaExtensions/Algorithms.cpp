...
Vector<Bindings::MediaKeySystemMediaCapability> get_supported_capabilities_for_audio_video_type(RefPtr<KeySystem> implementation, CapabilitiesType type, Vector<Bindings::MediaKeySystemMediaCapability> requested_capabilities, Bindings::MediaKeySystemConfiguration config, MediaKeyRestrictions restrictions)
{
    ...
    for (auto& capability : requested_capabilities) {
        ...
        // 15. If robustness is not the empty string and contains an unrecognized value or
        // a value not supported by implementation, continue to the next iteration.
        ...
        // the combination of container, media types, encryption scheme, robustness and local accumulated configuration in combination with restrictions:
...
Optional<ConsentConfiguration> get_supported_configuration_and_consent(RefPtr<KeySystem> implementation, Bindings::MediaKeySystemConfiguration const& candidate_configuration, MediaKeyRestrictions& restrictions, URL::Origin const& origin)
{
    ...
    case ConsentStatus::InformUser:
        ...
        // the information that Distinctive Identifier(s) and/or Distinctive Permanent Identifier(s) as appropriate will be used
        // if the distinctiveIdentifier member of accumulated configuration is "required".
