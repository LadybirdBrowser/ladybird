...
static Vector<ErrorCodeData> const& error_code_data()
{
    static auto const& data = *new Vector<ErrorCodeData> {
...
{
    auto const& error_code_data = WebDriver::error_code_data()[to_underlying(code)];
