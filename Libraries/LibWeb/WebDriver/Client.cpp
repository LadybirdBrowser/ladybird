...
using RouteHandler = NonnullRefPtr<WebDriver::Promise<JsonValue>> (*)(Client&, Parameters, JsonValue);
...
ErrorOr<NonnullRefPtr<WebDriver::Promise<JsonValue>>, Client::WrappedError> Client::handle_request(HTTP::HttpRequest const& request, JsonValue body)
{
