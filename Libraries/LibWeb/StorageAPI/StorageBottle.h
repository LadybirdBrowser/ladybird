...
String storage_cache_key(StorageEndpointType, u64 page_id, String const& storage_key);
...
protected:
    StorageBottle(Optional<u64> quota, StorageEndpointType endpoint_type, u64 page_id, String const& storage_key)
        : m_quota(quota)
