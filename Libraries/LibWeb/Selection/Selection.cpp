...
{
    GC::Ptr<DOM::Document> selection_document = document();
    ...
    auto is_focus_in_document_tree = focus && &focus->document() == selection_document;
    auto is_anchor_in_document_tree = anchor && &anchor->document() == selection_document;
