...
GC::Ref<MessageChannel> MessageChannel::create_for_constructor(JS::Object& relevant_global_object)
{
    auto* global_scope = window_or_worker_global_scope_from_global_object(relevant_global_object);
    VERIFY(global_scope);
