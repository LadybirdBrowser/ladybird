...
JS::ThrowCompletionOr<GC::Ref<OffscreenCanvas>> HTMLCanvasElement::transfer_control_to_offscreen()
{
    ...
    auto is_valid = m_context.visit([&](GC::Ref<CanvasRenderingContext2D>&) { return false; }, [&](GC::Ref<WebGL::WebGLRenderingContext>&) { return false; }, [&](GC::Ref<WebGL::WebGL2RenderingContext>&) { return false; }, [&](GC::Ref<OffscreenCanvas>&) { return false; }, [](Empty) { return true; });
    if (!is_valid) {
