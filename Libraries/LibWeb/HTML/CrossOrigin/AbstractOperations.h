...
Vector<CrossOriginProperty> cross_origin_properties(Variant<GC::Ref<HTML::Location const>, GC::Ref<HTML::Window const>> const&);
...
Optional<JS::PropertyDescriptor> cross_origin_get_own_property_helper(Variant<GC::Ref<HTML::Location>, GC::Ref<HTML::Window>> const&, JS::PropertyKey const&);
...
GC::RootVector<JS::Value> cross_origin_own_property_keys(Variant<GC::Ref<HTML::Location const>, GC::Ref<HTML::Window const>> const&);
