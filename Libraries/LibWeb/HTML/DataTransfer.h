...
class DataTransfer : public Bindings::GCAllocatedWrappable {
    WEB_WRAPPABLE(DataTransfer, Bindings::GCAllocatedWrappable);
...
public:
    ...
    ReadonlySpan<Utf16String> types_list() const;
