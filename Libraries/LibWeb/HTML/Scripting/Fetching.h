...
using PerformTheFetchHook = GC::Ptr<GC::Function<Coroutine<WebIDL::ExceptionOr<void>>(GC::Ref<Fetch::Infrastructure::Request>, TopLevelModule, Fetch::Infrastructure::FetchAlgorithms::ProcessResponseConsumeBodyFunction)>>;
...
WEB_API PerformTheFetchHook create_perform_the_fetch_hook(GC::Heap& heap, Function<Coroutine<WebIDL::ExceptionOr<void>>(GC::Ref<Fetch::Infrastructure::Request>, TopLevelModule, Fetch::Infrastructure::FetchAlgorithms::ProcessResponseConsumeBodyFunction)> function);
...
Coroutine<WebIDL::ExceptionOr<GC::Ref<ClassicScript>>> fetch_a_classic_worker_imported_script(URL::URL const&, HTML::EnvironmentSettingsObject&, PerformTheFetchHook = nullptr);
