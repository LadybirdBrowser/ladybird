...
GC::Ref<BeforeUnloadEvent> BeforeUnloadEvent::create(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::EventInit const& event_init)
{
...
BeforeUnloadEvent::BeforeUnloadEvent(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::EventInit const& event_init)
