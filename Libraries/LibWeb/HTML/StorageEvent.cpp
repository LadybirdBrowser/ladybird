...
GC::Ref<StorageEvent> StorageEvent::create(Utf16FlyString const& event_name, StorageEventInit const& event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
{
...
StorageEvent::StorageEvent(Utf16FlyString const& event_name, StorageEventInit const& event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
