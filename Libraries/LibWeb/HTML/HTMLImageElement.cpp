...
Optional<ARIA::Role> HTMLImageElement::default_role() const
{
    ...
    // N.B. The “image” role value is a synonym for the older “img” role value; however, the el-img test in
    // https://wpt.fyi/results/html-aam/roles.html expects the value to be “image” (not “img”).
    if (!alt().is_empty())
        return ARIA::Role::image;
    // https://www.w3.org/TR/html-aria/#el-img-empty-alt
    // N.B. The “none” role value is a synonym for the older “presentation” role value; however, the el-img-alt-no-value
