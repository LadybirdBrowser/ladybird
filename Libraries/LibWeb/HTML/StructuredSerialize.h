...
//         surrounding agent (e.g. AudioWorkletNode's processorOptions crossing into a same-thread
//         worklet realm), where the gate's threat model does not apply. Web-visible entry points
