...
Optional<Utf16String> DataTransferItem::string_data() const
{
...
GC::Ptr<EntriesAPI::FileSystemEntry> DataTransferItem::webkit_get_as_entry() const
{
    ...
    return EntriesAPI::FileSystemEntry::create(EntriesAPI::EntryType::File, item.file_name.to_utf8().to_byte_string());
}
