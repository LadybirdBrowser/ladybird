...
WebIDL::ExceptionOr<GC::Ptr<DataTransferItem>> DataTransferItemList::add(Utf16String const& data, Utf16String const& type)
{
    ...
    // DOMException.
    if (m_data_transfer->contains_item_with_type(DragDataStoreItem::Kind::Text, type.utf16_view()))
    ...
    auto lowercase_type = type.to_ascii_lowercase();
    auto item = m_data_transfer->add_item({
        .kind = HTML::DragDataStoreItem::Kind::Text,
        .type_string = Utf16FlyString::from_utf16(lowercase_type.utf16_view()),
        .data = data,
        .file_data = {},
        .file_name = {},
    });
