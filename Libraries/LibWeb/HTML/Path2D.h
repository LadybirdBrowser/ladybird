...
public:
    static WebIDL::ExceptionOr<GC::Ref<Path2D>> construct_impl(JS::Realm&, Optional<Variant<GC::Ref<Path2D>, Utf16String>> const& path);
...
private:
    Path2D(JS::Realm&, Optional<Variant<GC::Ref<Path2D>, Utf16String>> const&);
