...
GC::Ref<ErrorEvent> ErrorEvent::create(Utf16FlyString const& event_name, ErrorEventInit const& event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
{
...
ErrorEvent::ErrorEvent(Utf16FlyString const& event_name, ErrorEventInit const& event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
