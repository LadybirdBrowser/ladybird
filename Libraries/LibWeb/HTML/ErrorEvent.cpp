...
GC::Ref<ErrorEvent> ErrorEvent::create(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::ErrorEventInit const& event_init)
{
...
WebIDL::ExceptionOr<GC::Ref<ErrorEvent>> ErrorEvent::construct_impl(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::ErrorEventInit const& event_init)
{
    return realm.create<ErrorEvent>(realm, event_name, event_init);
}

ErrorEvent::ErrorEvent(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::ErrorEventInit const& event_init)
