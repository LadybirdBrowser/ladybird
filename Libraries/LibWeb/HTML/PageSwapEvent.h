...
public:
    ...
    [[nodiscard]] static GC::Ref<PageSwapEvent> create(Utf16String const& event_name, PageSwapEventInit const&, HighResolutionTime::DOMHighResTimeStamp);
...
private:
    ...
    PageSwapEvent(Utf16FlyString const& event_name, PageSwapEventInit const&, HighResolutionTime::DOMHighResTimeStamp);
