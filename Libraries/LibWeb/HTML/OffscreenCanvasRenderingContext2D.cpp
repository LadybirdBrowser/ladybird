...
GC::Ref<OffscreenCanvasRenderingContext2D> OffscreenCanvasRenderingContext2D::create(JS::Realm& realm, OffscreenCanvas& offscreen_canvas)
{
    return realm.create<OffscreenCanvasRenderingContext2D>(realm, offscreen_canvas);
}

OffscreenCanvasRenderingContext2D::OffscreenCanvasRenderingContext2D(JS::Realm& realm, OffscreenCanvas& offscreen_canvas)
...
void OffscreenCanvasRenderingContext2D::put_image_data(ImageData const&, float, float)
