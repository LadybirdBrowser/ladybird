...
GC::Ref<DragEvent> DragEvent::create(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::DragEventInit const& event_init, double page_x, double page_y, double offset_x, double offset_y)
{
    return realm.create<DragEvent>(realm, event_name, event_init, page_x, page_y, offset_x, offset_y);
}

WebIDL::ExceptionOr<GC::Ref<DragEvent>> DragEvent::construct_impl(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::DragEventInit const& event_init)
{
...
DragEvent::DragEvent(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::DragEventInit const& event_init, double page_x, double page_y, double offset_x, double offset_y)
