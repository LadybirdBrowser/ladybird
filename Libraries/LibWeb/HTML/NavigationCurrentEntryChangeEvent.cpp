...
GC::Ref<NavigationCurrentEntryChangeEvent> NavigationCurrentEntryChangeEvent::construct_impl(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::NavigationCurrentEntryChangeEventInit const& event_init)
{
    return realm.create<NavigationCurrentEntryChangeEvent>(realm, event_name, event_init);
}

NavigationCurrentEntryChangeEvent::NavigationCurrentEntryChangeEvent(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::NavigationCurrentEntryChangeEventInit const& event_init)
