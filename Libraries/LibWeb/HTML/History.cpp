...
WebIDL::ExceptionOr<Bindings::ScrollRestoration> History::scroll_restoration() const
{
    ...
    // FIXME: Using the document's node navigable instead. Spec issue:https://github.com/whatwg/html/issues/11209
    auto scroll_restoration_mode = document.navigable()->active_session_history_entry()->scroll_restoration_mode();
...
WebIDL::ExceptionOr<void> History::set_scroll_restoration(Bindings::ScrollRestoration scroll_restoration)
{
    ...
    // FIXME: Using the document's node navigable instead. Spec issue:https://github.com/whatwg/html/issues/11209
    auto active_session_history_entry = document.navigable()->active_session_history_entry();
