...
GC::Ref<ToggleEvent> ToggleEvent::create(JS::Realm& realm, FlyString const& event_name, Bindings::ToggleEventInit const& event_init)
{
...
WebIDL::ExceptionOr<GC::Ref<ToggleEvent>> ToggleEvent::construct_impl(JS::Realm& realm, FlyString const& event_name, Bindings::ToggleEventInit const& event_init)
{
    return create(realm, event_name, move(event_init));
}

ToggleEvent::ToggleEvent(JS::Realm& realm, FlyString const& event_name, Bindings::ToggleEventInit const& event_init)
