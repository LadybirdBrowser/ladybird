...
class DataTransferItem : public Bindings::GCAllocatedWrappable {
    WEB_WRAPPABLE(DataTransferItem, Bindings::GCAllocatedWrappable);
...
public:
    ...
    Optional<Utf16String> string_data() const;
