...
JS::ThrowCompletionOr<void> upgrade_custom_element(DOM::Element& element, GC::Ref<HTML::CustomElementDefinition> custom_element_definition)
{
    ...
    auto attempt_to_construct_custom_element = [&]() -> JS::ThrowCompletionOr<void> {
        ...
        auto& constructor_realm = constructor.callback->shape().realm();
        VERIFY(constructor_realm.host_defined());
        auto element_wrapper = GC::make_root(Bindings::wrap(Bindings::host_defined_wrapper_world(constructor_realm), constructor_realm, GC::Ref { element }));
...
JS::ThrowCompletionOr<GC::Ref<HTML::HTMLElement>> construct_autonomous_custom_element(DOM::Document& document, Utf16FlyString const& local_name, Optional<Utf16FlyString> const& prefix, GC::Ptr<HTML::CustomElementRegistry> registry, GC::Ref<HTML::CustomElementDefinition> custom_element_definition)
{
