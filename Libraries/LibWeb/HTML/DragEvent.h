...
public:
    [[nodiscard]] static GC::Ref<DragEvent> create(JS::Realm&, FlyString const& event_name, Bindings::DragEventInit const& event_init = {}, double page_x = 0, double page_y = 0, double offset_x = 0, double offset_y = 0);
    static WebIDL::ExceptionOr<GC::Ref<DragEvent>> construct_impl(JS::Realm&, FlyString const& event_name, Bindings::DragEventInit const& event_init);
