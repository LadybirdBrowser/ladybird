...
class Memory : public Bindings::GCAllocatedWrappable {
    WEB_WRAPPABLE(Memory, Bindings::GCAllocatedWrappable);
...
public:
    ...
    static WebIDL::ExceptionOr<GC::Ref<Memory>> create_for_constructor(JS::Object&, MemoryDescriptor const&);
