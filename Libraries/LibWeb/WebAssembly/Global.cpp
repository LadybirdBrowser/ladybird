...
WebIDL::ExceptionOr<GC::Ref<Global>> Global::create(NonnullRefPtr<Detail::WebAssemblyCache> cache, GlobalDescriptor const& descriptor, Wasm::Value value)
{
    ...
    if (value_type.kind() == Wasm::ValueType::V128)
        return WebIDL::SimpleException { WebIDL::SimpleExceptionType::TypeError, "V128 is not supported as a global value type"_utf16 };
    ...
    if (!address.has_value())
        return WebIDL::SimpleException { WebIDL::SimpleExceptionType::TypeError, "Wasm Global allocation failed"_utf16 };
...
WebIDL::ExceptionOr<Wasm::GlobalType> Global::type() const
{
    ...
    if (!global_instance)
        return WebIDL::SimpleException { WebIDL::SimpleExceptionType::RangeError, "Could not find the global instance"_utf16 };
...
WebIDL::ExceptionOr<void> Global::set_value(Wasm::Value value)
{
    ...
    if (mut_value_type.type().kind() == Wasm::ValueType::V128)
        return WebIDL::SimpleException { WebIDL::SimpleExceptionType::TypeError, "Cannot set the value of a V128 global"_utf16 };

    if (!mut_value_type.is_mutable())
        return WebIDL::SimpleException { WebIDL::SimpleExceptionType::TypeError, "Cannot set the value of a const global"_utf16 };
