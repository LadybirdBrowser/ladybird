...
GC::Ref<WebIDL::Promise> Internals::flush_session_history_traversal_queue()
{
    ...
    traversable->request_history_operation(
        ...
        {
            .pre_steps = GC::create_function(heap(), [&realm, promise](u64, Optional<Web::ReconstructedChildNavigation>, GC::Ref<HTML::LocalTraversableNavigable::OnHistoryOperationReady> ready) {
                HTML::TemporaryExecutionContext execution_context { realm };
                WebIDL::resolve_promise(promise);
