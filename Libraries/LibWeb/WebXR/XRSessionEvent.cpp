...
GC::Ref<XRSessionEvent> XRSessionEvent::create(Utf16FlyString const& type, XRSessionEventInit const& event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
{
    return GC::Heap::the().allocate<XRSessionEvent>(type, event_init, time_stamp);
}

XRSessionEvent::XRSessionEvent(Utf16FlyString const& type, XRSessionEventInit const& event_init, HighResolutionTime::DOMHighResTimeStamp time_stamp)
