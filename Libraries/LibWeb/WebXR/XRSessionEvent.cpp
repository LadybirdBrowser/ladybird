...
GC::Ref<XRSessionEvent> XRSessionEvent::create(JS::Realm& realm, Utf16FlyString const& type, Bindings::XRSessionEventInit const& event_init)
{
...
GC::Ref<XRSessionEvent> XRSessionEvent::construct_impl(JS::Realm& realm, Utf16FlyString const& type, Bindings::XRSessionEventInit const& event_init)
{
    return create(realm, type, event_init);
}

XRSessionEvent::XRSessionEvent(JS::Realm& realm, Utf16FlyString const& type, Bindings::XRSessionEventInit const& event_init)
