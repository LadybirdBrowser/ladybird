...
GC::Ref<XRSession> XRSession::create(JS::Realm& realm, XRSystem& xr_system)
{
...
void XRSession::shut_down()
{
    ...
    m_xr_system->list_of_inline_sessions().remove_first_matching([&](auto& entry) { return entry == this; });
