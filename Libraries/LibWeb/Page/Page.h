...
public:
    ...
    virtual void page_did_start_loading(Optional<Utf16String> const&, URL::URL const&, Optional<HTML::PendingSessionHistoryEntryDescriptor> const& pending_history_entry, bool is_redirect, Bindings::NavigationHistoryBehavior history_handling = Bindings::NavigationHistoryBehavior::Auto)
    {
        (void)pending_history_entry;
        (void)is_redirect;
    ...
    virtual void page_did_finalize_cross_document_navigation([[maybe_unused]] u64 operation_id, [[maybe_unused]] HTML::CrossProcessId navigable_id, [[maybe_unused]] HTML::SessionHistoryEntryDescriptor const& history_entry, [[maybe_unused]] Optional<Utf16String> const& entry_to_replace_navigation_api_key) { }
