...
#define WEB_PLATFORM_OBJECT(class_, base_class)                                  \
    ...
    virtual bool implements_interface(FlyString const& interface) const override \
    {                                                                            \
        if (interface == #class_##sv)                                            \
            return true;                                                         \
...
public:
    ...
    [[nodiscard]] virtual bool implements_interface(FlyString const&) const { return false; }
