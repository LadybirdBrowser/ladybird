...
static GC::Ref<JS::Object> create_supported_entry_types_array(JS::Object& relevant_global_object)
{
...
GC::Ref<PerformanceObserver> PerformanceObserver::create_for_constructor(JS::Object& relevant_global_object, GC::Ptr<WebIDL::CallbackType> callback)
{
    auto& relevant_global = HTML::relevant_window_or_worker_global_scope(relevant_global_object);
...
JS::Value PerformanceObserver::supported_entry_types(JS::VM& vm)
{
    ...
    auto supported_entry_types_array = create_supported_entry_types_array(realm.global_object());
