...
public:
    ...
    bool respects_set_cookie() const { return m_respects_set_cookie; }
    void set_respects_set_cookie(bool respects_set_cookie) { m_respects_set_cookie = respects_set_cookie; }
...
private:
    ...
    bool m_respects_set_cookie { true };
};
