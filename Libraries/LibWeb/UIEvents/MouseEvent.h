...
WEB_API MouseEventOptions mouse_event_options_from_bindings(Bindings::MouseEventInit const&);
...
public:
    [[nodiscard]] static GC::Ref<MouseEvent> create(
        FlyString const& event_name, MouseEventOptions const&,
        double page_x, double page_y, double offset_x, double offset_y,
        HighResolutionTime::DOMHighResTimeStamp);
    [[nodiscard]] static GC::Ref<MouseEvent> create(
        Utf16FlyString const& event_name, MouseEventOptions const&,
        double page_x, double page_y, double offset_x, double offset_y,
        HighResolutionTime::DOMHighResTimeStamp);
    [[nodiscard]] static WebIDL::ExceptionOr<GC::Ref<MouseEvent>> create_for_constructor(FlyString const&, Bindings::MouseEventInit const&, HighResolutionTime::DOMHighResTimeStamp);
    [[nodiscard]] static WebIDL::ExceptionOr<GC::Ref<MouseEvent>> create_for_constructor(Utf16String const&, Bindings::MouseEventInit const&, HighResolutionTime::DOMHighResTimeStamp);
    ...
    static WebIDL::ExceptionOr<GC::Ref<MouseEvent>> create_from_platform_event(JS::Object const& relevant_global_object, GC::Ptr<HTML::WindowProxy>, Utf16FlyString const& event_name, CSSPixelPoint screen, CSSPixelPoint page, CSSPixelPoint client, CSSPixelPoint offset, Optional<CSSPixelPoint> movement, unsigned button, unsigned buttons, unsigned modifiers, int detail = 0);
...
protected:
    MouseEvent(FlyString const& event_name, MouseEventOptions const&, double page_x, double page_y, double offset_x, double offset_y, HighResolutionTime::DOMHighResTimeStamp);
    MouseEvent(Utf16FlyString const& event_name, MouseEventOptions const&, double page_x, double page_y, double offset_x, double offset_y, HighResolutionTime::DOMHighResTimeStamp);
