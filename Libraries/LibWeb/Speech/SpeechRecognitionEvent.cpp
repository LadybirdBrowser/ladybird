...
GC::Ref<SpeechRecognitionEvent> SpeechRecognitionEvent::create(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::SpeechRecognitionEventInit const& event_init)
{
    return realm.create<SpeechRecognitionEvent>(realm, event_name, move(event_init));
}

WebIDL::ExceptionOr<GC::Ref<SpeechRecognitionEvent>> SpeechRecognitionEvent::construct_impl(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::SpeechRecognitionEventInit const& event_init)
{
    return create(realm, event_name, move(event_init));
}

SpeechRecognitionEvent::SpeechRecognitionEvent(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::SpeechRecognitionEventInit const& event_init)
