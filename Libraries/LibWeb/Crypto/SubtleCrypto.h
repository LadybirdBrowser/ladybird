...
class SubtleCrypto final : public Bindings::GCAllocatedWrappable {
    WEB_WRAPPABLE(SubtleCrypto, Bindings::GCAllocatedWrappable);
...
WEB_API JS::ThrowCompletionOr<GC::Ref<JS::Object>> create_algorithm_dictionary(JS::Realm&, Utf16String const& name);
