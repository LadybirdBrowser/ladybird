...
JS::ThrowCompletionOr<GC::Ref<GPU>> GPU::create(JS::Realm& realm)
{
    ...
    wgpu::InstanceCapabilities instance_capabilities {};
    instance_capabilities.timedWaitAnyEnable = true;
...
GC::Ref<WebIDL::Promise> GPU::request_adapter(GPURequestAdapterOptions const& options)
{
    ...
    wgpu::RequestAdapterOptions request_adapter_options = options.to_wgpu();
