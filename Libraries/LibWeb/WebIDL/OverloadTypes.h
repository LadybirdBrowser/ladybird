...
public:
    ...
    bool is_enumeration() const { return m_kind == Kind::Enumeration; }
    ...
    bool is_string() const { return is_enumeration() || (is_plain() && m_name.is_one_of("ByteString", "DOMString", "USVString")); }
