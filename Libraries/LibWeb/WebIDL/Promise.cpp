...
GC::Ref<Promise> create_promise_for(HTML::EnvironmentSettingsObject& settings_object)
{
    return create_promise(settings_object.realm());
}

GC::Ref<Promise> create_promise_for(JS::Object const& object)
{
    return create_promise(HTML::relevant_realm(object));
}

GC::Ref<Promise> create_promise_for(DOM::Node const& node)
{
    return create_promise(HTML::relevant_realm(node));
}

GC::Ref<Promise> create_promise_for(HTML::Window const& window)
{
    return create_promise(HTML::relevant_realm(window));
}
...
GC::Ref<Promise> create_resolved_promise_for(JS::Object const& object, JS::Value value)
{
    return create_resolved_promise(HTML::relevant_realm(object), value);
}

GC::Ref<Promise> create_resolved_promise_for(DOM::Node const& node, JS::Value value)
{
    return create_resolved_promise(HTML::relevant_realm(node), value);
}

GC::Ref<Promise> create_resolved_promise_for(HTML::Window const& window, JS::Value value)
{
    return create_resolved_promise(HTML::relevant_realm(window), value);
}
...
GC::Ref<Promise> create_rejected_promise_for(HTML::EnvironmentSettingsObject& settings_object, JS::Value reason)
{
    return create_rejected_promise(settings_object.realm(), reason);
}

GC::Ref<Promise> create_rejected_promise_for(HTML::EnvironmentSettingsObject& settings_object, GC::Ref<DOMException> exception)
{
    return create_rejected_promise(settings_object.realm(), exception);
}

GC::Ref<Promise> create_rejected_promise_for(JS::Object const& object, JS::Value reason)
{
    return create_rejected_promise(HTML::relevant_realm(object), reason);
}

GC::Ref<Promise> create_rejected_promise_for(JS::Object const& object, GC::Ref<DOMException> exception)
{
    return create_rejected_promise(HTML::relevant_realm(object), exception);
}
...
void resolve_promise(Promise const& promise, JS::Value value)
{
    resolve_promise(promise_realm(promise), promise, value);
}
...
void reject_promise(Promise const& promise, JS::Value reason)
{
    reject_promise(promise_realm(promise), promise, reason);
}

void reject_promise(Promise const& promise, GC::Ref<DOMException> exception)
{
...
{
    // Simple Web IDL exceptions are materialized through VM::throw_completion(),
    // which uses the VM's current realm. Ensure cross-realm callers still get
    // the exception object in the realm that owns the promise.
...
GC::Ref<Promise> create_rejected_promise_from_exception_for(HTML::EnvironmentSettingsObject& settings_object, Exception exception)
{
    return create_rejected_promise_from_exception(settings_object.realm(), move(exception));
}
...
void reject_promise_with_exception(Promise const& promise, Exception exception)
{
    auto& realm = promise_realm(promise);
    reject_promise_with_exception(realm, promise, move(exception));
}
