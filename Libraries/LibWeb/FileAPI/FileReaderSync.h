...
public:
    ...
    Coroutine<WebIDL::ExceptionOr<GC::Root<JS::ArrayBuffer>>> read_as_array_buffer(Blob&);
    Coroutine<WebIDL::ExceptionOr<String>> read_as_binary_string(Blob&);
    Coroutine<WebIDL::ExceptionOr<String>> read_as_text(Blob&, Optional<String> const& encoding = {});
    Coroutine<WebIDL::ExceptionOr<String>> read_as_data_url(Blob&);

private:
    explicit FileReaderSync(JS::Realm&);

    template<typename Result>
    Coroutine<WebIDL::ExceptionOr<Result>> read_as(Blob&, FileReader::Type, Optional<String> const& encoding = {});
