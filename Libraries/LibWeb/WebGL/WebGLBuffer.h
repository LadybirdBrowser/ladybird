...
public:
    static GC::Ref<WebGLBuffer> create(GC::Ref<WebGLRenderingContextBase> context, GLuint handle);
...
protected:
    explicit WebGLBuffer(GC::Ref<WebGLRenderingContextBase>, GLuint handle);
