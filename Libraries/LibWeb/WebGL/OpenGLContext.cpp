...
void OpenGLContext::allocate_iosurface_painting_surface()
{
    ...
    m_impl->surface = eglCreatePbufferFromClientBuffer(m_impl->display, EGL_IOSURFACE_ANGLE, m_image_instance->iosurface_handle().core_foundation_pointer(), m_impl->config, surface_attributes);
