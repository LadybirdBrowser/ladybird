...
Vector<Extension> s_available_webgl_extensions {
    ...
    { "ANGLE_instanced_arrays"_string, { "GL_ANGLE_instanced_arrays"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "EXT_blend_minmax"_string, { "GL_EXT_blend_minmax"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "EXT_frag_depth"_string, { "GL_EXT_frag_depth"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "EXT_shader_texture_lod"_string, { "GL_EXT_shader_texture_lod"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "EXT_texture_filter_anisotropic"_string, { "GL_EXT_texture_filter_anisotropic"_sv } },
    { "OES_element_index_uint"_string, { "GL_OES_element_index_uint"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "OES_standard_derivatives"_string, { "GL_OES_standard_derivatives"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "OES_texture_float"_string, { "GL_OES_texture_float"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "OES_texture_float_linear"_string, { "GL_OES_texture_float_linear"_sv } },
    { "OES_texture_half_float"_string, { "GL_OES_texture_half_float"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "OES_texture_half_float_linear"_string, { "GL_OES_texture_half_float_linear"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "OES_vertex_array_object"_string, { "GL_OES_vertex_array_object"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "WEBGL_compressed_texture_s3tc"_string, { "GL_EXT_texture_compression_dxt1"_sv, "GL_ANGLE_texture_compression_dxt3"_sv, "GL_ANGLE_texture_compression_dxt5"_sv } },
    { "WEBGL_debug_renderer_info"_string, {} },
    { "WEBGL_debug_shaders"_string, {} },
    { "WEBGL_depth_texture"_string, { "GL_ANGLE_depth_texture"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "WEBGL_draw_buffers"_string, { "GL_EXT_draw_buffers"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "WEBGL_lose_context"_string, {} },

    // Community approved WebGL Extensions
    { "EXT_clip_control"_string, { "GL_EXT_clip_control"_sv } },
    { "EXT_color_buffer_float"_string, { "GL_EXT_color_buffer_float"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "EXT_color_buffer_half_float"_string, { "GL_EXT_color_buffer_half_float"_sv } },
    { "EXT_conservative_depth"_string, { "GL_EXT_conservative_depth"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "EXT_depth_clamp"_string, { "GL_EXT_depth_clamp"_sv } },
    { "EXT_disjoint_timer_query"_string, { "GL_EXT_disjoint_timer_query"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "EXT_disjoint_timer_query_webgl2"_string, { "GL_EXT_disjoint_timer_query"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "EXT_float_blend"_string, { "GL_EXT_float_blend"_sv } },
    { "EXT_polygon_offset_clamp"_string, { "GL_EXT_polygon_offset_clamp"_sv } },
    { "EXT_render_snorm"_string, { "GL_EXT_render_snorm"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "EXT_sRGB"_string, { "GL_EXT_sRGB"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "EXT_texture_compression_bptc"_string, { "GL_EXT_texture_compression_bptc"_sv } },
    { "EXT_texture_compression_rgtc"_string, { "GL_EXT_texture_compression_rgtc"_sv } },
    { "EXT_texture_mirror_clamp_to_edge"_string, { "GL_EXT_texture_mirror_clamp_to_edge"_sv } },
    { "EXT_texture_norm16"_string, { "GL_EXT_texture_norm16"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "KHR_parallel_shader_compile"_string, { "GL_KHR_parallel_shader_compile"_sv } },
    { "NV_shader_noperspective_interpolation"_string, { "GL_NV_shader_noperspective_interpolation"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "OES_draw_buffers_indexed"_string, { "GL_OES_draw_buffers_indexed"_sv } },
    { "OES_fbo_render_mipmap"_string, { "GL_OES_fbo_render_mipmap"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "OES_sample_variables"_string, { "GL_OES_sample_variables"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "OES_shader_multisample_interpolation"_string, { "GL_OES_shader_multisample_interpolation"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "OVR_multiview2"_string, { "GL_OVR_multiview2"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "WEBGL_blend_func_extended"_string, { "GL_EXT_blend_func_extended"_sv } },
    { "WEBGL_clip_cull_distance"_string, { "GL_EXT_clip_cull_distance"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "WEBGL_color_buffer_float"_string, { "EXT_color_buffer_half_float"_sv, "OES_texture_float"_sv }, OpenGLContext::WebGLVersion::WebGL1 },
    { "WEBGL_compressed_texture_astc"_string, { "KHR_texture_compression_astc_hdr"_sv, "KHR_texture_compression_astc_ldr"_sv } },
    { "WEBGL_compressed_texture_etc"_string, { "GL_ANGLE_compressed_texture_etc"_sv } },
    { "WEBGL_compressed_texture_etc1"_string, { "GL_OES_compressed_ETC1_RGB8_texture"_sv } },
    { "WEBGL_compressed_texture_pvrtc"_string, { "GL_IMG_texture_compression_pvrtc"_sv } },
    { "WEBGL_compressed_texture_s3tc_srgb"_string, { "GL_EXT_texture_compression_s3tc_srgb"_sv } },
    { "WEBGL_multi_draw"_string, { "GL_ANGLE_multi_draw"_sv } },
    { "WEBGL_polygon_mode"_string, { "GL_ANGLE_polygon_mode"_sv } },
    { "WEBGL_provoking_vertex"_string, { "GL_ANGLE_provoking_vertex"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "WEBGL_render_shared_exponent"_string, { "GL_QCOM_render_shared_exponent"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
    { "WEBGL_stencil_texturing"_string, { "GL_ANGLE_stencil_texturing"_sv }, OpenGLContext::WebGLVersion::WebGL2 },
};
