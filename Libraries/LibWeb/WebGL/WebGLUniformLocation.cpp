...
GC::Ref<WebGLUniformLocation> WebGLUniformLocation::create(JS::Realm& realm, GLuint handle, GC::Root<WebGLProgram> parent_shader)
{
    return realm.create<WebGLUniformLocation>(realm, handle, parent_shader);
}

WebGLUniformLocation::WebGLUniformLocation(JS::Realm& realm, GLuint handle, GC::Root<WebGLProgram> parent_shader)
...
ErrorOr<GLuint> WebGLUniformLocation::handle(GC::Root<WebGLProgram> current_shader) const
{
