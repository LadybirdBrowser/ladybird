...
public:
    ...
    void framebuffer_texture_layer(WebIDL::UnsignedLong target, WebIDL::UnsignedLong attachment, GC::Root<WebGLTexture> const& texture, WebIDL::Long level, WebIDL::Long layer);
    ...
    void uniform1uiv(GC::Root<WebGLUniformLocation> const& location, Uint32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform2uiv(GC::Root<WebGLUniformLocation> const& location, Uint32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform3uiv(GC::Root<WebGLUniformLocation> const& location, Uint32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform4uiv(GC::Root<WebGLUniformLocation> const& location, Uint32List v, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform_matrix3x2fv(GC::Root<WebGLUniformLocation> const& location, bool transpose, Float32List data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform_matrix4x2fv(GC::Root<WebGLUniformLocation> const& location, bool transpose, Float32List data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform_matrix2x3fv(GC::Root<WebGLUniformLocation> const& location, bool transpose, Float32List data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform_matrix4x3fv(GC::Root<WebGLUniformLocation> const& location, bool transpose, Float32List data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform_matrix2x4fv(GC::Root<WebGLUniformLocation> const& location, bool transpose, Float32List data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    void uniform_matrix3x4fv(GC::Root<WebGLUniformLocation> const& location, bool transpose, Float32List data, WebIDL::UnsignedLongLong src_offset, WebIDL::UnsignedLong src_length);
    ...
    void delete_query(GC::Root<WebGLQuery> const& query);
    void begin_query(WebIDL::UnsignedLong target, GC::Root<WebGLQuery> const& query);
    void end_query(WebIDL::UnsignedLong target);
    JS::Value get_query_parameter(GC::Root<WebGLQuery> const& query, WebIDL::UnsignedLong pname);
    ...
    void wait_sync(GC::Root<WebGLSync> const& sync, WebIDL::UnsignedLong flags, WebIDL::UnsignedLongLong timeout);
    ...
    void delete_transform_feedback(GC::Root<WebGLTransformFeedback> const& transform_feedback);
    void bind_transform_feedback(WebIDL::UnsignedLong target, GC::Root<WebGLTransformFeedback> const& transform_feedback);
    void begin_transform_feedback(WebIDL::UnsignedLong primitive_mode);
    void end_transform_feedback();
    void transform_feedback_varyings(GC::Root<WebGLProgram> const& program, Vector<String> const& varyings, WebIDL::UnsignedLong buffer_mode);
