...
public:
    ...
    void array_buffer(GC::Ref<WebIDL::Promise>) const;
    void blob(GC::Ref<WebIDL::Promise>) const;
    void bytes(GC::Ref<WebIDL::Promise>) const;
    void form_data(GC::Ref<WebIDL::Promise>) const;
    void json(GC::Ref<WebIDL::Promise>) const;
    void text(GC::Ref<WebIDL::Promise>) const;
};
