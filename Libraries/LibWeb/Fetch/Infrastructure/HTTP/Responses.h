...
public:
    ...
    [[nodiscard]] virtual ReadonlyBytes status_message() const [[clang::lifetimebound]] { return m_status_message; }
...
public:
    ...
    [[nodiscard]] virtual ReadonlyBytes status_message() const [[clang::lifetimebound]] override { return m_internal_response->status_message(); }
...
public:
    ...
    [[nodiscard]] virtual ReadonlyBytes status_message() const [[clang::lifetimebound]] override { return {}; }
    [[nodiscard]] virtual GC::Ref<HeaderList> header_list() const override { return m_header_list; }
