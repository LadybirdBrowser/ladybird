...
GC::Ref<CookieChangeEvent> CookieChangeEvent::create(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::CookieChangeEventInit const& event_init)
{
    return realm.create<CookieChangeEvent>(realm, event_name, event_init);
}

GC::Ref<CookieChangeEvent> CookieChangeEvent::construct_impl(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::CookieChangeEventInit const& event_init)
{
    return create(realm, event_name, event_init);
}

CookieChangeEvent::CookieChangeEvent(JS::Realm& realm, Utf16FlyString const& event_name, Bindings::CookieChangeEventInit const& event_init)
