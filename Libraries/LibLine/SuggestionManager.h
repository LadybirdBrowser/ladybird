...
public:
    ...
    Utf8View text_view() const [[clang::lifetimebound]] { return text.code_points(); }
    Utf8View trivia_view() const [[clang::lifetimebound]] { return trailing_trivia.code_points(); }
    Utf8View display_trivia_view() const [[clang::lifetimebound]] { return display_trivia.code_points(); }
    StringView text_string() const [[clang::lifetimebound]] { return text.bytes_as_string_view(); }
    StringView display_trivia_string() const [[clang::lifetimebound]] { return display_trivia.bytes_as_string_view(); }
    bool is_valid { false };
};
