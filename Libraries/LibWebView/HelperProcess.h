...
WEBVIEW_API ErrorOr<NonnullRefPtr<AudioServerClient::Client>> launch_audio_server_process();
WEBVIEW_API ErrorOr<NonnullRefPtr<WebAudioWorkerClient::Client>> launch_webaudio_renderer_process();
...
WEBVIEW_API ErrorOr<IPC::File> connect_new_audio_server_client();
