...
void ViewImplementation::handle_web_content_process_crash(LoadErrorPage load_error_page)
{
    ...
    if (load_error_page == LoadErrorPage::Yes) {
        ...
        builder.append("<html lang=\"en\"><head><meta charset=\"UTF-8\"><title>Error!</title><style>"
                       ...
                       "svg { height: 64px; width: auto; stroke: currentColor; fill: none; stroke-width: 2; "
        ...
        builder.append("<defs><style>.b{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}</style></defs>"sv);
        builder.append("<path class=\"b\" d=\"M11.75.75h-9c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2v-13l-5-5z\"/>"sv);
        builder.append("<path class=\"b\" d=\"M10.75.75v4c0 1.1.9 2 2 2h4M4.75 9.75l2 2M10.75 9.75l2 2M12.75 9.75l-2 2M6.75 9.75l-2 2M5.75 16.75c1-2.67 5-2.67 6 0\"/>"sv);
        builder.append("</svg>"sv);
        auto escaped_url = escape_html_entities(m_url.to_byte_string());
        builder.appendff("<h1>Ladybird flew off-course!</h1>");
        builder.append("</header>"sv);
        builder.appendff("<p>The web page <a href=\"{0}\">{0}</a> has crashed.<br><br>You can reload the page to try again.</p>", escaped_url);
