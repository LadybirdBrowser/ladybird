...
private:
    ...
    virtual void did_request_geolocation_watch(u64 page_id, u64 request_id, bool enable_high_accuracy) override;
    virtual void did_stop_geolocation_watch(u64 page_id, u64 request_id) override;
