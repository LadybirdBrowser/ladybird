...
private:
    ...
    virtual void did_update_current_session_history_entry(u64 page_id, Web::HTML::SessionHistoryEntryUpdateKind, Web::HTML::SessionHistoryEntryDescriptor) override;
