...
private:
    ...
    virtual void did_finish_loading(u64 page_id, Optional<u64>, Optional<Utf16String>, URL::URL) override;
    ...
    virtual void did_start_loading(u64 page_id, Optional<u64>, Optional<Utf16String>, URL::URL, Optional<Web::HTML::PendingSessionHistoryEntryDescriptor>, bool, Web::Bindings::NavigationHistoryBehavior) override;
    virtual void did_cancel_loading(u64 page_id, Optional<u64>, Optional<Utf16String>, URL::URL) override;
    ...
    virtual void history_operation_ready(u64 page_id, u64 operation_id, bool proceed, Optional<i32> step_override, Optional<Web::HTML::CrossProcessId> creation_parent_document_state_id, Optional<Web::CrossDocumentNavigationFinalization>, Web::HTML::HistoryStepResult abandon_result) override;
