...
struct WEBVIEW_API AccessibilityNodeData {
    ...
    // starts. Populated from the text's rendered visual lines when it has any — which gives correct positions for
    // wrapping text; falls back to single-line font-metrics approximation otherwise.
