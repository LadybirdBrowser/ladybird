...
void WebContentTestClient::did_finish_test(Web::PageId page_id, String text)
{
    m_client.did_finish_test(page_id, move(text));
}

void WebContentTestClient::did_set_test_timeout(Web::PageId page_id, double milliseconds)
{
    m_client.did_set_test_timeout(page_id, milliseconds);
}

void WebContentTestClient::did_receive_reference_test_metadata(Web::PageId page_id, JsonValue metadata)
{
...
void WebContentTestClient::did_request_crash_of_remote_frame_processes_for_testing(Web::PageId page_id)
{
    m_client.did_request_crash_of_remote_frame_processes_for_testing(page_id);
}

void WebContentTestClient::did_reset_session_history_for_testing(Web::PageId page_id, Web::HTML::SessionHistoryEntryDescriptor active_entry)
{
