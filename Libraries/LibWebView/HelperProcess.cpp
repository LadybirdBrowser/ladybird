    ...
    ClientArguments&&... client_arguments)
{
    ...
    if (web_content_options.webserial_device_path.has_value()) {
        arguments.append("--webserial-device-path"sv);
        arguments.append(web_content_options.webserial_device_path.value());
    }
