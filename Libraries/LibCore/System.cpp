...
ErrorOr<int> accept4(int sockfd, sockaddr* address, socklen_t* address_length, int flags)
{
    ...
    if (fd < 0)
        return Error::from_syscall("accept4"_sv, errno);
    return fd;
}
#endif
...
ErrorOr<void> sigaction(int signal, struct sigaction const* action, struct sigaction* old_action)
{
    if (::sigaction(signal, action, old_action) < 0)
        return Error::from_syscall("sigaction"_sv, errno);
    return {};
}
...
#endif
{
    ...
    if (old_handler == SIG_ERR)
        return Error::from_syscall("signal"_sv, errno);
    return old_handler;
}
...
ErrorOr<struct stat> fstatat(int fd, StringView path, int flags)
{
    if (!path.characters_without_null_termination())
        return Error::from_syscall("fstatat"_sv, EFAULT);
...
ErrorOr<int> fcntl(int fd, int command, ...)
{
    ...
    va_end(ap);
    if (rc < 0)
        return Error::from_syscall("fcntl"_sv, errno);
    return rc;
}
...
{
    if (!path.characters_without_null_termination())
        return Error::from_syscall("open"_sv, EFAULT);
...
{
    if (::close(fd) < 0)
        return Error::from_syscall("close"_sv, errno);
    return {};
}
...
ErrorOr<void> ftruncate(int fd, off_t length)
{
    if (::ftruncate(fd, length) < 0)
        return Error::from_syscall("ftruncate"_sv, errno);
    return {};
}
...
{
    if (!path.characters_without_null_termination())
        return Error::from_syscall("lstat"_sv, EFAULT);

    struct stat st = {};

    ByteString path_string = path;
    if (::lstat(path_string.characters(), &st) < 0)
        return Error::from_syscall("lstat"_sv, errno);
    return st;
}
...
ErrorOr<ssize_t> read(int fd, Bytes buffer)
{
    ...
    if (rc < 0)
        return Error::from_syscall("read"_sv, errno);
    return rc;
}
...
ErrorOr<ssize_t> write(int fd, ReadonlyBytes buffer)
{
    ...
    if (rc < 0)
        return Error::from_syscall("write"_sv, errno);
    return rc;
}
...
ErrorOr<void> kill(pid_t pid, int signal)
{
    if (::kill(pid, signal) < 0)
        return Error::from_syscall("kill"_sv, errno);
    return {};
}
...
ErrorOr<int> dup(int source_fd)
{
    ...
    if (fd < 0)
        return Error::from_syscall("dup"_sv, errno);
    return fd;
}
...
ErrorOr<int> dup2(int source_fd, int destination_fd)
{
    ...
    if (fd < 0)
        return Error::from_syscall("dup2"_sv, errno);
    return fd;
}
...
ErrorOr<void> ioctl(int fd, unsigned request, ...)
{
    ...
    if (::ioctl(fd, request, arg) < 0)
        return Error::from_syscall("ioctl"_sv, errno);
    return {};
}
...
ErrorOr<struct termios> tcgetattr(int fd)
{
    ...
    if (::tcgetattr(fd, &ios) < 0)
        return Error::from_syscall("tcgetattr"_sv, errno);
    return ios;
}
...
ErrorOr<void> tcsetattr(int fd, int optional_actions, struct termios const& ios)
{
    if (::tcsetattr(fd, optional_actions, &ios) < 0)
        return Error::from_syscall("tcsetattr"_sv, errno);
    return {};
}
...
ErrorOr<void> chmod(StringView pathname, mode_t mode)
{
    if (!pathname.characters_without_null_termination())
        return Error::from_syscall("chmod"_sv, EFAULT);

    ByteString path = pathname;
    if (::chmod(path.characters(), mode) < 0)
        return Error::from_syscall("chmod"_sv, errno);
    return {};
}
...
{
    if (::fchmod(fd, mode) < 0)
        return Error::from_syscall("fchmod"_sv, errno);
    return {};
}
...
ErrorOr<void> fchown(int fd, uid_t uid, gid_t gid)
{
    if (::fchown(fd, uid, gid) < 0)
        return Error::from_syscall("fchown"_sv, errno);
    return {};
}
...
{
    if (!pathname.characters_without_null_termination())
        return Error::from_syscall("chown"_sv, EFAULT);

    ByteString path = pathname;
    if (::lchown(path.characters(), uid, gid) < 0)
        return Error::from_syscall("lchown"_sv, errno);
    return {};
}
...
{
    return posix_spawn_wrapper(path, file_actions, attr, arguments, envp, "posix_spawn"_sv, ::posix_spawn);
}
...
{
    return posix_spawn_wrapper(path, file_actions, attr, arguments, envp, "posix_spawnp"_sv, ::posix_spawnp);
}
...
ErrorOr<off_t> lseek(int fd, off_t offset, int whence)
{
    ...
    if (rc < 0)
        return Error::from_syscall("lseek"_sv, errno);
    return rc;
}
...
ErrorOr<bool> isatty(int fd)
{
    int rc = ::isatty(fd);
    if (rc < 0)
        return Error::from_syscall("isatty"_sv, errno);
    return rc == 1;
}
...
ErrorOr<void> link(StringView old_path, StringView new_path)
{
    ...
    if (::link(old_path_string.characters(), new_path_string.characters()) < 0)
        return Error::from_syscall("link"_sv, errno);
    return {};
}
...
ErrorOr<void> symlink(StringView target, StringView link_path)
{
    ...
    if (::symlink(target_string.characters(), link_path_string.characters()) < 0)
        return Error::from_syscall("symlink"_sv, errno);
    return {};
}
...
ErrorOr<int> mkstemp(Span<char> pattern)
{
    ...
    if (fd < 0)
        return Error::from_syscall("mkstemp"_sv, errno);
    return fd;
}
...
ErrorOr<void> rename(StringView old_path, StringView new_path)
{
    ...
    if (::rename(old_path_string.characters(), new_path_string.characters()) < 0)
        return Error::from_syscall("rename"_sv, errno);
    return {};
}
...
ErrorOr<void> utimensat(int fd, StringView path, struct timespec const times[2], int flag)
{
    ...
    if (::utimensat(fd, builder.string_view().characters_without_null_termination(), times, flag) < 0)
        return Error::from_syscall("utimensat"_sv, errno);
    return {};
}
...
ErrorOr<struct utsname> uname()
{
    struct utsname uts;
    if (::uname(&uts) < 0)
        return Error::from_syscall("uname"_sv, errno);
    return uts;
}
...
ErrorOr<int> socket(int domain, int type, int protocol)
{
    ...
    if (fd < 0)
        return Error::from_syscall("socket"_sv, errno);
    return fd;
}
...
ErrorOr<void> bind(int sockfd, struct sockaddr const* address, socklen_t address_length)
{
    if (::bind(sockfd, address, address_length) < 0)
        return Error::from_syscall("bind"_sv, errno);
    return {};
}
...
ErrorOr<void> listen(int sockfd, int backlog)
{
    if (::listen(sockfd, backlog) < 0)
        return Error::from_syscall("listen"_sv, errno);
    return {};
}
...
ErrorOr<void> connect(int sockfd, struct sockaddr const* address, socklen_t address_length)
{
    if (::connect(sockfd, address, address_length) < 0)
        return Error::from_syscall("connect"_sv, errno);
    return {};
}
...
ErrorOr<ssize_t> send(int sockfd, void const* buffer, size_t buffer_length, int flags)
{
    ...
    if (sent < 0)
        return Error::from_syscall("send"_sv, errno);
    return sent;
}
...
ErrorOr<ssize_t> sendmsg(int sockfd, const struct msghdr* message, int flags)
{
    ...
    if (sent < 0)
        return Error::from_syscall("sendmsg"_sv, errno);
    return sent;
}
...
ErrorOr<ssize_t> sendto(int sockfd, void const* source, size_t source_length, int flags, struct sockaddr const* destination, socklen_t destination_length)
{
    ...
    if (sent < 0)
        return Error::from_syscall("sendto"_sv, errno);
    return sent;
}
...
ErrorOr<ssize_t> recv(int sockfd, void* buffer, size_t length, int flags)
{
    ...
    if (received < 0)
        return Error::from_syscall("recv"_sv, errno);
    return received;
}
...
ErrorOr<ssize_t> recvmsg(int sockfd, struct msghdr* message, int flags)
{
    ...
    if (received < 0)
        return Error::from_syscall("recvmsg"_sv, errno);
    return received;
}
...
ErrorOr<ssize_t> recvfrom(int sockfd, void* buffer, size_t buffer_length, int flags, struct sockaddr* address, socklen_t* address_length)
{
    ...
    if (received < 0)
        return Error::from_syscall("recvfrom"_sv, errno);
    return received;
}
...
ErrorOr<AddressInfoVector> getaddrinfo(char const* nodename, char const* servname, struct addrinfo const& hints)
{
    ...
    if (rc != 0) {
        if (rc == EAI_SYSTEM) {
            return Error::from_syscall("getaddrinfo"_sv, errno);
        }
...
ErrorOr<void> getsockopt(int sockfd, int level, int option, void* value, socklen_t* value_size)
{
    if (::getsockopt(sockfd, level, option, value, value_size) < 0)
        return Error::from_syscall("getsockopt"_sv, errno);
    return {};
}
...
ErrorOr<void> setsockopt(int sockfd, int level, int option, void const* value, socklen_t value_size)
{
    if (::setsockopt(sockfd, level, option, value, value_size) < 0)
        return Error::from_syscall("setsockopt"_sv, errno);
    return {};
}
...
ErrorOr<void> getsockname(int sockfd, struct sockaddr* address, socklen_t* address_length)
{
    if (::getsockname(sockfd, address, address_length) < 0)
        return Error::from_syscall("getsockname"_sv, errno);
    return {};
}
...
ErrorOr<void> getpeername(int sockfd, struct sockaddr* address, socklen_t* address_length)
{
    if (::getpeername(sockfd, address, address_length) < 0)
        return Error::from_syscall("getpeername"_sv, errno);
    return {};
}
...
ErrorOr<void> socketpair(int domain, int type, int protocol, int sv[2])
{
    if (::socketpair(domain, type, protocol, sv) < 0)
        return Error::from_syscall("socketpair"_sv, errno);
    return {};
}
...
ErrorOr<Array<int, 2>> pipe2(int flags)
{
    ...
    if (::pipe2(fds.data(), flags) < 0)
        return Error::from_syscall("pipe2"_sv, errno);
#else
    if (::pipe(fds.data()) < 0)
        return Error::from_syscall("pipe2"_sv, errno);
...
{
    if (pathname.is_null())
        return Error::from_syscall("access"_sv, EFAULT);

    ByteString path_string = pathname;
    (void)flags;

    if (::access(path_string.characters(), mode) < 0)
        return Error::from_syscall("access"_sv, errno);
    return {};
}
...
ErrorOr<ByteString> readlink(StringView pathname)
{
    ...
    if (rc == -1)
        return Error::from_syscall("readlink"_sv, errno);
...
ErrorOr<int> poll(Span<struct pollfd> poll_fds, int timeout)
{
    ...
    if (rc < 0)
        return Error::from_syscall("poll"_sv, errno);
    return { rc };
}
...
ErrorOr<ByteString> current_executable_path()
{
    ...
    if (err) {
        ...
        return Error::from_syscall("proc_get_exe"_sv, errno);
    }
#elif defined(AK_OS_DRAGONFLY)
    return TRY(readlink("/proc/curproc/file"_sv));
#elif defined(AK_OS_SOLARIS)
    return TRY(readlink("/proc/self/path/a.out"_sv));
...
ErrorOr<rlimit> get_resource_limits(int resource)
{
    ...
    if (::getrlimit(resource, &limits) != 0)
        return Error::from_syscall("getrlimit"_sv, errno);
...
ErrorOr<void> set_resource_limits(int resource, rlim_t limit)
{
    ...
    if (::setrlimit(resource, &limits) != 0)
        return Error::from_syscall("setrlimit"_sv, errno);
...
ErrorOr<void> sleep_ms(u32 milliseconds)
{
    if (usleep(1000 * milliseconds) != 0)
        return Error::from_syscall("usleep"_sv, errno);
    return {};
}
