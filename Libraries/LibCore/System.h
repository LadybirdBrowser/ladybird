...
CORE_API ErrorOr<String> mkdtemp(Span<char> pattern);
...
CORE_API ErrorOr<size_t> transfer_file_through_pipe(int source_fd, int target_fd, size_t source_offset, size_t source_length);
