 ...
 */
 ...
 /**
  * A structure to hold user-provided CLI options.
  */
 struct Options {
     StringView in_path;
     StringView out_path;
  ...
  * Expects one positional argument for input file path and
  * uses optional flags for output path and write_full_frames.
  */
 ...
 /**
  * serenity_main is the entry point for this utility.
  * It sets up an animation writer, reads frames from the input,
  * and writes them (either in full or incremental form) to the output file.
  */
 ErrorOr<int> serenity_main(Main::Arguments arguments)
 {
     ...
     // Map the input file into memory for decoding.
     ...
     // Prepare the output file and buffer for the result.
     ...
     // Initialize the appropriate animation writer based on file extension.
