...
class Probe:
    ...
    def launch(self):
        argv = [str(self.binary), "--force-cpu-painting", FIXTURE.resolve().as_uri()]
        if self.preexisting:
            # A plain launch would hand its URL to the existing instance and exit; keep the probe self-contained.
            argv.insert(1, "--force-new-process")
