export function createAnalyserProcessor(log, ui) {
    ...
    /** @type {ReturnType<typeof createTimeDomainOscilloscope>} */
    let timeRenderer = null;
    /** @type {ReturnType<typeof createFrequencyDomainSpectrum>} */
    ...
    const timeCanvas = /** @type {HTMLCanvasElement} */ (document.createElement("canvas"));
    timeCanvas.width = 1000;
    timeCanvas.height = 280;

    const freqCanvas = /** @type {HTMLCanvasElement} */ (document.createElement("canvas"));
