...
class OnFocusedChangedTests(LadybirdOrcaTestCase):
    ...
    def _dispatch_focus_event(self, source: Atspi.Accessible) -> None:
        ...
        try:
            ...
            # Other exceptions (TypeError from a partially-constructed event, errors deep in super's call chain against
            # the synthetic environment, etc.) aren't what this regression test is guarding against.
            pass
