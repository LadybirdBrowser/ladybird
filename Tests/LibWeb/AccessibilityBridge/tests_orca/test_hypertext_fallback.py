...
Our Orca script installs _install_hypertext_fallback_patch to close four gaps that Qt's bridge leaves in AtkHypertext/
AtkHyperlink. All four are hit by Say All and sentence-extension; misbehavior here shows up as Say All dropping link
text, skipping post-link prose, or jumping link-to-link.
