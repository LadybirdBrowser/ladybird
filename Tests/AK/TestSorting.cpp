...
TEST_CASE(quick_sort_sorts_without_copy)
{
    struct NoCopy {
...
TEST_CASE(quick_sort_maximum_stack_depth)
{
    int const size = 256;
...
TEST_CASE(insertion_sort_sorts_ascending)
{
    srand(seed);
...
TEST_CASE(insertion_sort_sorts_descending)
{
    srand(seed);
...
TEST_CASE(insertion_sort_sorts_subrange_without_affecting_outside_elements)
{
