...
{
    constexpr GenericLexer sut("abcdef"_sv);
    static_assert(!sut.is_eof());
}
...
TEST_CASE(should_constexpr_next_is)
{
    ...
    static_assert(sut.next_is("abc"_sv));
}

TEST_CASE(should_constexpr_retreat)
{
    constexpr auto sut = [] {
        GenericLexer sut("abcdef"_sv);
        sut.consume();
        sut.retreat();
        return sut;
    }();
...
TEST_CASE(consume_escaped_code_point)
{
    ...
    test("\\u"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
    test("\\u{"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
    test("\\u{1"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
    test("\\u{}"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
    test("\\u{x}"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);

    test("\\u{110000}"_sv, GenericLexer::UnicodeEscapeError::UnicodeEscapeOverflow);
    test("\\u{f00000000}"_sv, GenericLexer::UnicodeEscapeError::UnicodeEscapeOverflow);

    test("\\u{0}"_sv, 0);
    test("\\u{41}"_sv, 0x41);
    test("\\u{ffff}"_sv, 0xffff);
    test("\\u{10ffff}"_sv, 0x10ffff);

    test("\\u1"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
    test("\\u11"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
    test("\\u111"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
    test("\\u111x"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
    test("\\ud800\\u"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
    test("\\ud800\\u1"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
    test("\\ud800\\u11"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
    test("\\ud800\\u111"_sv, GenericLexer::UnicodeEscapeError::MalformedUnicodeEscape);
