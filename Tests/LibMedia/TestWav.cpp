...
TEST_CASE(mono_8khz)
{
    run_test("tone_8000_mono.wav"_sv, 40000, 1, 8000);
}

TEST_CASE(stereo_8khz)
{
    run_test("tone_8000_stereo.wav"_sv, 40000, 2, 8000);
}

TEST_CASE(mono_11khz)
{
    run_test("tone_11025_mono.wav"_sv, 55125, 1, 11025);
}

TEST_CASE(stereo_11khz)
{
    run_test("tone_11025_stereo.wav"_sv, 55125, 2, 11025);
}

TEST_CASE(mono_16khz)
{
    run_test("tone_16000_mono.wav"_sv, 80000, 1, 16000);
}

TEST_CASE(stereo_16khz)
{
    run_test("tone_16000_stereo.wav"_sv, 80000, 2, 16000);
}

TEST_CASE(mono_22khz)
{
    run_test("tone_22050_mono.wav"_sv, 110250, 1, 22050);
}

TEST_CASE(stereo_22khz)
{
    run_test("tone_22050_stereo.wav"_sv, 110250, 2, 22050);
}

TEST_CASE(mono_44khz)
{
    run_test("tone_44100_mono.wav"_sv, 220500, 1, 44100);
}

TEST_CASE(stereo_44khz)
{
    run_test("tone_44100_stereo.wav"_sv, 220500, 2, 44100);
}
