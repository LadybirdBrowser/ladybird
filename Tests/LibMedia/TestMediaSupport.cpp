...
TEST_CASE(file_media_support_with_codecs)
{
    ...
    EXPECT_EQ(file_media_support("video"sv, "mp4"sv, "avc1.640028, mp4a.40.2"sv).support, Media::MediaSupport::Probably);
    EXPECT_EQ(file_media_support("video"sv, "mp4"sv, "avc1, mp4a.40.2"sv).support, Media::MediaSupport::Maybe);
    EXPECT_EQ(file_media_support("audio"sv, "mp4"sv, "mp4a.40"sv).support, Media::MediaSupport::Maybe);
    EXPECT_EQ(file_media_support("audio"sv, "mp4"sv, "mp4a.67"sv).support, Media::MediaSupport::Probably);
