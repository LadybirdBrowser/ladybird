...
HandshakeResult run_handshake(bool non_http_whitespace)
{
    ...
    auto accept_header = ByteString::formatted("Sec-WebSocket-Accept: {}{}{}", non_http_whitespace ? "\v"sv : ""sv, implementation->expected_accept(), non_http_whitespace ? "\f"sv : ""sv);
...
TEST_CASE(accept_proof_uses_http_whitespace)
{
