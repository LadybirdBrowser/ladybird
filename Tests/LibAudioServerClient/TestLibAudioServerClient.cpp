...
TEST_CASE(audioserver_smoke_ipc_and_shared_ring_buffer)
{
...
#ifndef AK_OS_WINDOWS
TEST_CASE(audioserver_smoke_shared_ring_buffer_two_threads_ordered_u32)
{
    Core::EventLoop event_loop;
    ...
    auto consumer = MUST(Threading::Thread::try_create("Consumer"sv, [&]() -> intptr_t {
        u32 expected = 0;
    ...
    auto producer = MUST(Threading::Thread::try_create("Producer"sv, [&]() -> intptr_t {
