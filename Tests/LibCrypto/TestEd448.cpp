...
TEST_CASE(TEST_BLANK)
{
    ...
    ReadonlyBytes private_key { private_bytes, 57 };
    ReadonlyBytes public_key { public_bytes, 57 };
    ReadonlyBytes message { message_bytes, 0 };
    ReadonlyBytes expected_signature { signature_bytes, 114 };
...
// https://datatracker.ietf.org/doc/html/rfc8032#section-7.4
TEST_CASE(TEST_1_OCTET_WITH_CTX)
{
    ...
    u8 context_bytes[3] = { 0x66, 0x6f, 0x6f };
    ...
    ReadonlyBytes public_key { public_bytes, 57 };
    ReadonlyBytes message { message_bytes, 1 };
    ReadonlyBytes context { context_bytes, 3 };
    ReadonlyBytes expected_signature { signature_bytes, 114 };

    Crypto::Curves::Ed448 curve;

    auto generated_signature = TRY_OR_FAIL(curve.sign(private_key, message, context));
    EXPECT_EQ(generated_signature, expected_signature);
    EXPECT(TRY_OR_FAIL(curve.verify(public_key, expected_signature, message, context)));
}

// https://datatracker.ietf.org/doc/html/rfc8032#section-7.4
TEST_CASE(TEST_11_OCTET)
{
    u8 private_bytes[57] = {
    ...
    ReadonlyBytes private_key { private_bytes, 57 };
    ReadonlyBytes public_key { public_bytes, 57 };
    ReadonlyBytes message { message_bytes, 11 };
    ReadonlyBytes expected_signature { signature_bytes, 114 };
...
TEST_CASE(TEST_13_OCTET)
{
    ...
    ReadonlyBytes private_key { private_bytes, 57 };
    ReadonlyBytes public_key { public_bytes, 57 };
    ReadonlyBytes message { message_bytes, 13 };
    ReadonlyBytes expected_signature { signature_bytes, 114 };
...
TEST_CASE(TEST_256_OCTET)
{
    ...
    ReadonlyBytes private_key { private_bytes, 57 };
    ReadonlyBytes public_key { public_bytes, 57 };
    ReadonlyBytes message { message_bytes, 256 };
    ReadonlyBytes expected_signature { signature_bytes, 114 };
