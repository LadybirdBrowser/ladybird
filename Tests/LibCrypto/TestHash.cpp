...
TEST_CASE(test_BLAKE2b_name)
{
    ...
    EXPECT_EQ(blake2b->class_name(), "BLAKE2b"_sv);
}
...
TEST_CASE(test_BLAKE2b_hash_string)
{
    ...
    auto digest = Crypto::Hash::BLAKE2b::hash("Well hello friends"_sv);
...
TEST_CASE(test_BLAKE2b_hash_empty_string)
{
    ...
    auto digest = Crypto::Hash::BLAKE2b::hash(""_sv);
    EXPECT(memcmp(result, digest.data, Crypto::Hash::BLAKE2b::digest_size()) == 0);
}
...
TEST_CASE(test_BLAKE2b_consecutive_multiple_updates)
{
    ...
    blake2b->update("Well"_sv);
    blake2b->update(" hello "_sv);
    blake2b->update("friends"_sv);
...
TEST_CASE(test_MD5_hash_string)
{
    ...
    auto digest = Crypto::Hash::MD5::hash("Well hello friends"_sv);
...
TEST_CASE(test_MD5_hash_empty_string)
{
    ...
    auto digest = Crypto::Hash::MD5::hash(""_sv);
    EXPECT(memcmp(result, digest.data, Crypto::Hash::MD5::digest_size()) == 0);
}
...
TEST_CASE(test_MD5_hash_single_character)
{
    ...
    auto digest = Crypto::Hash::MD5::hash("a"_sv);
    EXPECT(memcmp(result, digest.data, Crypto::Hash::MD5::digest_size()) == 0);
}
...
TEST_CASE(test_MD5_hash_alphabet)
{
    ...
    auto digest = Crypto::Hash::MD5::hash("abcdefghijklmnopqrstuvwxyz"_sv);
    EXPECT(memcmp(result, digest.data, Crypto::Hash::MD5::digest_size()) == 0);
}
...
TEST_CASE(test_MD5_hash_long_sequence)
{
    ...
    auto digest = Crypto::Hash::MD5::hash("12345678901234567890123456789012345678901234567890123456789012345678901234567890"_sv);
    EXPECT(memcmp(result, digest.data, Crypto::Hash::MD5::digest_size()) == 0);
}
...
TEST_CASE(test_MD5_consecutive_multiple_updates)
{
    ...
    md5->update("Well"_sv);
    md5->update(" hello "_sv);
    md5->update("friends"_sv);
...
TEST_CASE(test_SHA1_name)
{
    ...
    EXPECT(sha->class_name() == "SHA1"_sv);
}
...
TEST_CASE(test_SHA1_hash_empty_string)
{
    ...
    auto digest = Crypto::Hash::SHA1::hash(""_sv);
...
TEST_CASE(test_SHA1_hash_long_string)
{
    ...
    auto digest = Crypto::Hash::SHA1::hash("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"_sv);
    EXPECT(memcmp(result, digest.data, Crypto::Hash::SHA1::digest_size()) == 0);
}
...
TEST_CASE(test_SHA1_hash_successive_updates)
{
    ...
    hasher->update("aaaaaaaaaaaaaaa"_sv);
    hasher->update("aaaaaaaaaaaaaaa"_sv);
    hasher->update("aaaaaaaaaaaaaaa"_sv);
    hasher->update("aaaaaaaaaaaaaaa"_sv);
    hasher->update("aaaaaaaaaaaaaaa"_sv);
...
TEST_CASE(test_SHA1_hash_split_into_blocks)
{
    ...
    auto digest = Crypto::Hash::SHA1::hash("0123456789012345678901234567890123456789012345678901234567890123abcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcd"_sv);
    EXPECT(memcmp(result, digest.data, Crypto::Hash::SHA1::digest_size()) == 0);
}
...
TEST_CASE(test_SHA256_name)
{
    ...
    EXPECT_EQ(sha->class_name(), "SHA256"_sv);
}
...
TEST_CASE(test_SHA256_hash_string)
{
    ...
    auto digest = Crypto::Hash::SHA256::hash("Well hello friends"_sv);
...
TEST_CASE(test_SHA256_hash_empty_string)
{
    ...
    auto digest = Crypto::Hash::SHA256::hash(""_sv);
    EXPECT(memcmp(result, digest.data, Crypto::Hash::SHA256::digest_size()) == 0);
}
...
TEST_CASE(test_SHA256_hash_split_into_blocks)
{
    ...
    auto digest = Crypto::Hash::SHA256::hash("0123456789012345678901234567890123456789012345678901234567890123abcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcd"_sv);
    EXPECT(memcmp(result, digest.data, Crypto::Hash::SHA256::digest_size()) == 0);
}
...
TEST_CASE(test_SHA384_name)
{
    ...
    EXPECT_EQ(sha->class_name(), "SHA384"_sv);
}
...
TEST_CASE(test_SHA384_hash_string)
{
    ...
    auto digest = Crypto::Hash::SHA384::hash("Well hello friends"_sv);
...
TEST_CASE(test_SHA384_hash_bug)
{
    ...
    auto digest = Crypto::Hash::SHA384::hash("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu"_sv);
...
TEST_CASE(test_SHA512_name)
{
    ...
    EXPECT_EQ(sha->class_name(), "SHA512"_sv);
}
...
TEST_CASE(test_SHA512_hash_string)
{
    ...
    auto digest = Crypto::Hash::SHA512::hash("Well hello friends"_sv);
...
TEST_CASE(test_SHA512_hash_bug)
{
    ...
    auto digest = Crypto::Hash::SHA512::hash("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu"_sv);
    EXPECT_EQ(result_bytes, digest.bytes());
}
...
TEST_CASE(test_SHA512_hash_empty_string)
{
    ...
    auto digest = Crypto::Hash::SHA512::hash(""_sv);
    EXPECT(memcmp(result, digest.data, Crypto::Hash::SHA512::digest_size()) == 0);
}
