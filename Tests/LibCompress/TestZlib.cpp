...
{
    Array<u8, 34> const compressed {
        0x78, 0x9C, 0x0B, 0xC9, 0xC8, 0x2C, 0x56, 0x00, 0xA2, 0x44, 0x85, 0xE2,
        0xCC, 0xDC, 0x82, 0x9C, 0x54, 0x85, 0x92, 0xD4, 0x8A, 0x12, 0x85, 0xB4,
        0x4C, 0x20, 0xCB, 0x4A, 0x13, 0x00, 0x99, 0x5E, 0x09, 0xE8
    };

    u8 const uncompressed[] = "This is a simple text file :)";

    auto const freshly_pressed = TRY_OR_FAIL(Compress::ZlibCompressor::compress_all({ uncompressed, sizeof(uncompressed) - 1 }));
    EXPECT(freshly_pressed.bytes() == compressed.span());
}
