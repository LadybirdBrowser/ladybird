...
public:
    ...
    void start_request(u64 request_id, URL::URL url)
    {
        ...
        auto message = make<Messages::RequestServer::StartRequest>(request_id, ByteString { "GET" }, move(url), move(request_headers), ByteBuffer {}, HTTP::CacheMode::Default, HTTP::Cookie::IncludeCredentials::No, false, Optional<u32> {}, false);
