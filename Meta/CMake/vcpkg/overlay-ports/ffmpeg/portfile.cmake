vcpkg_from_github(
    ...
    PATCHES
        ...
        0100-ladybird-symbol-version-nodes.patch
)
...
# Ladybird: suffix the libraries so a system FFmpeg can be loaded alongside them.
set(FFMPEG_LIBRARY_SUFFIX "-ladybird")
set(OPTIONS "${OPTIONS} --build-suffix=${FFMPEG_LIBRARY_SUFFIX}")
...
set(FFMPEG_PKGCONFIG_MODULES libavutil${FFMPEG_LIBRARY_SUFFIX})
...
if("avcodec" IN_LIST FEATURES)
    ...
    list(APPEND FFMPEG_PKGCONFIG_MODULES libavcodec${FFMPEG_LIBRARY_SUFFIX})
else()
...
if("avdevice" IN_LIST FEATURES)
    ...
    list(APPEND FFMPEG_PKGCONFIG_MODULES libavdevice${FFMPEG_LIBRARY_SUFFIX})
else()
...
if("avformat" IN_LIST FEATURES)
    ...
    list(APPEND FFMPEG_PKGCONFIG_MODULES libavformat${FFMPEG_LIBRARY_SUFFIX})
else()
...
if("avfilter" IN_LIST FEATURES)
    ...
    list(APPEND FFMPEG_PKGCONFIG_MODULES libavfilter${FFMPEG_LIBRARY_SUFFIX})
else()
...
if("postproc" IN_LIST FEATURES)
    ...
    list(APPEND FFMPEG_PKGCONFIG_MODULES libpostproc${FFMPEG_LIBRARY_SUFFIX})
else()
...
if("swresample" IN_LIST FEATURES)
    ...
    list(APPEND FFMPEG_PKGCONFIG_MODULES libswresample${FFMPEG_LIBRARY_SUFFIX})
else()
...
if("swscale" IN_LIST FEATURES)
    ...
    list(APPEND FFMPEG_PKGCONFIG_MODULES libswscale${FFMPEG_LIBRARY_SUFFIX})
else()
...
function(append_dependencies_from_libs out)
    ...
    list(FILTER contents EXCLUDE REGEX "^avutil${FFMPEG_LIBRARY_SUFFIX}$")
    list(FILTER contents EXCLUDE REGEX "^avcodec${FFMPEG_LIBRARY_SUFFIX}$")
    list(FILTER contents EXCLUDE REGEX "^avdevice${FFMPEG_LIBRARY_SUFFIX}$")
    list(FILTER contents EXCLUDE REGEX "^avfilter${FFMPEG_LIBRARY_SUFFIX}$")
    list(FILTER contents EXCLUDE REGEX "^avformat${FFMPEG_LIBRARY_SUFFIX}$")
    list(FILTER contents EXCLUDE REGEX "^postproc${FFMPEG_LIBRARY_SUFFIX}$")
    list(FILTER contents EXCLUDE REGEX "^swresample${FFMPEG_LIBRARY_SUFFIX}$")
    list(FILTER contents EXCLUDE REGEX "^swscale${FFMPEG_LIBRARY_SUFFIX}$")
    if(VCPKG_TARGET_IS_WINDOWS)
