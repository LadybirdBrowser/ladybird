...
dawn_fetch(
    ...
    SOURCE ${SOURCE_PATH}
    PATCHES "${CMAKE_CURRENT_LIST_DIR}/macos_build_find_sdk.patch" # See https://github.com/LadybirdBrowser/ladybird/pull/5783#discussion_r2264350521
)
...
vcpkg_gn_configure(
    ...
    OPTIONS "target_cpu=\"${VCPKG_TARGET_ARCHITECTURE}\" use_sysroot=false tint_build_hlsl_writer=false tint_has_fuzzers=false tint_build_unittests=false tint_build_benchmarks=false is_clang=true use_custom_libcxx=false dawn_standalone=true dawn_use_swiftshader=false dawn_tests_use_angle=false dawn_enable_d3d12=false"
