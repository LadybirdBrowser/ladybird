...
# Workaround for bad patchelf interaction with binutils 2.43.50 https://github.com/LadybirdBrowser/ladybird/issues/2149
# https://github.com/microsoft/vcpkg/issues/41576 https://github.com/NixOS/patchelf/issues/568
...
# Munge the VCPKG_TRIPLET to correspond to the right one for our presets Just make sure not to override if the developer
# is trying to cross-compile or the developer set it manually, or if this is not the first run of CMake
if (NOT DEFINED CACHE{VCPKG_TARGET_TRIPLET}
    AND NOT DEFINED CACHE{VCPKG_HOST_TRIPLET}
    ...
    elseif (os_platform MATCHES "^(aarch64|arm64|ARM64)$")
        ...
        message(
            FATAL_ERROR
                "Unable to automatically detect architecture for vcpkg, please set VCPKG_TARGET_TRIPLET manually"
        )
    endif ()
    ...
    elseif (os_name MATCHES "Windows")
        ...
        message(
            FATAL_ERROR "Unable to automatically detect os name for vcpkg, please set VCPKG_TARGET_TRIPLET manually"
        )
    endif ()
