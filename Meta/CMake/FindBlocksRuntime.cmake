...
find_library(BLOCKS_RUNTIME NAMES BlocksRuntime PATHS ${SWIFT_LIBRARY_SEARCH_PATHS})
if(BLOCKS_RUNTIME)
        ...
        set_target_properties(
            ...
            PROPERTIES
                ...
                INTERFACE_COMPILE_OPTIONS
                    "$<$<COMPILE_LANGUAGE:C,CXX>:-fblocks>;SHELL:$<$<COMPILE_LANGUAGE:Swift>:-Xcc -fblocks>"
        )
    endif()
