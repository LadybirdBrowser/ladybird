...
#
# target: the name of the target to generate headers for. This target must build swift source files. header: the name of
...
function (_swift_generate_cxx_header target header)
    ...
    add_custom_command(
        ...
        COMMAND
            ${CMAKE_Swift_COMPILER} -frontend -typecheck ${ARG_SEARCH_PATHS} ${_SwiftSources} ${SDK_FLAGS}
            ${CXX_STD_FLAGS} ${ARG_COMPILE_OPTIONS} -Xcc -Wno-unqualified-std-cast-call -Xcc -Wno-user-defined-literals
            -Xcc -Wno-unknown-warning-option -module-name "${ARG_MODULE_NAME}" -cxx-interoperability-mode=default
    ...
    # Added to the target to ensure target rebuilds if header changes and is used by sources in the target.
