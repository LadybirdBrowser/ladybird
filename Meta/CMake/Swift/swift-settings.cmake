...
set(VFS_OVERLAY_DIRECTORY
    "${CMAKE_BINARY_DIR}/vfs_overlays"
    CACHE PATH "Directory to put VFS overlays in"
)

# FIXME: https://gitlab.kitware.com/cmake/cmake/-/issues/26195 For now, we'll just manually massage the flags.
...
function (add_swift_target_properties target_name)
    ...
    target_compile_options(
        ${target_name} PUBLIC "SHELL:$<$<COMPILE_LANGUAGE:Swift>:-Xcc -std=c++23 -cxx-interoperability-mode=default>"
    )
    ...
    foreach (internal_library IN LISTS SWIFT_TARGET_LAGOM_LIBRARIES)
        list(APPEND VFS_OVERLAY_OPTIONS "-Xcc"
             "-ivfsoverlay${VFS_OVERLAY_DIRECTORY}/${internal_library}_vfs_overlay.yaml"
        )
    endforeach ()
    ...
    # Swift-testing in swift.org toolchains on macOS has its .swiftmodule in a testing/ subdirectory of the swift
    # compiler's built-in lib dirs.
