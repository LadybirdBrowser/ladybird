...
if (WIN32)
    ...
    add_compile_definitions(_CRT_SECURE_NO_WARNINGS) # _s replacements not desired (or implemented on any other platform
                                                     # other than VxWorks)
...
elseif (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    ...
    # FIXME: These warnings trigger on Function and ByteBuffer in GCC (only when LTO is disabled...) investigate this
    # and maybe reenable them if they're not false positives/invalid.
...
elseif (CMAKE_CXX_COMPILER_ID MATCHES "Clang$" AND CMAKE_CXX_SIMULATE_ID MATCHES "MSVC")
    ...
    # TODO: this seems wrong, but we use this kind of code too much add_cxx_compile_options(-Wno-unsafe-buffer-usage)
endif ()
