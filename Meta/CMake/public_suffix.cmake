...
if (ENABLE_PUBLIC_SUFFIX_DOWNLOAD)
    set(PUBLIC_SUFFIX_PATH
        "${SERENITY_CACHE_DIR}/PublicSuffix"
        CACHE PATH "Download location for PublicSuffix files"
    )
    ...
    if (ENABLE_NETWORK_DOWNLOADS)
        ...
        message(
            STATUS "Skipping download of ${PUBLIC_SUFFIX_DATA_URL}, expecting it to be in ${PUBLIC_SUFFIX_DATA_PATH}"
        )
    endif ()
    invoke_generator(
        "PublicSuffixData"
        ...
        arguments
        -p
        "${PUBLIC_SUFFIX_DATA_PATH}"
    )

    set(PUBLIC_SUFFIX_SOURCES ${PUBLIC_SUFFIX_DATA_HEADER} ${PUBLIC_SUFFIX_DATA_IMPLEMENTATION})
endif ()
