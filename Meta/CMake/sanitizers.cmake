function(windows_clang_resource_lib_dir result_dir)
    execute_process(
    ...
    set(${result_dir} "${CLANG_RESOURCE_DIR}/lib/windows" PARENT_SCOPE)
endfunction()
...
if (ENABLE_ADDRESS_SANITIZER)
    if (WIN32 AND CMAKE_CXX_COMPILER_ID MATCHES "Clang$")
        ...
        windows_clang_resource_lib_dir(CLANG_WINDOWS_LIB_RESOURCE_DIR)
        file(COPY "${CLANG_WINDOWS_LIB_RESOURCE_DIR}/clang_rt.asan_dynamic-x86_64.dll" DESTINATION "${CMAKE_BINARY_DIR}/bin")
    else()
