...
function(embed_as_string name source_file output source_variable_name)
    ...
    add_custom_command(
        OUTPUT "${output}"
        COMMAND
            "${Python3_EXECUTABLE}" "${SerenityOS_SOURCE_DIR}/Meta/embed_as_string.py" "${source_file}" -o
...
function(generate_clang_module_map target_name)
    ...
    target_compile_options(
        ${target_name}
        PUBLIC "SHELL:$<$<COMPILE_LANGUAGE:Swift>:-Xcc -ivfsoverlay${vfs_overlay_file}>"
    )
endfunction()
...
function(compile_ipc source output)
    ...
    cmake_path(
        ...
        BASE_DIRECTORY ${SerenityOS_SOURCE_DIR}
        OUTPUT_VARIABLE current_source_dir_relative
    )
