...
if(NOT TARGET SwiftTesting::SwiftTesting)
    ...
    find_library(SWIFT_TESTING NAMES Testing PATHS ${_SEARCH_PATHS})
    if(SWIFT_TESTING)
        ...
        find_library(SWIFT_TESTING_MACROS NAMES TestingMacros PATHS ${_PLUGIN_PATHS} NO_DEFAULT_PATH)
        ...
        set_target_properties(
            ...
            PROPERTIES
                ...
                INTERFACE_COMPILE_OPTIONS
                    "$<$<COMPILE_LANGUAGE:Swift>:SHELL:-load-plugin-library ${SWIFT_TESTING_MACROS}>"
