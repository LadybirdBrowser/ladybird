...
function(ladybird_lib name fs_name)
    cmake_parse_arguments(PARSE_ARGV 2 LADYBIRD_LIB "EXPLICIT_SYMBOL_EXPORT" "TYPE;PCH_HEADER" "")
    ...
    if (LADYBIRD_ENABLE_PCH)
        if (NOT LADYBIRD_LIB_PCH_HEADER)
            set(LADYBIRD_LIB_PCH_HEADER "${LADYBIRD_SOURCE_DIR}/AK/PCH.h")
        endif()
        target_precompile_headers(${name} PRIVATE ${LADYBIRD_LIB_PCH_HEADER})
    endif()
...
function(ladybird_test test_src sub_dir)
    cmake_parse_arguments(PARSE_ARGV 2 LADYBIRD_TEST "SKIP_PCH" "CUSTOM_MAIN;NAME" "LIBS")
    ...
    if (LADYBIRD_ENABLE_PCH AND NOT LADYBIRD_TEST_SKIP_PCH)
        target_precompile_headers(${LADYBIRD_TEST_NAME} REUSE_FROM LibTestPchTarget)
    endif()
