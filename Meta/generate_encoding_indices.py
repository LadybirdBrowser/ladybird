...
def main():
    parser = argparse.ArgumentParser(description="Generate text codec lookup tables")
    parser.add_argument(
        "--generated-header-path", required=True, help="Path to the lookup table header file to generate"
    )
    parser.add_argument(
    ...
    parser.add_argument("--json-path", required=True, help="Path to the JSON file to read from")
    ...
    print(f"Generated {args.generated_header_path}")
    print(f"Generated {args.generated_implementation_path}")
