...
namespace Web::CSS {
static HashMap<StringView, MathFunction, AK::CaseInsensitiveASCIIStringViewTraits> math_function_table = {
    { "calc"sv, MathFunction::Calc },
)~~~");
    ...
    { "@name@"sv, MathFunction::@name:titlecase@ },
)~~~");
    });
...
{
    return math_function_table.get(name);
}
