...
- WebContent-side bridge to the WebAudioWorker backend:
  ...
  - [AudioContextRegistry](../Libraries/LibWeb/WebAudio/Engine/AudioContextRegistry.cpp)
  - [SessionRouter (owns the helper session + transports)](../Libraries/LibWeb/WebAudio/Engine/SessionClient.cpp)
...
- Render process (WebAudioWorker):
  ...
  - [WebAudioWorker control connection](../Services/WebAudioWorker/WebAudioBrokerConnection.cpp)
  - [Server control-plane IPC surface](../Services/WebAudioWorker/WebAudioServer.ipc)
...
- Ring helpers + descriptor validation: [RingStream.h](../Libraries/LibWebAudio/RingStream.h)
