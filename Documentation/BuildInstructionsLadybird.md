...
```
sudo apt install autoconf autoconf-archive automake build-essential cmake libstdc++-12-dev libavcodec-dev libgl1-mesa-dev ninja-build qt6-base-dev qt6-tools-dev-tools qt6-multimedia-dev ccache fonts-liberation2 zip unzip curl tar libssl-dev
```
