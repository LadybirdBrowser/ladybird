...
void InputStream::initialize_ring_header(RingHeader& header, u32 sample_rate_hz, u32 channel_count,
    u32 channel_capacity, u64 capacity_frames)
{
...
ErrorOr<void> InputStream::initialize_shared_ring_storage(u32 sample_rate_hz, u32 channel_count,
    u64 capacity_frames)
{
    ...
    m_view.interleaved_frames = { data,
        ring_stream_bytes_for_data(channel_capacity, capacity_frames) / sizeof(float) };
