...
Messages::AudioServerServer::CreateAudioOutputSessionResponse AudioServerConnection::create_audio_output_session(u32 target_latency_ms)
{
    if (should_log_audio_server())
        dbgln("cid={}: create_audio_output_session(target_latency_ms={})", client_id(), target_latency_ms);
...
Messages::AudioServerServer::CreateAudioOutputSessionAsyncResponse AudioServerConnection::create_audio_output_session_async(u32 target_latency_ms)
{
    if (should_log_audio_server())
        dbgln("cid={}: create_audio_output_session_async(target_latency_ms={})", client_id(), target_latency_ms);
