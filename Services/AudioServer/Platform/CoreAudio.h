...
ChannelMap device_channel_layout(AudioChannelLayout const& channel_layout, u32 layout_size,
    u32 expected_channel_count);

inline void log_os_error_code([[maybe_unused]] OSStatus error_code,
    [[maybe_unused]] SourceLocation location = SourceLocation::current())
{
#if AUDIO_DEBUG
