...
Vector<DeviceInfo> Server::enumerate_platform_devices() { return Vector<DeviceInfo> {}; }

ErrorOr<NonnullOwnPtr<OutputDriver>>
create_platform_output_driver(DeviceHandle, OutputState, u32, OutputDriver::SampleSpecificationCallback&&,
