...
public:
    ...
    // Called on the AudioServer control thread.
    void register_producer(u64 producer_id, SharedCircularBuffer ring, Core::AnonymousBuffer timing_buffer,
...
private:
    ...
    static void publish_timing(TimingInfo& storage, u64 device_played_frames, u64 server_monotonic_ns,
