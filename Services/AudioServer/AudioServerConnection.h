...
private:
    ...
    Messages::AudioServerServer::CreateAudioOutputSessionResponse create_audio_output_session(u32 target_latency_ms) override;
    Messages::AudioServerServer::CreateAudioOutputSessionAsyncResponse create_audio_output_session_async(u32 target_latency_ms) override;
