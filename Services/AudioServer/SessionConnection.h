...
private:
    ...
    void create_input_stream(u64 request_id, ByteString grant_id, DeviceHandle device_handle, u64 capacity_frames) override;
    ...
    void create_session(u64 request_id, ByteString grant_id, u32 target_latency_ms, DeviceHandle device_handle) override;
