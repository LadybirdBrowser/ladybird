...
public:
    ...
    void register_output_producer(DeviceHandle device_handle, u64 producer_id, SharedCircularBuffer ring, Core::AnonymousBuffer timing_buffer, size_t bytes_per_frame);
