...
bool PageClient::page_did_request_traverse_the_history_by_delta(Optional<u64> history_traversal_request_id, Web::HTML::SessionHistoryEpoch epoch, Web::HTML::SessionHistoryOperationId last_session_history_mutation_id, int delta)
{
    return client().did_request_traverse_the_history_by_delta(m_id, history_traversal_request_id, epoch, last_session_history_mutation_id, delta);
}
