...
{
    // Browser user agents should offer users the ability to arbitrarily close any top-level traversable in their top-
    // level traversable set. For example, by clicking a "close tab" button.
    if (auto page = this->page(page_id); page.has_value())
