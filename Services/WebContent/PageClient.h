...
private:
    ...
    virtual void page_did_start_loading(Optional<Utf16String> const&, URL::URL const&, Web::HTML::DocumentResource, Web::HTML::CrossProcessId, bool, Web::Bindings::NavigationHistoryBehavior) override;
