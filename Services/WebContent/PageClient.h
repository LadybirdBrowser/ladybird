...
private:
    ...
    virtual void page_did_allocate_backing_stores(i32 front_bitmap_id, Gfx::SharedImagePayload front_backing_store, i32 back_bitmap_id, Gfx::SharedImagePayload back_backing_store) override;
