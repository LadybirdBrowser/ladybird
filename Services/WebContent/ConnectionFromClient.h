...
public:
    ...
    Function<void(IPC::TransportHandle const&, ByteString const&)> on_audio_server_connection;
...
private:
    ...
    virtual void connect_to_audio_server(IPC::TransportHandle handle, ByteString grant_id) override;
