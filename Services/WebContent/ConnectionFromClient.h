...
private:
    ...
    virtual void history_operation_started(u64 page_id, u64 operation_id, Optional<u64> initiation_id, Optional<Web::HTML::SessionHistoryEntryDescriptor> creation_target_entry) override;
