...
class WebAudioSessionConnection final
    : public IPC::ConnectionFromClient<ToSessionClientFromWebAudioWorkerEndpoint,
...
public:
    ...
    static void audio_server_did_become_ready();
    static void audio_server_did_fail_to_connect(ByteString const& error);

private:
    void begin_create_session(u64 request_id, u32 target_latency_ms);
    ...
    void
    set_render_graph(u64 session_id, ByteBuffer encoded_graph,
        Vector<Web::WebAudio::Render::SharedAudioBufferBinding> shared_audio_buffers) override;
    void set_suspended(u64 session_id, bool suspended, u64 generation) override;
    void set_media_element_audio_source_streams(
        u64 session_id,
        Vector<Web::WebAudio::Render::MediaElementAudioSourceStreamDescriptor> streams) override;
    void set_media_stream_audio_source_streams(
        u64 session_id, Vector<Web::WebAudio::Render::MediaStreamAudioSourceStreamDescriptor> streams) override;
    void set_script_processor_streams(
        u64 session_id, Vector<Web::WebAudio::Render::ScriptProcessorStreamDescriptor> streams) override;
    void set_worklet_node_ports(u64 session_id,
        Vector<Web::WebAudio::Render::WorkletNodePortDescriptor> ports) override;
    void
    set_worklet_node_definitions(u64 session_id,
        Vector<Web::WebAudio::Render::WorkletNodeDefinition> definitions) override;
    Messages::ToWebAudioWorkerFromSessionClient::CreateAnalyserStreamResponse
    create_analyser_stream(u64 session_id, u64 analyser_node_id, u32 fft_size, u32 block_count) override;
    Messages::ToWebAudioWorkerFromSessionClient::CreateDynamicsCompressorStreamResponse
    create_dynamics_compressor_stream(u64 session_id, u64 compressor_node_id, u32 block_count) override;
