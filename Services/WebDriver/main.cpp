...
static Vector<ByteString> create_arguments(ByteString const& webdriver_endpoint, bool headless, bool test_mode, bool expose_experimental_interfaces, bool force_cpu_painting, Optional<StringView> debug_process, Optional<StringView> default_time_zone)
{
...
ErrorOr<int> ladybird_main(Main::Arguments arguments)
{
    ...
    server->on_ready_to_accept = [&] {
        ...
        auto launch_browser_callback = [&](ByteString const& webdriver_endpoint, bool headless) {
            auto arguments = create_arguments(webdriver_endpoint, headless, test_mode, expose_experimental_interfaces, force_cpu_painting, debug_process, default_time_zone);
