...
// POST /session
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::new_session(Web::WebDriver::Parameters, JsonValue payload)
{
    dbgln_if(WEBDRIVER_DEBUG, "Handling POST /session");

    auto promise = Web::WebDriver::Promise<JsonValue>::construct();
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::delete_session(Web::WebDriver::Parameters parameters, JsonValue)
{
...
// GET /status
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_status(Web::WebDriver::Parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_timeouts(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::set_timeouts(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::navigate_to(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_current_url(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::back(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::forward(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::refresh(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_title(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_window_handle(Web::WebDriver::Parameters parameters, JsonValue)
{
    dbgln_if(WEBDRIVER_DEBUG, "Handling GET /session/<session_id>/window");
    auto promise = Web::WebDriver::Promise<JsonValue>::construct();
    auto session = WEBDRIVER_TRY(Session::find_session(parameters[0]));

    auto inner_promise = Web::WebDriver::Promise<JsonValue>::construct();
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::close_window(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::switch_to_window(Web::WebDriver::Parameters parameters, AK::JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_window_handles(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::new_window(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::switch_to_frame(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::switch_to_parent_frame(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_window_rect(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::set_window_rect(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::maximize_window(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::minimize_window(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::fullscreen_window(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::consume_user_activation(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::find_element(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::find_elements(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::find_element_from_element(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::find_elements_from_element(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::find_element_from_shadow_root(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::find_elements_from_shadow_root(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_active_element(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_element_shadow_root(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::is_element_selected(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_element_attribute(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_element_property(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_element_css_value(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_element_text(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_element_tag_name(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_element_rect(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::is_element_enabled(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_computed_role(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_computed_label(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::element_click(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::element_clear(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::element_send_keys(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_source(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::execute_script(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::execute_async_script(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_all_cookies(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_named_cookie(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::add_cookie(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::delete_cookie(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::delete_all_cookies(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::perform_actions(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::release_actions(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::dismiss_alert(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::accept_alert(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::get_alert_text(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::send_alert_text(Web::WebDriver::Parameters parameters, JsonValue payload)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::take_screenshot(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::take_element_screenshot(Web::WebDriver::Parameters parameters, JsonValue)
{
...
NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> Client::print_page(Web::WebDriver::Parameters parameters, JsonValue payload)
{
