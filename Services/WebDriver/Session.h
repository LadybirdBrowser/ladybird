...
public:
    ...
    static ErrorOr<NonnullRefPtr<Web::WebDriver::Promise<NewSession>>> create(NonnullRefPtr<Client> client, JsonValue capabilities, Web::WebDriver::SessionFlags flags);
    ~Session();
    ...
    NonnullRefPtr<Web::WebDriver::Promise<Empty>> close();
    ...
    void set_timeouts(JsonValue, NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> top_level_promise);
    void close_window(NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> top_level_promise);
    void switch_to_window(StringView, NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> top_level_promise);
    Web::WebDriver::Response get_window_handles() const;
    ErrorOr<void, Web::WebDriver::Error> ensure_current_window_handle_is_valid() const;

    template<typename Action>
    void perform_async_action(NonnullRefPtr<Web::WebDriver::Promise<JsonValue>> promise, Action&& action)
    {
...
private:
    ...
    RefPtr<Web::WebDriver::Promise<Empty>> m_close_promise;
