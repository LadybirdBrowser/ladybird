...
private:
    ...
    virtual void decode_image(Core::AnonymousBuffer, Optional<Gfx::IntSize> ideal_size, Optional<ByteString> mime_type, i64 request_token) override;
    virtual void cancel_decoding(i64 request_token) override;
    ...
    NonnullRefPtr<Job> make_decode_image_job(i64 request_token, Core::AnonymousBuffer, Optional<Gfx::IntSize> ideal_size, Optional<ByteString> mime_type);
