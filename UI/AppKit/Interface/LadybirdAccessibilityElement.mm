    ...
    if ([attribute isEqualToString:@"AXStringForTextMarkerRange"]
        ...
        for (auto leaf_id : leaves) {
            ...
            if (leaf_id == startData.node_id && leaf_id == endData.node_id) {
                ...
                i32 start_off = MIN(startData.offset, static_cast<i32>(text.length()));
                i32 end_off = MIN(endData.offset, static_cast<i32>(text.length()));
            ...
            if (leaf_id == startData.node_id) {
                collecting = true;
                i32 off = MIN(startData.offset, static_cast<i32>(text.length()));
            ...
            if (leaf_id == endData.node_id) {
                i32 off = MIN(endData.offset, static_cast<i32>(text.length()));
...
// The accessibility system may query via th "modern" property API rather than the "informal" protocol. These delegate
