...
- (id)accessibilityAttributeValue:(NSString*)attribute forParameter:(id)parameter
{
    if ([attribute isEqualToString:@"AXUIElementsForSearchPredicate"] ||
        ...
        // When navigating forward past a container element, skip its descendants to avoid re-traversing them. In pre-
        // order DFS, descendants form a contiguous block right after their ancestor.
...
// The accessibility system may query via modern property API rather than the informal protocol. These delegate to
