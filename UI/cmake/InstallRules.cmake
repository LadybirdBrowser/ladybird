...
if (ENABLE_INSTALL_FREEDESKTOP_FILES)
    ...
    configure_file(${FREEDESKTOP_RESOURCE_DIR}/org.ladybird.Ladybird.metainfo.xml.in ${LADYBIRD_SOURCE_DIR}/Build/org.ladybird.Ladybird.metainfo.xml @ONLY)
    install(FILES
    ...
    install(FILES
        "${LADYBIRD_SOURCE_DIR}/Build/org.ladybird.Ladybird.metainfo.xml"
