...
// Toolkit-independent macOS accessibility for the Qt UI.
//
// Uses the same LadybirdAccessibilityElement wrappers as the AppKit UI. A WebContentAccessibilityView (NSView overlay)
// conforms to LadybirdAccessibilityViewProtocol and provides the scroll-area container for the web content root.
//
// Three swizzles on QMacAccessibilityElement connect Qt's bridge to our overlay: accessibilityRole (returns AXWebArea),
// accessibilityChildren (returns the overlay), and accessibilityFocusedUIElement (returns the overlay's focused
// element). All other semantics (search predicates, roles, landmarks, actions) are handled by
...
// ============================================================================
// WebContentAccessibilityView: NSView overlay implementing
// LadybirdAccessibilityViewProtocol (same protocol as AppKit's
// LadybirdWebView). VoiceOver navigates web content through this view.
// ============================================================================
...
//
// 1. accessibilityRole → AXWebArea (triggers VoiceOver web mode)
// 2. accessibilityChildren → [overlay] (the scroll area container)
// 3. accessibilityFocusedUIElement → overlay's focused element
// ============================================================================
