...
// is populated by LibWeb from the text's rendered visual lines and correctly places each character on its own line — even
// when the text wraps. Coordinates are widget-local.
