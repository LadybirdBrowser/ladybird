...
class WebContentView final
    ...
    Q_OBJECT
public:
    WebContentView(QWidget* window, RefPtr<WebView::WebContentClient> const& parent_client = nullptr, size_t page_index = 0, WebContentViewInitialState initial_state = {});
