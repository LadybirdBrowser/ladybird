        ...
        if app and name:
            ...
            if _ladybird_os.path.exists(candidate):
                try:
                    ...
                    # Fall back to Orca's default script, but surface why ours failed to load; a silent pass hides
                    # a broken Ladybird script behind seemingly-normal behavior.
                    import traceback as _ladybird_traceback

                    _ladybird_traceback.print_exc()
