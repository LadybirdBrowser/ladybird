...
public:
    ...
    ALWAYS_INLINE ReadonlyBytes bytes() const [[clang::lifetimebound]] { return { characters(), length() }; }
    ALWAYS_INLINE StringView view() const [[clang::lifetimebound]] { return { characters(), length() }; }
