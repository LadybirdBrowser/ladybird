...
public:
    ...
    ALWAYS_INLINE operator Utf16View() const& [[clang::lifetimebound]] { return utf16_view(); }
    ...
    [[nodiscard]] ALWAYS_INLINE StringView ascii_view() const& [[clang::lifetimebound]]
    {
    ...
    [[nodiscard]] ALWAYS_INLINE Utf16View utf16_view() const& [[clang::lifetimebound]]
    {
        if (has_short_ascii_storage())
    ...
    [[nodiscard]] ALWAYS_INLINE Utf16View substring_view(size_t code_unit_offset, size_t code_unit_length) const [[clang::lifetimebound]]
    {
        return utf16_view().substring_view(code_unit_offset, code_unit_length);
    }

    [[nodiscard]] ALWAYS_INLINE Utf16View substring_view(size_t code_unit_offset) const [[clang::lifetimebound]]
    {
