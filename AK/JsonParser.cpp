...
constexpr char const exceeded_max_nesting_depth_error[] = "JsonParser: Exceeded maximum nesting depth";
...
ErrorOr<JsonValue> JsonParser::parse_object()
{
    if (m_current_nesting_depth >= max_nesting_depth)
        return Error::from_string_literal(exceeded_max_nesting_depth_error);
