...
public:
    ...
    [[nodiscard]] ALWAYS_INLINE Utf16View view() const [[clang::lifetimebound]] { return m_data.utf16_view(); }

    ALWAYS_INLINE explicit operator Utf16String() const { return to_utf16_string(); }

    ALWAYS_INLINE operator Utf16View() const& [[clang::lifetimebound]] { return view(); }
