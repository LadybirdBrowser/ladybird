...
#    pragma GCC diagnostic pop
    ...
    [[nodiscard]] Bytes bytes() [[clang::lifetimebound]]
    {
        return { data(), size() };
    }
    [[nodiscard]] ReadonlyBytes bytes() const [[clang::lifetimebound]] { return { data(), size() }; }

    [[nodiscard]] AK::Bytes span() [[clang::lifetimebound]] { return { data(), size() }; }
    [[nodiscard]] AK::ReadonlyBytes span() const [[clang::lifetimebound]] { return { data(), size() }; }
    ...
    Bytes must_get_bytes_for_writing(size_t length) [[clang::lifetimebound]]
    {
...
#pragma GCC diagnostic pop
    ...
    operator Bytes() [[clang::lifetimebound]] { return bytes(); }
    operator ReadonlyBytes() const [[clang::lifetimebound]] { return bytes(); }
