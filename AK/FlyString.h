...
public:
    ...
    [[nodiscard]] ReadonlyBytes bytes() const [[clang::lifetimebound]] { return m_data.bytes(); }
    [[nodiscard]] StringView bytes_as_string_view() const [[clang::lifetimebound]] { return m_data.bytes(); }
