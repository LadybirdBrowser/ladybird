...
public:
    ...
    [[nodiscard]] StringView find_last_split_view(char separator) const& [[clang::lifetimebound]] { return view().find_last_split_view(separator); }
    ...
    [[nodiscard]] ALWAYS_INLINE ReadonlyBytes bytes() const& [[clang::lifetimebound]] { return m_impl->bytes(); }
    ...
    [[nodiscard]] StringView view() const& [[clang::lifetimebound]] { return { characters(), length() }; }
